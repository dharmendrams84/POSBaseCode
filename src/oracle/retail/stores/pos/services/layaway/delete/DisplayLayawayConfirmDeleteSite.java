 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/delete/DisplayLayawayConfirmDeleteSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:14 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayLayawayConfirmDeleteSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText("Layaway",
                                             "Layaway").toLowerCase(locale);
        args[1] = args[0];
        args[2] = args[0];
