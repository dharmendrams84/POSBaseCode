 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/delete/LayawayRefundRoad.java /rgbustores_13.4x_generic_branch/2 2011/09/09 17:41:55 sgu Exp $
 * ===========================================================================
 * NOTES
...
public class LayawayRefundRoad extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        journalLayawayDelete(layawayTransaction, layawayCargo, bus.getServiceName(), pm);
    ...
    **/
    protected void journalLayawayDelete(LayawayTransactionIfc trans,
                                        LayawayCargo layawayCargo, String serviceName)
    {
        journalLayawayDelete(trans, layawayCargo, serviceName, null);
    }
