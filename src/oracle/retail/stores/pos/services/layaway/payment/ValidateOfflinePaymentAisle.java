 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/payment/ValidateOfflinePaymentAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:13 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateOfflinePaymentAisle extends LaneActionAdapter
{
    ...
    **/
    ...
    /**
       Args for Invalid Layaway Payment dialog
    **/
    ...
    /**
       Args for Invalid Layaway Payment dialog
    **/
    public static final String[] ERROR_MESSAGE_TAG =
    {
        "LayawayInvalidPayment.CannotExceed",
        "LayawayInvalidPayment.LessThanEqual"
    };
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if ( paymentAmount.compareTo(balanceDue) > 0 )
        {
            ...
            args[0] = utility.retrieveDialogText(ERROR_MESSAGE_TAG[0],
                                                 ERROR_MESSAGE[0]);
            args[1] = utility.retrieveDialogText(ERROR_MESSAGE_TAG[1],
                                                 ERROR_MESSAGE[1]) + " " +
                        balanceDue.toFormattedString();
