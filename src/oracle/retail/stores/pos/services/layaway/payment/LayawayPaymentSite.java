 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/payment/LayawayPaymentSite.java /rgbustores_13.4x_generic_branch/1 2011/10/27 11:27:09 hyin Exp $
 * ===========================================================================
 * NOTES
...
public class LayawayPaymentSite extends PosSiteActionAdapter
{
     ...
     * @deprecated as of 13.1 legal statement is in LayawayReceipt.bpt now
     */
    ...
    /**
     * Legal Statement bundle tag.
     * @deprecated as of 13.1 legal statement is in LayawayReceipt.bpt now
     */
    protected static final String LEGAL_STMT_TAG = "LegalStatement";

    /**
     * Legal Statement default text.
     * @deprecated as of 13.1 legal statement is in LayawayReceipt.bpt now
     */
    protected static final String LEGAL_STMT_TEXT = "Layaway Legal statement of liability";
