 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/create/DisplayNoLinkCustomerAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:14 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayNoLinkCustomerAisle extends LaneActionAdapter
{
    ...
    **/
    ...
    /**
        layaway tag
    **/
    protected static String LAYAWAY_TAG = "NoLinkedCustomer.Layaway";
    /**
     * layaway message
     */
    protected static String LAYAWAY = "Layaway";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText(LAYAWAY_TAG, LAYAWAY);
        args[1] = args[0];
        args[2] = args[0];
