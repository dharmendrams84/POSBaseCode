 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/create/LinkCustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2012/02/07 13:49:37 blarsen Exp $
 * ===========================================================================
 * NOTES
...
implements ShuttleIfc
{
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        JournalManagerIfc jmgr = (JournalManagerIfc)Gateway.getDispatcher().getManager(JournalManagerIfc.TYPE);
        ...
        if (customerMainCargo.isLink() && customer != null)
        {
            ...
            initializeNewLayaway(layawayTransaction,
                                 jmgr,
                                 pm,
                                 customer,
                                 register,
        ...
        if (layawayTransaction != null) {
        	CustomerUtilities.journalCustomerExit(layawayTransaction.getCashier().getEmployeeID(),
    ...
    **/
    ...
    {                                   // begin initializeNewLayaway()
        ...
        if (journalLink)
        {
        	CustomerUtilities.journalCustomerLink(layawayTransaction.getCashier().getEmployeeID(),
        				customer.getCustomerID(),
                        layawayTransaction.getTransactionID());
            // journal the customer pricing after customer has been linked
            // to the transaction in order to pickup the correct pricing.
            CustomerUtilities.journalCustomerPricing(layawayTransaction, customer.getPricingGroupID());
        }
