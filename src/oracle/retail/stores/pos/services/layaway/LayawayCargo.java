 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/LayawayCargo.java /rgbustores_13.4x_generic_branch/1 2011/08/09 11:31:52 cgreene Exp $
 * ===========================================================================
 * NOTES
        ...
        LayawayPaymentCargoIfc, RetailTransactionCargoIfc
{
     ...
     */
    protected int layawayOperation = -1; // not set yet
