 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/find/GetTransactionSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:13 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GetTransactionSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    /**
       ...
       summary entry. And the training mode<P>
    ...
    **/
        ...
        LayawaySummaryEntryIfc summary, boolean trainingMode, LocaleRequestor localeReq)
    {
        if (debug)
        {
            System.out.println("Building transaction using " + summary);
        }
        TransactionIfc transaction
        ...
        if (debug)
        {
            System.out.println("Built transaction had id: " +
                transaction.getTransactionIdentifier());
            System.out.println("Workstation: " +
                transaction.getWorkstation());
            System.out.println("and business day: " +
                transaction.getBusinessDay());
        }
    ...
    **/
    //----------------------------------------------------------------------
    protected LayawayIfc instantiateLayaway(
        LayawaySummaryEntryIfc summary, boolean trainingMode)
    {
        if (debug)
        {
            System.out.println("Building layaway using " + summary);
        }
        LayawayIfc layaway
        ...
        if (debug)
        {
            System.out.println("Built layway was: " + layaway.getLayawayID());
        }
