 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/find/LookupLayawaySite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:13 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
     Retrieves a LayawaySummary based on a Layaway ID.
     This site sends the following letters: Failure, Success, NotFound.
...
public class LookupLayawaySite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
        Retrieves a layaway summary based on a layaway ID. The layaway ID
        is retrieved from the LayawayCargo using getLayawaySearchID().
        The resulting summary (LayawaySummaryEntryIfc) is then set in the
        cargo as an array of 1 using
        setLayawaySummaryEntryList(LayawaySummaryEntryIfc[]).
        Save the Layaway object generated by the data call as well.
        <P>
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
      ...
      CustomerIfc customer;             // customer associated with the layaway
      String customerID;                // customer ID associated with the layaway
        ...
        try
        {
            ...
            LayawayIfc layaway =
              instantiateLayaway(cargo.getLayawaySearchID(),
                                 trainingMode, utility.getRequestLocales());
            ...
            if (debug)
            {
                System.out.println("############### Layaway " + layaway);
            }
            ...
            if (debug)
            {
                System.out.println("############### Layaway summary " + layaway);
            }
            ...
            // Send the success message if nothing bad's happened yet.
    ...
    **/
    //---------------------------------------------------------------------
    static protected LayawayIfc instantiateLayaway(String layawayID, boolean trainingMode, LocaleRequestor localeRequestor)
    {
    ...
    //---------------------------------------------------------------------
    /**
       Populates the layaway summary entry array with the corresponding
       layaway data. <P>
