 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/find/LayawayCanceledRoad.java /rgbustores_13.4x_generic_branch/3 2011/10/27 11:27:09 hyin Exp $
 * ===========================================================================
 * NOTES
...
public class LayawayCanceledRoad extends PosLaneActionAdapter
{
    ...
    **/
    ...
    /**
            ...
            transaction, or turns the seed transaction into a Sale Return
            Transaction so that the POS service will cancel it.
            <P>
    ...
    public void traverse(BusIfc bus)
    {
            ...
            cargo.getSeedLayawayTransaction() != null)
        {
            cargo.setTenderableTransaction(
                    instantiateLayawayTransaction(cargo, bus));
        }
    }

    //---------------------------------------------------------------------
    /**
       Instantiates an object implementing the LayawayTransactionIfc interface and sets it as the tendrable transaction in the cargo.. <P>
       @return object implementing LayawayIfc
    **/
    //---------------------------------------------------------------------
    static protected LayawayTransactionIfc instantiateLayawayTransaction(LayawayCargo cargo, BusIfc bus)
    {
