 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/priceadjustment/PriceAdjustmentUtilities.java /main/15 2011/02/16 09:13:24 cgreene Exp $
 * ===========================================================================
...
public class PriceAdjustmentUtilities
{
     ...
     */
    private static final Map<String, String> dialogMap = new HashMap<String, String>();
