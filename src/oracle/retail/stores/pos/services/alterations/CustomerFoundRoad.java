 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/alterations/CustomerFoundRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:16 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class CustomerFoundRoad extends PosLaneActionAdapter
{
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = 1008185386725730986L;
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if (cargo.isCustomerLinkRefreshUI()) // Link the customer.
        {
            if (cargo.getTransaction() != null && cargo.getCustomer() != null)
            {
                ...
                // Se the customer in the transaction
                ...
                CustomerUtilities.journalCustomerLink(cargo.getEmployeeID(),
                ...
                CustomerUtilities.journalCustomerExit(cargo.getEmployeeID(),
                                                cargo.getTransaction().getTransactionID());
            }
        }
