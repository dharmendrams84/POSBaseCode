 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/alterations/AlterationsOptionsSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:16 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AlterationsOptionsSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    protected NavigationButtonBeanModel getNavigationButtonBeanModel(AlterationPLUItemIfc item,
                                                                     boolean modifyItemServiceFlag,
                                                                     boolean newPLUItemFlag)
    {
