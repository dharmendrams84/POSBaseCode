 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/alterations/AlterationInfoEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:16 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AlterationInfoEnteredAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        AlterationIfc alterationObject = (AlterationIfc)item.getAlteration();

        if (item!=null && alterationObject!=null)
        {
