 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/alterations/AlterationsErrorSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:15 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AlterationsErrorSite extends PosSiteActionAdapter
{
    ...
    **/
    private static final String ARG_TAG = "NoLinkedCustomer.Alteration";
    /**
        no link customer argument text
    **/
    private static final String ARG_TEXT = "Alteration";
