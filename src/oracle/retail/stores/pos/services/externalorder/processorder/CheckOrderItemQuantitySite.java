 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/externalorder/processorder/CheckOrderItemQuantitySite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:59 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//      get the pluitem
    ...
    private boolean isQuantityValid(PLUItemIfc plu)
    {
        ...
        if ( plu.getUnitOfMeasure().getUnitID().equals(UNITS) ||
             ...
             plu.getRelatedItemContainer().getRelatedItemGroups(RelatedItemGroupIfc.AUTOMATIC).length != 0 ||
             plu.getRelatedItemContainer().getRelatedItemGroups(RelatedItemGroupIfc.PICK_SOME).length != 0 ||
             plu.getRelatedItemContainer().getRelatedItemGroups(RelatedItemGroupIfc.PICK_ONE).length != 0)
       {
