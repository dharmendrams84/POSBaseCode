 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/externalorder/processorder/LockOrderSite.java /rgbustores_13.4x_generic_branch/3 2011/09/19 12:16:56 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        else if (!cargo.getRegister().getWorkstation().isTrainingMode())
        {
            ...
            try
            {
                ...
                TransactionUtility.journalExternalOrder(cargo.getExternalOrder().getNumber());
            }
