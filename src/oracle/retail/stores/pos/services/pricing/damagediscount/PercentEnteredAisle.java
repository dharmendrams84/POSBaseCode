 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/damagediscount/PercentEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:01 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{
    private static final long serialVersionUID = 1149865117600186263L;
    ...
    public void traverse(BusIfc bus)
    {
        ...
        POSBaseBeanModel beanModel =
            (POSBaseBeanModel) ui.getModel(POSUIManagerIfc.DAMAGE_PERCENT);
