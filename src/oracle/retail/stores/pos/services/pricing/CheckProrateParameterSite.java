 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/CheckProrateParameterSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:00 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
            ...
            prorateSelectionDialogRequired((ParameterManagerIfc) bus.getManager(ParameterManagerIfc.TYPE)))
        {
            ...
            msg[0] = msg[1] = msg[2] = utility.retrieveCommonText(DOLLAR_OFF, DOLLAR_OFF, uiLocale);
            showProrateSelectionDialog(ui, msg);
        }
        else
        {
    ...
    //----------------------------------------------------------------------
    /**
     *  Displays the prorate discount selection dialog. <P>
     *  @param  ui  The POSUIManager
     *  @param msg  <ARG>'s of dialog
     */
    //----------------------------------------------------------------------
    protected void showProrateSelectionDialog(POSUIManagerIfc ui, String[] msg)
    {
