 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/AbstractApplyDiscountPercentSite.java /main/11 2011/02/16 09:13:28 cgreene Exp $
 * ===========================================================================
 * NOTES
...
abstract public class AbstractApplyDiscountPercentSite extends PosSiteActionAdapter
{
                                          ...
                                          SaleReturnLineItemIfc[] lineItems)
    {
        ...
        for (Iterator i = keys.iterator(); i.hasNext();)
        {
            ...
            {    
                cargo.removeAllManualDiscounts(srli, (JournalManagerIfc) Gateway.getDispatcher()
                        ...
                        if (isMarkdown()) 
                        {
                            if (currentDiscounts[j].getAccountingMethod() == 
                                ...
                                currentDiscounts[j].getAssignmentBasis() ==
                                    getDiscountBasis())
                            {
                                journalDiscount(cargo.getOperator().getEmployeeID(),
     ...
     */
    protected void journalDiscount(String employeeID,
