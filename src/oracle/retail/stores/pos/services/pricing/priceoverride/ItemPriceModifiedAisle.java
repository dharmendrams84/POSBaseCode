 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/priceoverride/ItemPriceModifiedAisle.java /rgbustores_13.4x_generic_branch/4 2011/06/12 09:16:13 icole Exp $
 * ===========================================================================
...
/**
 * Journal the item price modification.
 *
...
public class ItemPriceModifiedAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        // Decide which bean model to get depending on the Capture Reason Code For Price Override parameter
        // Use screenID = POSUIManagerIfc.PRICE_OVERRIDE_NOREASON; if reason code needs to be removed
        screenID = POSUIManagerIfc.PRICE_OVERRIDE;
        ...
        CodeListIfc rcl = pc.getPriceOverrideCodeList();
    ...
    protected void journalPriceModification(BusIfc bus, LocalizedCodeIfc selectedCode, String screenID)
    {
        ...
        if (journal != null)
        {
            ...
            sb.append(Util.EOL);
            Object dataObject[]={ip.getItemPriceOverrideReason().getText(LocaleMap.getLocale(LocaleConstantsIfc.JOURNAL))};
