 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/itemdiscount/ModifyItemDiscountPercentSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:00 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    display is primed with data from existing discount. <P>
...
public class ModifyItemDiscountPercentSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        CodeListIfc rcl = utility.getReasonCodes(cargo.getOperator().getStoreID(),CodeConstantsIfc.CODE_LIST_ITEM_DISCOUNT_BY_PERCENTAGE);
