 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/giftcard/reload/GiftCardReloadCardNumEnteredAisle.java /rgbustores_13.4x_generic_branch/3 2011/09/07 08:33:37 jswan Exp $
 * ===========================================================================
 * NOTES
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if ( noError(bus, cardData) )
        {
            ...
            if (cardData != null && pluItem != null)
            {
                ...
                JournalManagerIfc jmi = (JournalManagerIfc) Gateway
