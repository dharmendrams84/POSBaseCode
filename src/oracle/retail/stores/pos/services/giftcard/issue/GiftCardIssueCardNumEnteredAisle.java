 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/giftcard/issue/GiftCardIssueCardNumEnteredAisle.java /rgbustores_13.4x_generic_branch/3 2011/09/07 08:33:37 jswan Exp $
 * ===========================================================================
 * NOTES
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if (noError)
        {
            ...
            if (pluItem != null && cardData != null)
            {
				...
				StringBuffer journalString = new StringBuffer(giftCard
