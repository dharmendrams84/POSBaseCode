 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnfindtrans/ReadTransactionSite.java /rgbustores_13.4x_generic_branch/2 2011/09/19 15:36:17 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ReadTransactionSite extends NoTransactionsErrorSite
{
     ...
     * Error text constant
     */
    public static final String NO_DATA_TEXT = "matching this number.";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            if (transactionID != null && !Util.isEmpty(transactionID.getTransactionIDString()))
            {
                ...
                transactions = dt.readTransactionsByID(transIDString, transactionID.getBusinessDate(), trainingMode, localeRequestor);
                ...
                if (transactions != null)
                {
                    ...
                    for (int i = 0; i < transactions.length; i++)
                    {
                        ...
                        if (!transactions[i].isVoided())//dt.isTransactionVoided(transactions[i]))
                        {
