 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnfindtrans/ValidateReceiptIDAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateReceiptIDAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        else
        {
            ...
            if(receiptNo.getSequenceNumber()==0 && receiptNo.getStoreID().equals("")&&
