 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnfindtrans/EvaluateSearchCriteriaSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EvaluateSearchCriteriaSite extends PosSiteActionAdapter 
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        // Otherwise Search by criteria if one is available; there are other
        // types of criteria besides tender, such as store number and serial number.
