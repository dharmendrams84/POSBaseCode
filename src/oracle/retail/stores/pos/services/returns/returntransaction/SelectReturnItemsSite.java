 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/SelectReturnItemsSite.java /main/17 2011/01/14 15:48:01 npoola Exp $
 * ===========================================================================
 * NOTES
...
public class SelectReturnItemsSite extends DisplayTransactionDetailsSite
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        // If IMEI scan is enabled then set the promot max length to imei length
