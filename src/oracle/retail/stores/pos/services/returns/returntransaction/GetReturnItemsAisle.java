 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/GetReturnItemsAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GetReturnItemsAisle extends ValidateItemNumberAisle
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        PromptAndResponseModel promptModel = beanModel.getPromptAndResponseModel();
