 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/ValidateReturnItemInformationAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateReturnItemInformationAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       This aisle validates the returned item information.  Specifically,
       it makes sure that user does not return more items than were purchased.
       <P>
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        BigDecimal   qtyAvailable = item.getItemQuantityDecimal().subtract(item.getQuantityReturnedDecimal());
        BigDecimal qtyReturnable = qtyAvailable.subtract(qtyToReturn);
