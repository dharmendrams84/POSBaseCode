 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/UndoReturnItemChangesRoad.java /rgbustores_13.4x_generic_branch/5 2011/08/18 08:44:04 jswan Exp $
 * ===========================================================================
 * NOTES
...
public class UndoReturnItemChangesRoad extends LaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {            
            ...
            BigDecimal qnty =
                item.getItemQuantityDecimal().subtract(item.getQuantityReturnedDecimal());
            cargo.getReturnItem().setItemQuantity(qnty);
