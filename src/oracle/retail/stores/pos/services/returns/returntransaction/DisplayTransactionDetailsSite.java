 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/DisplayTransactionDetailsSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (cargo.getOriginalTransaction() instanceof OrderTransaction)
        {
                    ...
                    && transactionType == TransactionIfc.TYPE_ORDER_INITIATE)
            {
                ...
                {
                    if (itemsArray[i].getOrderItemStatus().getItemDispositionCode() == OrderLineItemIfc.ORDER_ITEM_DISPOSITION_SALE)
                    {
        ...
        String message = LocaleUtilities.formatComplexMessage(pattern, saleTransaction.getTransactionID());
        ...
        try
        {
            ...
            if (ui.getActiveScreenID() == screenName)
            {
                ...
                timerModel.setActionName(DefaultTimerModel.TRANS_LETTER);
