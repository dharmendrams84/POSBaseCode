 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/AddItemToBlindReturnSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{
    /**  */
    private static final long serialVersionUID = 561271050167220046L;

    //----------------------------------------------------------------------
    /**
     * This site attempts to find the highest price item and add it to
     * the transaction.
     * <P>
     *
     * @param bus
    ...
    { 
        ...
        if (itemAvailable)
        {
            ...
            while (iter.hasNext())
            {
                ...
                {
                    if (srli.getOrderItemStatus().getItemDispositionCode() == OrderLineItemIfc.ORDER_ITEM_DISPOSITION_DELIVERY
                            || srli.getOrderItemStatus().getItemDispositionCode() == OrderLineItemIfc.ORDER_ITEM_DISPOSITION_PICKUP)
                    {
