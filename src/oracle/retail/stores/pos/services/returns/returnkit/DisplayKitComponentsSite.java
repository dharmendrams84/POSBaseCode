 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnkit/DisplayKitComponentsSite.java /rgbustores_13.4x_generic_branch/2 2011/07/07 12:20:07 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayKitComponentsSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        tempTxn.setTransactionTax(utilityManager.getInitialTransactionTax(bus));
        ...
        tempTxn.addPLUItem(cargo.getPLUItem(), Util.I_BIG_DECIMAL_ONE);
