 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returncommon/EnterReturnItemInformationSite.java /rgbustores_13.4x_generic_branch/3 2011/08/18 08:44:03 jswan Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (letter == null)
        {
            ...
            model.setUnitOfMeasure(getUOMName(item, locale, utility, cargo.getStoreID()));
            ...
            if (cargo.getOriginalTransaction() != null)
            {
                ...
                model.setReceiptNumber(cargo.getOriginalTransaction().getTransactionID());
            ...
            if (item.isKitHeader())
            {
                model.setQuantity(Util.I_BIG_DECIMAL_ONE);
     ...
     */
    private String getUOMName(PLUItemIfc item, Locale locale, UtilityManagerIfc utility, String storeID)
    {
        String name    = "";
        String uomCode = null;
