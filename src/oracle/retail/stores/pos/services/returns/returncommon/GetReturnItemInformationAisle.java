 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returncommon/GetReturnItemInformationAisle.java /rgbustores_13.4x_generic_branch/3 2011/09/29 10:13:06 abondala Exp $
 * ===========================================================================
 * NOTES
...
public class GetReturnItemInformationAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
            ...
            cargo instanceof ReturnTransactionCargo)
        {
            ...
            item = cargoTran.getSaleLineItem();
            qtyAvailable = item.getItemQuantityDecimal().subtract(item.getQuantityReturnedDecimal().abs());
            returnItem.setFromRetrievedTransaction(true);
            returnItem.setQuantityReturnable(qtyAvailable);
            returnItem.setQuantityPurchased(item.getItemQuantityDecimal());
            ...
            SaleReturnLineItemIfc srli = cargoTran.getSaleLineItem();
            ...
            HashMap<String, String> tenderList = new HashMap<String, String>();
        ...
        if (receipt != null && receipt.length() > 0)
        {
            ...
            id.setTransactionID(receipt);
            returnItem.setOriginalTransactionID(id);
            returnItem.setHaveReceipt(cargo.haveReceipt());
        }
