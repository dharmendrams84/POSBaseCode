 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returncommon/ResetRestockingFeeAndSetNextItemRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ResetRestockingFeeAndSetNextItemRoad extends LaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        UtilityManager.setRestockingFeeOverRiddenTransaction(true);
