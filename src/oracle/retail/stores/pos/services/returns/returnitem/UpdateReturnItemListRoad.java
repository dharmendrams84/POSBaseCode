 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/UpdateReturnItemListRoad.java /rgbustores_13.4x_generic_branch/3 2011/08/18 08:44:04 jswan Exp $
 * ===========================================================================
 * NOTES
...
public class UpdateReturnItemListRoad extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        setupReturnItem(cargo, utility, pm);

        // get the default tax rate from the utility manager and set on the return item
        TransactionTaxIfc transactionTax = utility.getInitialTransactionTax(bus);
        ...
        SaleReturnLineItemIfc item = tempTxn.addReturnItem(cargo.getPLUItem(),cargo.getReturnItem(), Util.I_BIG_DECIMAL_ONE);
    ...
    protected void setupReturnItem(ReturnItemCargo cargo, UtilityManagerIfc utility, ParameterManagerIfc pm )
    {
        ...
        { //UI is not displayed for Kit Header items
            ...
            itemReturn.setItemQuantity(Util.I_BIG_DECIMAL_ONE);
