 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/StoreIDTaxGroupInformationHolder.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:56 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{
    private HashMap<String, HashMap<Integer, TaxGroupInformation>> storeGroupHolder = new HashMap<String, HashMap<Integer, TaxGroupInformation>>();
    ...
    public void addReturnItem(SaleReturnLineItemIfc item)
    {
        ...
        { 
            ...
            else 
            {
                ...
                {
                    HashMap<Integer, TaxGroupInformation> taxGroups = new HashMap<Integer, TaxGroupInformation>();
