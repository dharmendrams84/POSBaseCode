 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/ItemPriceCodeInfoEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{
    private static final long serialVersionUID = 5931869398382039529L;
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {
            String formattedSizeNumber = PLUItemUtility.getFormattedSizeNumber(model.getItemSize());
        ...
        {
          item.setDepartmentID(((utility.getReasonCodes(cargo.getStoreID(),CodeConstantsIfc.CODE_LIST_DEPARTMENT)).findListEntry(model
                .getDepartmentName())).getCode());
        }
        ...
        if (Util.isEmpty(model.getItemSerial()) || Util.isObjectEqual(model.getQuantity(), Util.I_BIG_DECIMAL_ONE))
        {
