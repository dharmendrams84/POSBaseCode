 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/EnterItemPriceCodeInfoSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:56 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
/**
    This site displays the ITEM_NOT_FOUND_PRICE_CODE screen to allow
...
public class EnterItemPriceCodeInfoSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Displays the ITEM_NOT_FOUND_PRICE_CODE form to allow the user
    ...
    **/
    ...
    public String[] getUnitOfMeasureStrings(BusIfc bus)
    {
        ...
        PLUCargoIfc cargo = (PLUCargoIfc)bus.getCargo();
        CodeListManagerIfc codeListManager =
            (CodeListManagerIfc) bus.getManager(CodeListManagerIfc.TYPE);
