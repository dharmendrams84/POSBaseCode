 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/EnterReturnItemSite.java /main/16 2011/01/14 15:48:01 npoola Exp $
 * ===========================================================================
 * NOTES
...
public class EnterReturnItemSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        else
        {
            ...
            model.setActionName(DefaultTimerModel.TRANS_LETTER);
        ...
        if (!cargo.haveReceipt())
        {
            ...
            if (cargo.getPLUItemID() != null)
            {

                if (cargo.getReturnData() != null)
                {
                    if (cargo.getReturnData().getSaleReturnLineItems().length > 0)
                    {
        ...
        else
        {
            ...
            String message = LocaleUtilities.formatComplexMessage(pattern, cargo.getOriginalTransactionId().getTransactionIDString());
