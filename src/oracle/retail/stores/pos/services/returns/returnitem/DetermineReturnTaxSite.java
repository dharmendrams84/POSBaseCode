 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/DetermineReturnTaxSite.java /main/11 2011/02/16 09:13:29 cgreene Exp $
 * ===========================================================================
 * NOTES
            ...
            try
            {
                ...
                if(groupIDs.length > 0 )
                {
                    ...
                    if ( taxRulesVO.hasTaxRules() )
                    {
                        ...
                        {
                            NewTaxRuleIfc[] taxRules = taxRulesVO.getTaxRules(groupIDs[j].intValue());
