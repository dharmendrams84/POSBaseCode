 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/ReturnOptionsCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
implements ReturnExternalOrderItemsCargoIfc
{
    ...
    /**
     * Indicates the current override is for Drivers Licence validation
     */
    ...
    public boolean isTransactionInOriginalTransactionList(SaleReturnTransactionIfc transaction)
    {
        ...
        if (originalReturnTransactions != null)
        {
            ...
            {
                if (SaleCargo.areTransactionIDsTheSame(transFromList, transaction))
                {
                    inArray = true;
                    break;
                }
     ...
     */
    protected boolean areAllItemsFromTransaction()
    {
