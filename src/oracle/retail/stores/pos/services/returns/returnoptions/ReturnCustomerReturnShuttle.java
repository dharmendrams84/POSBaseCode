 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/ReturnCustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:54 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ReturnCustomerReturnShuttle implements ShuttleIfc
{
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        CustomerUtilities.journalCustomerExit(rcCargo.getOperator().getEmployeeID(),
                                             transactionID);
