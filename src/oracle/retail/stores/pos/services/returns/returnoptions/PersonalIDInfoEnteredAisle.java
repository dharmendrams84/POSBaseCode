 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/PersonalIDInfoEnteredAisle.java /rgbustores_13.4x_generic_branch/3 2011/09/02 13:05:38 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class PersonalIDInfoEnteredAisle extends PosLaneActionAdapter
{
    ...
    private boolean isDriversLicenceValid(BusIfc bus, CustomerInfoIfc customerInfo)
    {
        ...
        byte[] personalID            = customerInfo.getPersonalID().getDecryptedNumber().getBytes();
