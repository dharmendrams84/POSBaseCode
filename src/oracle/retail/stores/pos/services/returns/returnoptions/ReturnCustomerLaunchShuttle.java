 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/ReturnCustomerLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ReturnCustomerLaunchShuttle extends AbstractReturnLaunchShuttle
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.returns.returnoptions.ReturnCustomerLaunchShuttle.class);
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        CustomerUtilities.journalCustomerEnter(roCargo.getOperator().getEmployeeID(), transactionID);
    }
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  ReturnCustomerLaunchShuttle (Revision " +
                                      ")" + hashCode());
