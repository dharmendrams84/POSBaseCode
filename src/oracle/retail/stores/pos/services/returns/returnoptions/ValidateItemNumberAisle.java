 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/ValidateItemNumberAisle.java /rgbustores_13.4x_generic_branch/2 2011/08/11 19:22:53 ohorne Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateItemNumberAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    protected boolean isSizeRequired(BusIfc bus, String itemNumber, boolean isScanned)
    {
        ...
        if (!isScanned)
        {
            PLUItemIfc pluItem = lookupItem(itemNumber, utility);
     ...
     */
    //----------------------------------------------------------------------
    protected PLUItemIfc lookupItem(String itemNumber, UtilityManagerIfc utility)
    {
