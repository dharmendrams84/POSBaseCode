 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/CheckForCustomerRequiredSite.java /main/13 2011/02/16 09:13:25 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (cargo.isCustomerMustLink() && !isCustomerAvailable(cargo))
        {
            ...
            else
            {
                ...
                // build the screen
                // set arg strings to Return
                String argSeed = utility.retrieveDialogText("NoLinkedCustomer.Return",
                                                            "Return");
                String args[] =
                {
                    argSeed,
