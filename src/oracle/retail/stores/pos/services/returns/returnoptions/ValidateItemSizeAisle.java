 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/ValidateItemSizeAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateItemSizeAisle extends LaneActionAdapter implements LaneActionIfc
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        POSBaseBeanModel model = ((POSBaseBeanModel) ui.getModel(POSUIManagerIfc.ITEM_SIZE));
        ...
        // Set up size object
        String sizeCode = PLUItemUtility.getFormattedSizeNumber(input);
        ...
        criteria.setItemSizeCode(sizeCode);
