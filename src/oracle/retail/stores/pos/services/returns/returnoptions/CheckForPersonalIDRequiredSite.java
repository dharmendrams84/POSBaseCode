 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnoptions/CheckForPersonalIDRequiredSite.java /rgbustores_13.4x_generic_branch/3 2011/09/12 15:46:42 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            if (!cargo.isCustomerInfoCollected() && (parameterValue.indexOf(ParameterConstantsIfc.RETURN_FormOfID_PERSONAL_ID) != -1))
            {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (cargo.getTransaction() != null && cargo.getTransaction().getCustomer() != null)
                            {
                                ...
                                {
                                    model.setBusinessCustomer(true);
                                    companyName = cargo.getTransaction().getCustomer().getCompanyName();
                ...
                if (!bIdTypeAdded)
                {
                    String selectedIDType = (customerInfo.getLocalizedPersonalIDType() != null)?
