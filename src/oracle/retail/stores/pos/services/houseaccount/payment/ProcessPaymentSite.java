 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/houseaccount/payment/ProcessPaymentSite.java /rgbustores_13.4x_generic_branch/6 2011/08/19 11:54:22 ohorne Exp $
 * ===========================================================================
 * NOTES
...
public class ProcessPaymentSite extends PosSiteActionAdapter
{
    ...
    /**
     * Default constant used for initializeTransaction method of UtilityManager
     * Signals the creation of a new transaction with the next available
     * sequence number.
     */
