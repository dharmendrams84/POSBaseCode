 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/delivery/address/CheckDeliveryAddressSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:49 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        { // set the delivery address detail into OrderDeliveryDetail Object
            try
            {
                ...
                orderDeliveryDetail.getContactPhone().setAreaCode(model.getPostalCode());
