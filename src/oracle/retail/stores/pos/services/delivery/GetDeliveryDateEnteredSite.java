 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/delivery/GetDeliveryDateEnteredSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:49 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GetDeliveryDateEnteredSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        {
            OrderDeliveryDetailIfc orderDeliveryDetail = null;

            pickupDeliveryOrderCargo.setDeliveryAction(true);
            for (int i = 0; i < lineItems.length; i++)
            {
                lineItems[i].getOrderItemStatus().setDeliveryDate(enteredDate);
                ...
                if (lineItems[i].isKitHeader())
                {
                    ...
                    while (childKitItemIter.hasNext())
                    {
                        ...
                        childKit.getOrderItemStatus().setDeliveryDate(enteredDate);
