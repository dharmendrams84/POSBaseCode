 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/SaveCanceledTransactionSite.java /rgbustores_13.4x_generic_branch/3 2011/09/19 12:16:56 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (transaction != null && !transCompleted && !transaction.isCanceledTransactionSaved())
        {
            ...
            catch (DataException de)
            {
            	...
            	DialogBeanModel dialogModel = utility.createErrorDialogBeanModel(de);
