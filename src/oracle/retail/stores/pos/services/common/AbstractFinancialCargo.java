 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/AbstractFinancialCargo.java /main/17 2011/02/25 15:24:53 hyin Exp $
 * ===========================================================================
 * NOTES
...
public class AbstractFinancialCargo extends UserAccessCargo implements AbstractFinancialCargoIfc
{
     ...
     * @param isTrainingMode Is this workstion for training mode
    ...
    static public WorkstationIfc createWorkstation(StoreIfc store, Logger logger, boolean isTrainingMode)
    {
        ...
        if (workstationID != null && workstationID.length() > 0)
        {
            ...
            ws.setTrainingModeWorkstationID(workstationID);
            ws.setStore(store);
    ...
    {
        originalPriceAdjustmentTransactions = new HashMap<String,SaleReturnTransactionIfc>();
    }
