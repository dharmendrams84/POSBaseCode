 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/SaveRetailTransactionAisle.java /rgbustores_13.4x_generic_branch/2 2011/08/09 11:31:52 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class SaveRetailTransactionAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        catch (DataException exception)
        {
            ...
            DialogBeanModel dialogModel = utility.createErrorDialogBeanModel(exception);
    ...
    public void processOriginalTransactions(SaleReturnTransactionIfc[] transactions, String serviceName)
    {
        if (transactions != null)
        {
            try
            {
                ...
                dbTrans.updateReturnedItems(transactions);
