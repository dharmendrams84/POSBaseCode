 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/WriteHardTotalsSite.java /main/12 2011/02/16 09:13:26 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class WriteHardTotalsSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (bOk)
        {
            ...
            {
                // begin write hard totals
                POSDeviceActions pda = new POSDeviceActions((SessionBusIfc) bus);

                // set up hard totals
                HardTotalsIfc ht = DomainGateway.getFactory().getHardTotalsInstance();
                ht.setStoreStatus(storeStatus);
                ht.setRegister(register);
                ht.setLastUpdate();
                ...
                {
                    logger.warn("Hard totals device could not be written due to a HardTotalsFormatException.", htre);
                    // issue HardTotalsError letter
                    letter = new Letter(HARDTOTALS_ERROR_LETTER);
                }
            }
