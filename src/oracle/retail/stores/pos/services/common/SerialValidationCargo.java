 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/SerialValidationCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:52 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SerialValidationCargo implements CargoIfc
{
    ...
    /**
     * boolean to indicate whether response needs
     * to be processed or passed on as in case of
     * IMEI
     */
