 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/common/EnterItemSizeSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:52 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EnterItemSizeSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
    	...
    	model.setDisplayText(getAvailableSizesInfo(utility));
    ...
    **/
    ...
    public String getAvailableSizesInfo(UtilityManagerIfc utility)
    {
        ...
        try
        {
            ...
            {
                display.append(sizes[i].getDescription(LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE)))
                       .append(" = ")
                       .append(sizes[i].getSizeCode())
