 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/ModifyTransactionSalesAssociateReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void unload(BusIfc bus)
    {
        ...
        if (dirtyFlag)
        {
            ...
            if (transaction != null)
            {
             ...
             cargo.updateTransactionSalesAssociate(newSalesAssociate, updateAllItemsFlag);
