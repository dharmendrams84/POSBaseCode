 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/employeediscount/AmountEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AmountEnteredAisle extends PosLaneActionAdapter
{
    ...
    protected void showInvalidTransactionDiscountDiscountDialog(POSUIManagerIfc uiManager, String[] msg)
    {
        ...
        dialogModel.setResourceID(ModifyTransactionDiscountCargo.INVALID_TRANSACTION_DISCOUNT_DIALOG);
