 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/tax/CheckForCustomerRequiredSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:32 mszekely Exp $
 * ===========================================================================
 * NOTES
        ...
        if (isCustomerRequired(bus) && !isCustomerAvailable(cargo))
        {
             ...
             */
             ...
             else
             {
                ...
                String argSeed = utility.retrieveDialogText("NoLinkedCustomer.TaxExemptTransaction",
