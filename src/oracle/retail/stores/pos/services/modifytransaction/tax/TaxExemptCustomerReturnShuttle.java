 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/tax/TaxExemptCustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/2 2012/02/07 13:49:37 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class TaxExemptCustomerReturnShuttle extends FinancialCargoShuttle
{
    ...
    public void unload(BusIfc bus)
    {
        ...
        if (customerMainCargo.isLink() && (customer != null))
        {
            ...
            CustomerUtilities.journalCustomerExit(transaction.getCashier().getEmployeeID(), transaction
                    .getTransactionID());
