 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/tax/EnterTaxExemptSite.java /rgbustores_13.4x_generic_branch/2 2011/09/02 13:23:12 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EnterTaxExemptSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        else if (cargo.getCustomer() != null)
        {
            ...
            if (!Util.isEmpty(customer.getEncipheredTaxCertificate().getDecryptedNumber()))
                beanModel.setValue(customer.getEncipheredTaxCertificate().getDecryptedNumber());
        }
