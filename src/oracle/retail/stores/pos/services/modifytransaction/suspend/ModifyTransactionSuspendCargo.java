 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/suspend/ModifyTransactionSuspendCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 **/
// ------------------------------------------------------------------------------
public class ModifyTransactionSuspendCargo extends AbstractFinancialCargo implements CargoIfc, DBErrorCargoIfc
{ // begin class ModifyTransactionSuspendCargo
    ...
    { // begin ModifyTransactionSuspendCargo()
    } // end ModifyTransactionSuspendCargo()
    ...
    // ---------------------------------------------------------------------
    /**
     * Returns selected reason code text.
     * <P>
     * 
     * @return selected reason code text
     * @deprecated as of 13.1 Use
     *             {@link #setSelectedLocalizedReason(LocalizedCodeIfc)}
     **/
    // ---------------------------------------------------------------------
    public void setSelectedReason(String value)
    {
        selectedLocalizedReason.setCode(value);
    }
     ...
     * 
     * @return selected reason code text
     * @deprecated as of 13.1 Use {@link #getSelectedLocalizedReason()}
     **/
    // ---------------------------------------------------------------------
    public String getSelectedReason()
    {
        return (selectedLocalizedReason.getCode());
    }

    // ---------------------------------------------------------------------
    /**
     * Returns index of selected reason code.
     * <P>
     * 
     * @return index of selected reason code
     * @deprecated as of 13.1 Use
     *             {@link #setSelectedLocalizedReason(LocalizedCodeIfc)}
     **/
    // ---------------------------------------------------------------------
    public void setSelectedReasonCode(int value)
    {
        selectedReasonCodeIndex = value;
    }
    ...
    {
        return (selectedReasonCodeIndex);
    }
     ...
     * argument.
     * 
     * @deprecated Use PararamterManager directly to get at params. This support
     *             does not belong in cargo.
    ...
    public String getParameterValue(BusIfc bus, String paramName)
    {
        ...
        try
        {
            value = pm.getStringValue(paramName);
        }
    ...
    public String toString()
    {
        ...
        strResult.append("Class:  ModifyTransactionSuspendCargo").append(" (Revision ").append(getRevisionNumber())
...
} // end class ModifyTransactionSuspendCargo
