 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/VoidLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class VoidLaunchShuttle extends FinancialCargoShuttle
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.modifytransaction.VoidLaunchShuttle.class);
    /**
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        ContextFactory.getInstance().setContext(new TourADOContext(bus));
