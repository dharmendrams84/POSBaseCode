 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/GiftReceiptAssignedAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GiftReceiptAssignedAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        boolean flag = false;
        boolean needRetrieveTaxRuleAgain = false;
        boolean taxOnDiscount = true;
        String storeID = cargo.getStoreStatus().getStore().getStoreID();
        String state = cargo.getStoreStatus().getStore().getAddress().getState();
