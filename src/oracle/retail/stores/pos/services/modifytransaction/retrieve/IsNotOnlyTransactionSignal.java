 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/IsNotOnlyTransactionSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
    Clears if there is more than one transaction in the list of retrieved transactions.
...
public class IsNotOnlyTransactionSignal implements TrafficLightIfc
{
    ...
    //
    static final long serialVersionUID = 8989950206333166292L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.modifytransaction.retrieve.IsNotOnlyTransactionSignal.class);
    ...
    **/
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        // if more than one transaction retrieved
