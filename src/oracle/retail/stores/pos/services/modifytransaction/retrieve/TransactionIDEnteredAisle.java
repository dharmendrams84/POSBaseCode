 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/TransactionIDEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
        Retrieves entered transaction ID from user interface. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class TransactionIDEnteredAisle extends PosLaneActionAdapter
{                                                                               // begin class TransactionIDEnteredAisle
    ...
    **/
    ...
    {                                                                   // begin traverse()
        ...
        if (logger.isInfoEnabled()) logger.info(
                    "" + "Selected transaction ID: " + "" + transactionID + "");
