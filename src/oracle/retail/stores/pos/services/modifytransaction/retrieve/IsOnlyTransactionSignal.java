 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/IsOnlyTransactionSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
    Clears if there is only one transaction in the list of retrieved transactions.
...
public class IsOnlyTransactionSignal implements TrafficLightIfc
{
    ...
    //
    static final long serialVersionUID = 240666891662690501L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.modifytransaction.retrieve.IsOnlyTransactionSignal.class);
    ...
    **/
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        // if only one transaction retrieved
        ...
        // For this signal true, there must be either just one transaction in the
