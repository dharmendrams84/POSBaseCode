 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/CheckForReturnedGiftCardsSite.java /rgbustores_13.4x_generic_branch/6 2011/07/26 16:57:39 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CheckForReturnedGiftCardsSite extends PosSiteActionAdapter
{
    ...
    */
    private void writeJournalEntry(SaleReturnTransactionIfc transaction,
