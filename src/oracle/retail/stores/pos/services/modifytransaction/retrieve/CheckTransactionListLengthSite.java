 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/CheckTransactionListLengthSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
    Check the length of suspended transaction list and mail different letters. So that
    when database is offline, no retrieved suspended transaction situation will be handled <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class CheckTransactionListLengthSite extends PosSiteActionAdapter
{                                       // begin class CheckTransactionListLengthSite
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Check the length of suspended transaction list. So that when database is offline,
       no retrieved suspended transaction situation will be handled.<P>
