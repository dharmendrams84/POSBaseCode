 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/retrieve/LookupSuspendedTransactionsSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:30 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{
    private static final long serialVersionUID = -2633533243810956379L;
    ...
    **/
    ...
    {                                   // begin toString()
        ...
        strResult.append("LookupSuspendedTransactionsSite (Revision ")
