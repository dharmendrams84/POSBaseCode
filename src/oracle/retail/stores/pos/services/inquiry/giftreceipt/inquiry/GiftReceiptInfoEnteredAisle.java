 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/inquiry/giftreceipt/inquiry/GiftReceiptInfoEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:45 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GiftReceiptInfoEnteredAisle extends LaneActionAdapter implements LaneActionIfc
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        BigDecimal price = cargo.convertPriceCodeToPrice(ui.getInput());
        ...
        showGiftCodeJournale(ui.getInput(), price);
     ...
     */
    protected void showGiftCodeJournale(String giftCode, BigDecimal giftPrice)
    {
