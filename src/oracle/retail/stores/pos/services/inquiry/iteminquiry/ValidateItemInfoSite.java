 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/inquiry/iteminquiry/ValidateItemInfoSite.java /rgbustores_13.4x_generic_branch/1 2011/05/12 15:58:53 rrkohli Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            if((pm.getStringValue(SEARCH_FOR_ITEM_BY_MANUFACTURER)).equalsIgnoreCase("Yes"))
            {
        ...
        {
        	if (inquiry.getDescription() == null && inquiry.getItemID() == null && inquiry.getPosItemID() == null 
        	 && inquiry.getItemNumber() == null && inquiry.getManufacturer() == null)
            {
        	    allNullFields = true;
            }
        } else if (inquiry.getDescription() == null && inquiry.getItemID() == null 
        ...
        if (!isValidField(inquiry.getItemNumber()) || !isValidField(inquiry.getItemID()) || !isValidField(inquiry.getPosItemID()) 
         || !isValidField(inquiry.getDescription()) || (searchForItemByManufacturer && !isValidField(inquiry.getManufacturer())))
        {
       ...
       else if (anyInvalidField)
       {
        ...
        else
        {
            ...
            searchInquiry.setSearchItemByItemNumber(inquiry.isSearchItemByItemNumber());
            searchInquiry.setItemNumber(replaceStar(inquiry.getItemNumber()));
            
            searchInquiry.setSearchItemByItemID(inquiry.isSearchItemByItemID());
            searchInquiry.setItemID(replaceStar(inquiry.getItemID()));
            
            searchInquiry.setSearchItemByPosItemID(inquiry.isSearchItemByPosItemID());
            searchInquiry.setPosItemID(replaceStar(inquiry.getPosItemID()));
    ...
    **/
    ...
    public String getItems(BusIfc bus, ItemInquiryCargo cargo, SearchCriteriaIfc inquiry)
    {
        ...
        try
        {
            ...
            {
                // get department info
                DepartmentIfc department = getDepartment(utility, cargo.getOperator().getStoreID(), pluItems[0].getDepartmentID());
        ...
        catch (DataException de)
        {
            ...
            logger.warn(
                "ItemNo: " + inquiry.getItemID() + " \nItem Desc: " + inquiry.getDescription() + " \nItem Dept: " + inquiry.getDepartmentID() + " \nItem Manufacturer: " + inquiry.getManufacturer() + "" );
