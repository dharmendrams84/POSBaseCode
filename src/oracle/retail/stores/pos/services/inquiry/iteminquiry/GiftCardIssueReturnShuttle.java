 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/inquiry/iteminquiry/GiftCardIssueReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:44 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GiftCardIssueReturnShuttle implements ShuttleIfc
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.inquiry.iteminquiry.GiftCardIssueReturnShuttle.class);
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Loads cargo for Sale service. <P>
       <B>Pre-Condition(s)</B>
       <UL>
       <LI>Cargo will contain the retail transaction
       </UL>
    ...
    **/
    ...
    { // begin unload()
        ...
        if ( giftCardCargo.getItemQuantity().compareTo(BigDecimalConstants.ONE) == 0 )
        {
    ...
    **/
    ...
    { // begin toString()
        ...
        String strResult =
            new String(
                "Class:  GiftCardIssueReturnShuttle (Revision "
                    + revisionNumber
                    + ") @"
                    + hashCode());
        // pass back result
