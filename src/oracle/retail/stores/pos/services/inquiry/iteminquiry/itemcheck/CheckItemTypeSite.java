 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/inquiry/iteminquiry/itemcheck/CheckItemTypeSite.java /rgbustores_13.4x_generic_branch/4 2011/09/02 14:48:19 cgreene Exp $
 * ===========================================================================
 * NOTES
...
import oracle.retail.stores.pos.services.inquiry.iteminquiry.itemvalidate.ValidateItemInfoSite;
...
public class CheckItemTypeSite extends PosSiteActionAdapter implements ProductGroupConstantsIfc
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        {
            letter = ValidateItemInfoSite.LETTER_MULTIPLE_ITEMS_FOUND;
        }
