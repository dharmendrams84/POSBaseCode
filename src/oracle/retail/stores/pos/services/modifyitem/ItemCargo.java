 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/ItemCargo.java /main/24 2011/02/16 09:13:32 cgreene Exp $
 * ===========================================================================
                ...
                if (items[i].isTaxChanged())
                {
                    ...
                    if (taxScope == TaxIfc.TAX_SCOPE_ITEM) //scope must be item
                    {
                        if(taxMode == TaxConstantsIfc.TAX_MODE_OVERRIDE_RATE)
                        {
                            ...
                            String taxModeFlag =I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JOURNAL_PREFIX+".taxflag."+taxDesc,null);
                            String taxModeDesc = I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JOURNAL_PREFIX+".taxdesc."+TaxConstantsIfc.TAX_MODE_DESCRIPTOR[taxMode],null);
                        ...
                        journal.journal(getCashier().getLoginID(), getTransactionID(), sb.toString());
                    }
                }
            }
        }
