 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/serialnumber/GetSerialNumberSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:25 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GetSerialNumberSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        UINLabel = srli.getPLUItem().getItemClassification().getUINLabel();
        ...
        if (srli.isFromExternalOrder() || itemSerial != null || !isItemSerialised ||
                cargo.isKitHeader() || hasReturnLineItems || cargo.isForReturn())
        {
