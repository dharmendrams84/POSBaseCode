 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/serialnumber/SerializedItemCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:25 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SerializedItemCargo extends AbstractFinancialCargo implements CargoIfc
{
    ...
    {
        item = (SaleReturnLineItemIfc)lineItemIterator.next();
        return item;
    }
    /**
