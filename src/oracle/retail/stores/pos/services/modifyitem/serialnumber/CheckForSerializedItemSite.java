 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/serialnumber/CheckForSerializedItemSite.java /rgbustores_13.4x_generic_branch/2 2011/08/10 12:32:11 cgreene Exp $
 * ===========================================================================
 * NOTES
        ...
        while (cargo.hasMoreLineItems())
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // For Order initiate transactions, serial number should not
