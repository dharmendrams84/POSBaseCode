 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/ServiceItemSelectedAisle.java /rgbustores_13.4x_generic_branch/1 2011/04/19 16:41:43 jkoppolu Exp $
 * ===========================================================================
 * NOTES
...
public class ServiceItemSelectedAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        PLUItemIfc pluItem = beanModel.getSelectedItem();
        ...
        try
        {
            ...
            PLUTransaction pluTransaction = (PLUTransaction) DataTransactionFactory.create(DataTransactionKeys.PLU_TRANSACTION);
        ...
        catch (DataException de)
        {
            ...
            model.setArgs(new String[]{pluItem.getPosItemID()});
