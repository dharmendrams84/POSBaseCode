 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/DontAttachItemGiftRegistryAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:24 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DontAttachItemGiftRegistryAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        StringBuffer buf =
            new StringBuffer("DontAttachItemGiftRegistryAisle Received input:");
...
//                .append("  Gift Reg.: ") .append(newGiftId);
    ...
    **/
    ...
    {                                   // begin toString()
        ...
        // result string
        String strResult = new String("Class:  DonTAttachItemGiftRegistryAisle (Revision " +
                                      getRevisionNumber() +
                                      ")" +
                                      hashCode());
