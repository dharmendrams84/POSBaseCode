 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeefind/EditCheckAisle.java /rgbustores_13.4x_generic_branch/1 2011/09/22 17:33:16 tksharma Exp $
 * ===========================================================================
 * NOTES
...
public class EditCheckAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if(EmployeeTypeEnum.TEMPORARY.equals(cargo.getEmployee().getType()))
        {
            employee.setDaysValid(model.getSelectedDaysValidValue());
        }
