 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeefind/DisplayTemporaryPasswordSite.java /main/12 2011/02/25 15:24:53 hyin Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayTemporaryPasswordSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        logEJEntry(cargo.getEmployee().getLoginID());
	 ...
	 */
	// --------------------------------------------------------------------------
    private void logEJEntry(String empID)
    {
