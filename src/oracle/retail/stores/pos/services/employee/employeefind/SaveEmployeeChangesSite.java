 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeefind/SaveEmployeeChangesSite.java /rgbustores_13.4x_generic_branch/1 2011/09/22 17:33:18 tksharma Exp $
 * ===========================================================================
 * NOTES
	...
	public void arrive(BusIfc bus) {
		...
		try
		{
            ...
            if (!current.equals(original)) {
                ...
                journalString.append(I18NHelper.getString(
                        I18NConstantsIfc.EJOURNAL_TYPE,
                        JournalConstantsIfc.OLD_SOCIAL_SECURITY_NUMBER_LABEL,
                        dataArgs));
                journalString.append(Util.EOL);
                dataArgs[0] = current;
                journalString.append(I18NHelper.getString(
                        I18NConstantsIfc.EJOURNAL_TYPE,
                        JournalConstantsIfc.SOCIAL_SECURITY_NUMBER_LABEL,
                        dataArgs));
            }
            ...
            EmployeeFindUtility.logEJEntry(journalString.toString());
		...
		catch (DataException de)
		{
			...
			EmployeeFindUtility.logEJEntry(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.SAVE_UNSUCCESSFUL_LABEL, null) + Util.EOL);
