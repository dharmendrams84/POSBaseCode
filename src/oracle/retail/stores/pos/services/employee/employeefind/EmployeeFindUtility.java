 ...
 * ===================================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeefind/EmployeeFindUtility.java /main/1 2011/02/25 15:24:53 hyin Exp $
 * ===================================================================================
 * NOTES
...
public class EmployeeFindUtility {
    ...
    private static JournalManagerIfc journalMgr = (JournalManagerIfc) Gateway.getDispatcher().getManager(JournalManagerIfc.TYPE);
     ...
     * @param journalStr
     */
    public static void logEJEntry(String journalStr)
    {
        if (journalMgr != null)
        {
