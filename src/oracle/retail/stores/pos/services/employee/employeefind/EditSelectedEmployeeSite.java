 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeefind/EditSelectedEmployeeSite.java /rgbustores_13.4x_generic_branch/2 2011/10/25 11:30:23 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EditSelectedEmployeeSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setRoles(cargo.getRoleTitles());
        ...
        if (cargo.getEmployee() != null )
        {
            ...
            {
                model.setDaysValidList(getDaysValidList(bus));
