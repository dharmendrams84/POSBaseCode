 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeemain/SelectEmployeeOptionUndoRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:09 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SelectEmployeeOptionUndoRoad extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.EXITING_EMPLOYEE_LABEL, null));
