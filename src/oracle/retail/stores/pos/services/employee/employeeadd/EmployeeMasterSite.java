 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeeadd/EmployeeMasterSite.java /rgbustores_13.4x_generic_branch/2 2011/10/25 11:30:23 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EmployeeMasterSite extends PosSiteActionAdapter
{
     ...
     */
    protected static EmployeeMasterBeanModel populateModel(BusIfc bus)
        throws DataException
    {
        ...
        String[] roles = cargo.getRoleTitles();
        ...
        {
            // Populate the days valid field
            String[] daysValidList = populateDaysValid(bus);
            model.setDaysValidList(daysValidList);
        ...
        else
        {
            ...
            if (cargo.getEmployee() != null)
            {
                model.setSelectedDaysValidValue(cargo.getEmployee().getDaysValid());
            }
            else
            {
                model.setSelectedDaysValidValue(1);
            }
        }
