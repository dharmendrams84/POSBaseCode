 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeeadd/CheckDuplicateIDSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:09 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (!trainingModeOn) {
            ...
            {   
            	...
            	{
            	    //If Employee Login Id is not edited then do nothing.
                ...
                // employee = empTransaction.getEmployee(cargo.getEmployee().getEmployeeID());
                employee = empTransaction.getEmployee(cargo.getEmployee().getLoginID());
