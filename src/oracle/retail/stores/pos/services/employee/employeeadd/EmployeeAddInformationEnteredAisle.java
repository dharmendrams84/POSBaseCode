 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeeadd/EmployeeAddInformationEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/09/22 17:33:11 tksharma Exp $
 * ===========================================================================
 * NOTES
    ...
    implements LaneActionIfc
{
    ...
    protected static EmployeeIfc createEmployeeFromModel(BusIfc bus)
    {
        ...
        if (EmployeeTypeEnum.TEMPORARY.equals(addEmployeeType))
        {
            ...
            int selectedDaysValidValue = model.getSelectedDaysValidValue();
