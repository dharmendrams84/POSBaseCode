 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/redeem/EnterRedeemNumberUISite.java /rgbustores_13.4x_generic_branch/2 2011/07/07 12:20:03 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        String pattern =
            utility.retrieveText(
                    ...
                    "redeemText",
                    "RedeemNumberPrompt",
            "Enter {0} number, then press Next, or press Foreign.");
