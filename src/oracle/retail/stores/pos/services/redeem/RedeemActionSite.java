 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/redeem/RedeemActionSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:10 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//              use default locale for currency and date time display
            ...
            redeemTender.setTenderAttributes(cargo.getTenderAttributes());
        ...
        catch (TenderException te)
        {
            ...
            if (error == TenderErrorCodeEnum.CERTIFICATE_TENDERED)
            {
                ...
                args[0] = utility.retrieveDialogText(cargo.getRedeemTypeSelected(), cargo.getRedeemTypeSelected());
                args[1] = (String) redeemTender.getTenderAttributes().get(TenderConstants.NUMBER);
                args[2] = (String) redeemTender.getTenderAttributes().get(TenderConstants.REDEEM_TRANSACTION_ID);
                args[3] = (String) redeemTender.getTenderAttributes().get(TenderConstants.REDEEM_DATE);
