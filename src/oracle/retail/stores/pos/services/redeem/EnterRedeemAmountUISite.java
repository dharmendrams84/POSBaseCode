 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/redeem/EnterRedeemAmountUISite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:10 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
    ...
    public void arrive(BusIfc bus)
    {
        ...
        journalmgr = (JournalManagerIfc) Gateway.getDispatcher().getManager(JournalManagerIfc.TYPE);
        ...
        String pattern =
            utility.retrieveText(
                    ...
                    "redeemText",
                    "RedeemAmountPrompt",
            "Enter amount of {0}, then press Next.");
