 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/main/tdo/MainTDO.java /rgbustores_13.4x_generic_branch/1 2011/08/30 14:10:07 mchellap Exp $
 * ===========================================================================
 * NOTES
...
public class MainTDO extends TDOAdapter implements MainTDOIfc
{
     ...
     * through Spring in ServiceContext.xml. It will create scheduled jobs
     * for retrieving datasets from the store server.  It should schedule
     * automatically, but for some reason the bean must be loaded
     * in order for the scheduling to occur.
     *
     */
    ...
    protected void otherInit(BusIfc bus) throws TDOException
    {
        ...
        UtilityManagerIfc utility = null;
        ...
        readAndConfigureTaxRules(bus, storeID, utility);
    }
     ...
     * @throws TDOException
     */
    protected void readAndConfigureTaxRules(BusIfc bus, String storeID, UtilityManagerIfc utility) throws TDOException
    {
        ////////// start Tax Rules
        // ////////////////////////////////////////////////
        MainCargo cargo = (MainCargo) bus.getCargo();
        ...
        try
        {
            ...
            Hashtable<Integer, Vector<NewTaxRuleIfc>> taxGroupTaxRulesMapping = taxTDO.createTaxGroupTaxRuleMappingForStore(storeID, state);
            // Save the tax group and tax rules mapping in utility.
            if (utility != null)
            {
                utility.setTaxGroupTaxRulesMapping(taxGroupTaxRulesMapping);
            }
            else
            {
