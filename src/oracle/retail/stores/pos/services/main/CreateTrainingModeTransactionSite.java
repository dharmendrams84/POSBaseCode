 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/main/CreateTrainingModeTransactionSite.java /rgbustores_13.4x_generic_branch/2 2011/09/22 13:24:34 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class CreateTrainingModeTransactionSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        utility.initializeTransaction((TransactionIfc)transaction, bus, -1);
        ...
        try
        {
            ...
            if (transaction.getTransactionType() == TransactionIfc.TYPE_EXIT_TRAINING_MODE)
            {
