 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/main/MainMenuSite.java /rgbustores_13.4x_generic_branch/4 2011/09/01 11:50:28 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class MainMenuSite extends PosSiteActionAdapter
{
    ...
    /**
     * Number of seconds the Data Manager waits before attempting the next transaction.
     */
    ...
    {
        // When the application comes to main menu, there won't be any open transaction
        ...
        try
        {
            ...
            // Check that a licensed 3rd party browser is available for this installation
