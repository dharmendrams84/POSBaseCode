 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/enrollment/GetCustomerInfoSite.java /rgbustores_13.4x_generic_branch/2 2011/05/18 14:10:36 sgu Exp $
 * ===========================================================================
 * NOTES
...
import oracle.retail.stores.pos.ui.beans.InstantCreditBeanModel;
...
public class GetCustomerInfoSite extends PosSiteActionAdapter
{
	...
	public void arrive(BusIfc bus)
	{
		...
		if (cargo.getTransaction() == null)
		{
			...
			trans
					.setTransactionType(TransactionIfc.TYPE_INSTANT_CREDIT_ENROLLMENT);
