 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/enrollment/CompleteEnrollmentSite.java /rgbustores_13.4x_generic_branch/2 2011/08/17 11:00:52 sgu Exp $
 * ===========================================================================
 * NOTES
...
public class CompleteEnrollmentSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        // save transaction
        saveTransaction(bus, cargo, utility);
    ...
    protected boolean printTemporaryPass(BusIfc bus, ParameterManagerIfc pm,
            ...
            POSDeviceActions pda, UtilityManager util)
    {
        try
        {
     ...
     */
    protected void saveTransaction(BusIfc bus, InstantCreditCargo cargo, UtilityManager utility)
    {
