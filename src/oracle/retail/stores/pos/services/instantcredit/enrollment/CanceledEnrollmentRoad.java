 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/enrollment/CanceledEnrollmentRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:14 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        UtilityManager utility =
            (UtilityManager) bus.getManager(UtilityManagerIfc.TYPE);
        ...
        if (transaction != null)
        {
               ...
               (cargo.getTransaction().getTransactionType() == TransactionIfc.TYPE_INSTANT_CREDIT_ENROLLMENT))
            {
                ...
                try
                {
                    ...
                    TillIfc till = (TillIfc) register.getCurrentTill();
                ...
                // write hard totals
                error = writeHardTotals(bus, utility, error);
     ...
     */
    //------------------------------------------------------------------------------------
    protected boolean writeHardTotals(BusIfc bus, UtilityManager utility, boolean error)
    {
        try
        {
     ...
     */
    //--------------------------------------------------------------------------------------------
    protected void journalTransaction(BusIfc bus,
