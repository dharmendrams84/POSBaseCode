 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/enrollment/AuthorizeEnrollmentSite.java /rgbustores_13.4x_generic_branch/14 2011/10/29 14:02:29 sgu Exp $
 * ===========================================================================
 * NOTES
...
/**
 * @version $Revision: /rgbustores_13.4x_generic_branch/14 $
 */
public class AuthorizeEnrollmentSite extends PosSiteActionAdapter
{
     ...
     */
    public static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/14 $";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            card = ValidationUtility.createInstantCredit(response,cargo.getCustomer(), cargo.getSsn(),null);
        }
    ...
    */
    ...
    /**
     * Gets only the numeric element of the phone number. Doesn't return the
     * "(" or ")" or "-"
     * @param phone Phone Number
     * @return formatted phone number
     * @deprecated As of 13.3, no replacement.
     */
    protected StringBuilder formatPhoneNumber(PhoneIfc phone)
    {
