 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/CreateTempPassSite.java /rgbustores_13.4x_generic_branch/11 2011/10/31 08:48:24 jswan Exp $
 * ===========================================================================
 * NOTES
...
/**
 * @version $Revision: /rgbustores_13.4x_generic_branch/11 $
 */
public class CreateTempPassSite extends PosSiteActionAdapter
{
    ...
    public static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/11 $";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (InstantCreditApprovalStatus.APPROVED.equals(status))
        {
            ...
            try
            {
                InstantCreditIfc card = ValidationUtility.createInstantCredit(response, null, cargo.getSsn(), null);
                cargo.setInstantCredit(card);

                // write Journal entry
                writeJournal(cargo, util);
