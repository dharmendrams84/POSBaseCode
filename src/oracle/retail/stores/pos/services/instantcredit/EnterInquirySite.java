 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/EnterInquirySite.java /rgbustores_13.4x_generic_branch/3 2011/08/30 11:34:33 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EnterInquirySite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (cargo.getSsn() == null && (cargo.getHomePhone() != null || cargo.getZipCode() != null))
        {
            model = (InstantCreditInquiryCriteriaBeanModel)ui.getModel(POSUIManagerIfc.INSTANT_CREDIT_INQUIRY_CRITERIA);
            model.setSsn(null); // make sure ssn is cleared
        }
        else
        {
