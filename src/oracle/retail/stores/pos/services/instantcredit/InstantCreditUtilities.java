 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/InstantCreditUtilities.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:15 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
                                                  ...
                                                  ParameterManagerIfc pm)
    {
        ...
        if (customer != null )
        {
            ...
            Vector addressVector = customer.getAddresses();
            ...
            if (!addressVector.isEmpty())
            {
                ...
                if (addr != null)
                {
                    ...
                    model.setExtZipCode(addr.getPostalCodeExtension());
                }
            }
            else
            {
