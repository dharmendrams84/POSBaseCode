 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/ValidateInquiryAisle.java /rgbustores_13.4x_generic_branch/4 2011/08/30 11:34:34 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateInquiryAisle extends LaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {
            UIUtilities.setDialogModel(ui, DialogScreensIfc.ERROR, "InvalidSSN", null, "Retry");
        }
    }
}
