 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/ShippingAddressLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    {                                   // begin unload()
        ...
        if ( itemCargo.isItemUpdate() )
        {
            ...
            SendPackageLineItemIfc sendPackage = totals.getSendPackages()[sendLabelIndex-1];
