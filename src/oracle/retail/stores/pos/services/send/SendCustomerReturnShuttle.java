 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/SendCustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SendCustomerReturnShuttle implements ShuttleIfc
{
    ...
    public void unload(BusIfc bus)
    {
        ...
        // link the customer
        sendMgr.linkCustomer(iCargo);

        // journal customer tour exit
        if(txn != null)
        {
           CustomerUtilities.journalCustomerExit(txn.getCashier().getEmployeeID(),
