 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/address/DisplaySendMethodReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{ // begin class DisplaySendMethodReturnShuttle
    ...
    public void unload(BusIfc bus)
    {
        ...
        for (int i = 0; i < sendItems.length; i++)
        {
            ...
            sendItems[i].getItemPrice().setItemTax((ItemTaxIfc) cargo.getLineItems()[i].getItemPrice().getItemTax().clone());
        }
        sendCargo.getTransaction().setTransactionTotals(cargo.getTransaction().getTransactionTotals());
        sendCargo.setParameter(cargo.getParameter());
        sendCargo.setPartialShippingCharges(cargo.getPartialShippingCharges());
        sendCargo.setShipToInfo(cargo.getShipToInfo());
    } // end unload()
