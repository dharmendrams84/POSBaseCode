 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/address/DisplayShippingAddressSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayShippingAddressSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        {         
            CustomerInfoBeanModel custModel = CustomerUtilities.getCustomerInfo(shipCustomer, 
                                                          utility,
                                                          pm);
