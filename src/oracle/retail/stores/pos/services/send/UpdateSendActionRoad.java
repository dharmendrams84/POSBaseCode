 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/UpdateSendActionRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class UpdateSendActionRoad extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        for ( int i = 0; i < allItems.length; i++ )
        {
            ...
            if ( item.getSendLabelCount() == sendLabelIndex )
            {
