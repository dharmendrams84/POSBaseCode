 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/send/displaysendmethod/DisplaySendMethodSite.java /rgbustores_13.4x_generic_branch/1 2011/07/18 13:00:21 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class DisplaySendMethodSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        finally
        {
            ...
            if ( cargo.isItemUpdate() )
            {
                ...
                ShippingMethodIfc method = totals.getSendPackages()[cargo.getSendIndex()-1].getShippingMethod();
                int selectedIndex = 0;
                for ( int i = 0; i < methods.length; i++ )
                {
    ...
    /**
     * @deprecated as of 13.1 use {@link #toShippingMethods(CodeEntryIfc[])} instead
     */
    protected ShippingMethodIfc[] setShippingMethods(CodeEntryIfc[] methodList)
    {
        return toShippingMethods(methodList);
    }
