 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/validateid/ValidateIDInfoSite.java /rgbustores_13.4x_generic_branch/1 2011/07/20 04:31:53 rrkohli Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
            ...
            cargo.getIdTypeName().equals("DriversLicense"))
        {
            ...
            if(util.getParameterValue("ValidateDriverLicenseFormat", "Y").equals("Y"))
            {
                try
                {
                  util.validateDriversLicense(cargo.getIdNumberEncipheredData().getDecryptedNumber().getBytes(),
                      cargo.getIDState(),
                      cargo.getIDCountry());
