 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/printing/FrankTendersSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:12 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class FrankTendersSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    protected static final String ECHECK = 
        DomainGateway.getFactory().getTenderTypeMapInstance()
        ...
        try
        {
                ...
                && frankConfig.length != 0)
            {
                ...
                if (frankGiftCertIssued)
                {
                    ...
                    {
                        Vector<AbstractTransactionLineItemIfc> lineItems = ((RetailTransactionIfc)cargo.getTransaction()).getLineItemsVector();
