 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/printing/CaptureEmailUISite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:12 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureEmailUISite extends PosSiteActionAdapter {
    ...
    public void arrive(BusIfc bus) 
    {
        ...
        if("Email".equals(currentLetter) || "PrintEmail".equals(currentLetter))
        {
            //email option is selected, set flag to print eReceipt.
            if("Email".equals(currentLetter))
            {
