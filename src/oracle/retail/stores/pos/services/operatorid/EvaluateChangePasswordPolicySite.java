 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/operatorid/EvaluateChangePasswordPolicySite.java /main/11 2011/02/23 10:45:34 mkutiana Exp $
 * ===========================================================================
 * NOTES
...
public class EvaluateChangePasswordPolicySite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        String newPassword = beanModel.getNewPassword();
        ...
        if (result.equals(PasswordEvaluationResultEnum.SUCCESS))
        {
			...
			if (!CheckTrainingReentryMode.isTrainingRetryOn(cargo.getRegister()))
			{
        		...
        		result.equals(PasswordEvaluationResultEnum.TOO_SHORT))
        {
