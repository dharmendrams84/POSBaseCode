 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/operatorid/OperatorIdCargo.java /rgbustores_13.4x_generic_branch/1 2011/07/12 11:02:00 mchellap Exp $
 * ===========================================================================
 * NOTES
...
{ // begin class OperatorIdCargo
    ...
    { // begin getSelectedEmployee()
        return (selectedEmployee);
    } // end getSelectedEmployee()
    ...
    { // begin setSelectedEmployee()
        selectedEmployee = value;
    } // end setSelectedEmployee()
    ...
    // ----------------------------------------------------------------------------
    /**
     * Retrieves that user has entered into the UI..
     * <P>
     * 
     * @return that user has entered into the UI.
     * @throws UnsupportedEncodingException Caller should catch this since it
     *             should not be used.
     * @deprecated as of 12.1. Please use {@link #getEmployeePasswordBytes()}.
     **/
    // ----------------------------------------------------------------------------
    public String getEmployeePassword() throws UnsupportedEncodingException
    { // begin getEmployeePassword()
        return new String(employeePassword, EmployeeIfc.PASSWORD_CHARSET);
    } // end getEmployeePassword()

    // ----------------------------------------------------------------------------
    /**
     * Sets that user has entered into the UI.
     * 
     * @param value that user has entered into the UI.
     * @deprecated as of 12.1. Please use
     *             {@link #setEmployeePasswordBytes(byte[])}.
     **/
    // ----------------------------------------------------------------------------
    public void setEmployeePassword(String value)
    { // begin setEmployeePassword()
        try
        {
            employeePassword = value.getBytes(EmployeeIfc.PASSWORD_CHARSET);
        }
        catch (UnsupportedEncodingException e)
        {
            Logger.getLogger(OperatorIdCargo.class).error("Unable to use UTF-8 char set", e);
            employeePassword = value.getBytes();
        }
    } // end setEmployeePassword()
    ...
    { // begin getEmployeePasswordBytes()
        return (employeePassword);
    } // end getEmployeePasswordBytes()
    ...
    { // begin setEmployeePasswordBytes()
        employeePassword = value;
    } // end setEmployeePasswordBytes()
    ...
    { // begin isPasswordRequiredWithList()
        return (passwordRequiredWithList);
    } // end isPasswordRequiredWithList()
    ...
    { // begin setPasswordRequiredWithList()
        passwordRequiredWithList = value;
    } // end setPasswordRequiredWithList()
    ...
    { // begin getmaximumAttempts()
        return (maximumAttempts);
    } // end getmaximumAttempts()
    ...
    { // begin setmaximumAttempts()
        maximumAttempts = value;
    } // end setmaximumAttempts()
    ...
    { // begin setOperatorIdScreenName()
        operatorIdScreenName = value;
    } // end setOperatorIdScreenName()
