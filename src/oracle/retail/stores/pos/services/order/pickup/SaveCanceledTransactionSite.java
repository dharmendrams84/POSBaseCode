 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/pickup/SaveCanceledTransactionSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:33 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (transaction != null)
        {
            ...
            for (int i=0; i<allItems.length; i++)
            {
                 ...
                 if (status > OrderLineItemIfc.ORDER_ITEM_STATUS_PICKED_UP)
                 {
