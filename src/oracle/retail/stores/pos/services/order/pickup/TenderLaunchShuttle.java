 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/pickup/TenderLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:33 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{                                       // begin class TenderLaunchShuttle
    ...
    **/
    ...
    {                                   // begin unload()
        ...
        {
            logger.error("ADOException caught", e);
        }
        ...
        if (originalReturnTransactions != null)
        {
            ...
            for (int i=0; i< originalReturnTransactions.length; i++)
            {
                ...
                {
                    logger.error("ADOException caught", e2);
                }
