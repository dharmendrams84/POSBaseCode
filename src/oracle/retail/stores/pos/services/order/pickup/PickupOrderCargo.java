 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/pickup/PickupOrderCargo.java /rgbustores_13.4x_generic_branch/2 2011/08/09 11:31:52 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class PickupOrderCargo extends OrderCargo implements RetailTransactionCargoIfc
{
    ...
    // Original order line items prior to pickup - pos use
    protected AbstractTransactionLineItemIfc[] savedOrderItems = null;
    ...
    // Original order prior to pickup
    ...
    /**
     * Sets the order line items on the order in cargo.
     * 
     * @param
     * @deprecated As of release 5.0.0
     */
    public void setSavedOrderItems(AbstractTransactionLineItemIfc[] value)
    {
        savedOrderItems = value;
    }

    /**
     * Gets the order line items from the order in cargo.
     * 
     * @return AbstractTransactionLineItemIfc[]
     * @deprecated As of release 5.0.0
     */
    public AbstractTransactionLineItemIfc[] getSavedOrderItems()
    {
    ...
    /**
     * Sets the a copy of order in cargo.
     * 
     * @param
     */
    ...
    /**
     * Gets the copy of the order in cargo.
     * 
     * @return OrderIfc
     */
    public OrderIfc getSavedOrder()
    {
        return savedOrder;
    }
