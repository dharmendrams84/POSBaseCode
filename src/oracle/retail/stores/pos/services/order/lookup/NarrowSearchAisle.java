 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/lookup/NarrowSearchAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:34 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class NarrowSearchAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {
            result = new Letter(CommonLetterIfc.STATUS);
        }
