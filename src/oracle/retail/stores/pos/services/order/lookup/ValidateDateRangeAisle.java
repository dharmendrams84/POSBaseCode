 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/lookup/ValidateDateRangeAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:34 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateDateRangeAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        StatusSearchBeanModel model = null;
        DateSearchBeanModel model1 = null;
        EYSDate startDate = null;
        EYSDate endDate = null;

        if ((cargo.getSearchMethod() == OrderSearchCargoIfc.SEARCH_BY_ORDER_ID) ||
            (cargo.getSearchMethod() == OrderSearchCargoIfc.SEARCH_BY_CUSTOMER))
        {
            model1 = (DateSearchBeanModel)ui.getModel(POSUIManagerIfc.NARROW_SEARCH);
            startDate = model1.getStartDate();
            endDate = model1.getEndDate();
        }
        else
        {
