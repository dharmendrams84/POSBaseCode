 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/lookup/NoMatchConversionAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:34 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class NoMatchConversionAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        // determine which letter to send based upon search method
        if (cargo.getSearchMethod() == OrderSearchCargoIfc.SEARCH_BY_ORDER_STATUS) // status search
        {
            result = new Letter(CommonLetterIfc.STATUS); // status based search - loop around
        }
