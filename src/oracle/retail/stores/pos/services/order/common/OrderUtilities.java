 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/common/OrderUtilities.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:33 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OrderUtilities
{
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
       journalOrder is used for PrintOrder, FillOrder, CancelOrder
       and PickupOrder services. A journal entry is made
       with minor modifications depending on the type of calling service.
       ...
       @deprecated Since 12.0, use public void journalOrder(OrderIfc,String,int,AbstractFinancialCargo,ParameterManagerIfc)
    **/
    //--------------------------------------------------------------------------
    ...
    {
        journalOrder(order, transactionID, serviceType, cargo, null);
    }
    ...
    **/
                             ...
                             ParameterManagerIfc pm)
    {
        ...
        {
//            journalText.append("\n  Location: ")
//                .append(order.getStatus().getLocation());
...
//        sb.append("\n  Old Status: ").append(previousStatus)
//          .append("\n  New Status: ").append(order.getStatus().getStatus().statusToString());
    ...
    **/
    ...
    public StringBuilder printLineItem(OrderLineItemIfc item)
    {
        ...
        if (status == OrderLineItemIfc.ORDER_ITEM_STATUS_CANCELED)
        {
        ...
        String previousStatus = "";
        if (prevStatus == OrderLineItemIfc.ORDER_ITEM_STATUS_UNDEFINED)
        {
            previousStatus = "Undefined";
        }
        else
        ...
        if (status != OrderLineItemIfc.ORDER_ITEM_STATUS_CANCELED && status != OrderLineItemIfc.ORDER_ITEM_STATUS_PICKED_UP)
        {
        //++ CR 27545
