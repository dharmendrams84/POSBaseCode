 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/common/OrderCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:33 mszekely Exp $
 * ===========================================================================
 * NOTES
                                   ...
                                   OrderSearchCargoIfc //<-extends CustomerSelectCargoIfc,DBErrorCargoIfc
{
    ...
    protected     Vector                  summaries       = new Vector(10);
    ...
    **/
    ...
    public void setSelectedSummary(OrderSummaryEntryIfc value)
    {
        if (summaries.contains(value))
        {
            ...
            "OrderSummaryEntryIfc not contained in OrderCargo summaries storage.");
    }

    //--------------------------------------------------------------------------
    /**
        Sets selected OrderSummaryEntryIfc attribute to null.
        @param removeFromList flags whether to also remove the summary from
    ...
    **/
    ...
    {
        searchType = name;
        //status search always uses date range
        if (searchType == OrderSearchCargoIfc.SEARCH_BY_ORDER_STATUS)
        {
            setDateRange(true);
        }
    }
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
        Gets the value of searchStatus, a status search method which the cargo will be used for.
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
        Gets the value of orderID, search orderID method which the cargo will be used for.
        @return int representation of the summaryStatus
    **/
    //--------------------------------------------------------------------------
