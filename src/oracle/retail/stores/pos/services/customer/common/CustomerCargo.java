 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/common/CustomerCargo.java /rgbustores_13.4x_generic_branch/2 2011/11/03 14:06:02 sgu Exp $
 * ===========================================================================
 * NOTES
...
**/
//--------------------------------------------------------------------------
public class CustomerCargo extends UserAccessCargo implements  TourCamIfc, CargoIfc, Serializable
{
    ...
    **/
    protected CustomerIfc[] customerList = null;
    ...
    **/
    ...
    /**
        The sales associate for the transaction - set in Launch Shuttle
...
//  ----------------------------------------------------------------------
    ...
    **/
    //---------------------------------------------------------------------
    public CustomerIfc[] getCustomerList()
    {
        return customerList;
    }
    ...
    **/
    ...
    {
        /*
         * This is only here because CustomerSelectBeanModel still
         * requires a Vector.
         */
        Vector list = new Vector();
        for (int i = 0; i < customerList.length; ++i)
        {
            list.addElement(customerList[i]);
        }
        return(list);
    }
    ...
    **/
    //---------------------------------------------------------------------
    public void setCustomerList(CustomerIfc[] customerList)
    {
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
        Sets the access employee. <P>
        @param value    the employee
        @deprecated as of release 5.0.0, replace by {@link #setOperator()}
    **/
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    /**
        Returns the access employee. <P>
        @return the employee
        @deprecated as of release 5.0.0, replace by {@link #getOperator()}
    **/
    //---------------------------------------------------------------------
...
// Tourcam record is set to OFF. Do not need the following two methods
    ...
    **/
    ...
    {
        isActionPickupDelivery = isActionPickupDelivery;
    }
    // --------------------------------------------------------------------------
    /**
