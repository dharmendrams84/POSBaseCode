 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/common/CheckDiscountChangesSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:26 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
       ...
       // pull off new customer group ID for comparison
        ...
        if ((newCustomerGroup != null && !(cargo.getOverride())) ||
        ...
        {
           // if user is not authorized and the discount type is not changed then user
           // should be allowed to proceed further without prompting for manager override
