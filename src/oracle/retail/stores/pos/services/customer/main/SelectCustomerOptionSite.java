 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/main/SelectCustomerOptionSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:27 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (cargo.isInitialEntry())
        {
            if (cargo.getTransactionID() != null)
            {
              ...
              CustomerUtilities.journalCustomerEnter(cargo.getOperator().getEmployeeID(),
