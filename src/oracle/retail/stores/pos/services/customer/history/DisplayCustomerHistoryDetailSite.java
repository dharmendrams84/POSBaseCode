 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/history/DisplayCustomerHistoryDetailSite.java /rgbustores_13.4x_generic_branch/2 2011/07/14 12:11:50 vtemker Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            ReadTransactionsForReturn dt = null;

            dt = (ReadTransactionsForReturn) DataTransactionFactory.create(DataTransactionKeys.READ_TRANSACTIONS_FOR_RETURN);
