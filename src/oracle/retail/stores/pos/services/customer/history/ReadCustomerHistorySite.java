 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/history/ReadCustomerHistorySite.java /main/14 2011/02/16 09:13:24 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ReadCustomerHistorySite extends SiteActionAdapter
{
    ...
    static public int getMaximumNumberOfTransactions(BusIfc bus)
    {
        ...
        try
        {
            values  = pm.getParameterValues(ParameterConstantsIfc.CUSTOMER_CustomerMaximumMatches);
