 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/delete/DeleteCustomerRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:26 mszekely Exp $
 * ===========================================================================
 * NOTES
...
import oracle.retail.stores.domain.arts.CustomerDeleteDataTransaction;
...
//--------------------------------------------------------------------------
/**
    Site to mark customer deleted in the database. <p>
    $Log:
     3    360Commerce 1.2         3/31/2005 4:27:43 PM   Robert Pearse
     2    360Commerce 1.1         3/10/2005 10:20:53 AM  Robert Pearse
     1    360Commerce 1.0         2/11/2005 12:10:33 PM  Robert Pearse
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if(cargo.getRegister().getWorkstation().isTrainingMode() == false)
        {
            ...
            try
            {
                CustomerDeleteDataTransaction ct = null;

                ct = (CustomerDeleteDataTransaction) DataTransactionFactory.create(DataTransactionKeys.CUSTOMER_DELETE_DATA_TRANSACTION);
