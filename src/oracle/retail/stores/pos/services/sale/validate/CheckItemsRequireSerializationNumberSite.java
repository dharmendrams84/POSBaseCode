 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/validate/CheckItemsRequireSerializationNumberSite.java /rgbustores_13.4x_generic_branch/1 2012/02/14 13:24:39 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class CheckItemsRequireSerializationNumberSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        {
            if(abstractItems[index] instanceof SaleReturnLineItemIfc)
            {
                ...
                if(srli.isSerializedItem() && Util.isEmpty(srli.getItemSerial()))
                {
                    ...
                    if(srli.getOrderItemStatus() != null &&
                            ...
                            srli.getOrderItemStatus().getItemDispositionCode() != OrderLineItemIfc.ORDER_ITEM_DISPOSITION_DELIVERY &&
