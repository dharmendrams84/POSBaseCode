 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/GiftOptionsReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 16:17:11 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{                                       // begin class GiftOptionsReturnShuttle()
    ...
    **/
    ...
    {                                   // begin unload()
         ...
         */
        if ( quantity.compareTo(BigDecimalConstants.ONE) == 0 )
        { 
