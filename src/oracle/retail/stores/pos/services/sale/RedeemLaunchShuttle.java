 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/RedeemLaunchShuttle.java /rgbustores_13.4x_generic_branch/2 2011/08/15 10:24:52 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class RedeemLaunchShuttle extends FinancialCargoShuttle implements ShuttleIfc
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.sale.RedeemLaunchShuttle.class);
