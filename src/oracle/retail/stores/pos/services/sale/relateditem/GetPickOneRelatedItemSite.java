 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/relateditem/GetPickOneRelatedItemSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 16:17:11 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
/**
     This site asks the associate to pick 1 or none of the displayed items.
     $Revision: /rgbustores_13.4x_generic_branch/1 $
 **/
//--------------------------------------------------------------------------
public class GetPickOneRelatedItemSite extends PosSiteActionAdapter
{
    //----------------------------------------------------------------------
    /**
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        RelatedItemIfc[] relatedItems = sortRelatedItems(cargo.getRelatedItems());
    ...
    **/
    ...
    {
        RelatedItemCargo cargo = (RelatedItemCargo)bus.getCargo();
        if (bus.getCurrentLetter().getName().equals("Add"))
        {
            POSUIManagerIfc  ui = (POSUIManagerIfc)bus.getManager(UIManagerIfc.TYPE);
            RelatedItemListBeanModel relatedModel =
                (RelatedItemListBeanModel) ui.getModel(POSUIManagerIfc.PICK_ONE_RELATED_ITEM);
            ...
            if(ri != null)
            {
                ...
                RelatedItemIfc[] allRelatedItems = item.getPLUItem().getRelatedItemContainer().getRelatedItems(RelatedItemGroupIfc.PICK_ONE);
