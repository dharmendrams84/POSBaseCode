 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/RemoveItemRoad.java /rgbustores_13.4x_generic_branch/3 2011/08/10 12:32:12 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class RemoveItemRoad extends PosLaneActionAdapter
{
    ...
    private void removeAllSimilarLineItems(SaleReturnTransactionIfc transaction, String itemID)
    {
        ...
        for (int i = 0; i < saleLineItems.size(); i++)
        {
            ...
            {
                // remove sale items from external order and any related items
