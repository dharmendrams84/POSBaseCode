 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/scansheet/GetSelectedScanSheetItemSite.java /rgbustores_13.4x_generic_branch/1 2012/02/27 18:16:37 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class GetSelectedScanSheetItemSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setSelectedItemaCategory(false);
