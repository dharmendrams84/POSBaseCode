 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/specialorder/add/LinkCustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/2 2012/02/07 13:49:37 blarsen Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        if (customerMainCargo.isLink() && customer != null)
        {
            ...
            CustomerUtilities.journalCustomerExit(customerMainCargo.getOperator().getEmployeeID(),
