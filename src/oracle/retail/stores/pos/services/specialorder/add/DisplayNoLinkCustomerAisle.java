 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/specialorder/add/DisplayNoLinkCustomerAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:02 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayNoLinkCustomerAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        // set arg strings to special order
        String args[] = new String[3];
        args[0] = utility.retrieveDialogText
          ("NoLinkedCustomer.SpecialOrder",
           "Special Order");
        args[1] = args[0];
        args[2] = args[0];
