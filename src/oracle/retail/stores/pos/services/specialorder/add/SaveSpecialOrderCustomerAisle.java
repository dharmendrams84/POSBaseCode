 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/specialorder/add/SaveSpecialOrderCustomerAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:02 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    when the customer data was successfully saved to the database. <P>
    <P>
...
public class SaveSpecialOrderCustomerAisle extends PosLaneActionAdapter
{
    ...
    private static final long serialVersionUID = 2629218826823930504L;
    /**
        class name constant
    **/
