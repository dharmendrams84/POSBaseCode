 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/specialorder/deposit/SpecialOrderDepositSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:03 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SpecialOrderDepositSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        orderTransaction.getOrderStatus().setTotal(grandTotal);
        ...
        orderTransaction.getOrderStatus().setMinimumDepositAmount(minimumDeposit);
        ...
        {
            mailLetter = true;
            orderTransaction.getOrderStatus().setMinimumDepositAmount(grandTotal);
            orderTransaction.getOrderStatus().setDepositAmount(grandTotal);
