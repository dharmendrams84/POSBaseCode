 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/email/detail/StatusAndJournalUpdatesSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:29 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class StatusAndJournalUpdatesSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Update the email status in the system and
       journal this status change.
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        journalManager = (JournalManagerIfc)Gateway.getDispatcher().getManager(
