 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/email/detail/EmailDetailToViewOrderShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:29 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EmailDetailToViewOrderShuttle extends FinancialCargoShuttle
{
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        orderCargo.setSearchMethod(OrderSearchCargoIfc.SEARCH_BY_EMESSAGE);
