 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/giftcertificate/issue/CardNumberEnteredAisle.java /rgbustores_13.4x_generic_branch/2 2011/07/07 12:20:05 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CardNumberEnteredAisle extends PosLaneActionAdapter
{
    ...
    throws Exception
    {
        ...
        cargo.setItemQuantity(new BigDecimal("0.00"));
    }
