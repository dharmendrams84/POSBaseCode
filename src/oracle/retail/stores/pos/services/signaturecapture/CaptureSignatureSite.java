 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/signaturecapture/CaptureSignatureSite.java /rgbustores_13.4x_generic_branch/8 2011/08/24 10:31:30 jswan Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureSignatureSite extends PosSiteActionAdapter
{
    ...
    protected Letter performSignatureCapture(BusIfc bus)
    {
        ...
        // Setup a workstation object with the workstation and store ID values 
        String workstationID = Gateway.getProperty("application", "WorkstationID", "");
        ...
        CPOIPaymentUtility.getInstance().endScrollingReceipt(workstation);
