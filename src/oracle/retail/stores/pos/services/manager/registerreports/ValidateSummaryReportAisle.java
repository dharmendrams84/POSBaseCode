 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/manager/registerreports/ValidateSummaryReportAisle.java /rgbustores_13.4x_generic_branch/4 2011/10/12 15:49:11 mkutiana Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateSummaryReportAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        String dateString =  date.toFormattedString();
    ...
    protected void showErrorDialog(BusIfc bus, String invalidId, String errorCode, DataException ex)
    {
        ...
        if (ex.getErrorCode() != DataException.NO_DATA)
        {
