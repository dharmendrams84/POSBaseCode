 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/manager/registerreports/ValidateOrderStatusReportAisle.java /main/13 2011/03/08 17:21:15 vtemker Exp $
 * ===========================================================================
 * NOTES
        ...
        else
        {
            ...
            try
            {
                switch (statusArray[0])
                {
                    ...
                    data = ordt.retrieveOrderSummaryByStatus(statusArray,
                                                             storeID,
                                                             null,
                                                             null,
                                                             trainingMode);
