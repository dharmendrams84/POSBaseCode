 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/servicealert/ListNewAlertEntriesSite.java /rgbustores_13.4x_generic_branch/2 2011/10/05 15:03:50 mkutiana Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            if (!cargo.retrieveListFailed())
            {
                ...
                // Make a call to the database to get a list of all service entries
                AlertDataTransaction adt = null;

                adt = (AlertDataTransaction) DataTransactionFactory.create(DataTransactionKeys.ALERT_DATA_TRANSACTION);

                alertList = adt.retrieveAlertList(inquiry);
