 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/servicealert/ServiceAlertCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:10 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    also holds any data which might be collected in or passed to this service 
    and required by any services called by this service. The data required by 
    nested service will be placed in that services LaunchShuttle.
     
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class ServiceAlertCargo extends SaleCargo implements SaleCargoIfc, OrderCargoIfc, OrderViewCargoIfc
                                    // PosCargo implements DBErrorCargoIfc
{
    protected AlertEntryIfc selectedEntry = null;   // entry selected from service alert list
    protected OrderIfc order = null;                // holds the retrieved OrderIfc object
    protected EMessageIfc message = null;           // the retrieved EMessage object

    protected int dataExceptionErrorCode = 0;       // data manager return code
    protected boolean viewOrder = true;             // flag for printOrder service display
    protected boolean retrieveListFailed = false;   // Used to make sure we don't keep trying on DB error
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Gets the cashier ID prompt
        Overrides the one defined in PosCargo.
    ...
    **/
    ...
    private static String initOperatorIdPromptText()
    {
        ...
        String operatorIdPromptText = 
          utility.retrieveText(POSUIManagerIfc.PROMPT_AND_RESPONSE_SPEC,
                               BundleConstantsIfc.OPERATORID_BUNDLE_NAME,
                               "OperatorIdentificationPrompt",
                               "Enter cashier ID.");
