 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/foreigncurrency/ForeignCurrencyCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:59 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ForeignCurrencyCargo extends TenderCargo implements Serializable
{
    ...
    /**
     * Maximum number of letters currently supported by foreignCurrency.xml
     * as alternate tenders
     */
    public static final int maximumLetterMatches = 16;
