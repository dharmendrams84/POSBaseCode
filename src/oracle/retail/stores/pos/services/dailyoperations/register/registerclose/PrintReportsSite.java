 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/register/registerclose/PrintReportsSite.java /main/13 2011/02/16 09:13:26 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class PrintReportsSite extends PosSiteActionAdapter
{
    ...
    /**
        register argument text tag
    **/
    protected static String REGISTER_TEXT_TAG = "RegisterPromptArgumentText";
    /**
        register argument text
    **/
    protected static String REGISTER_TEXT = "Register";
    /**
        close argument text tag
    **/
    protected static String CLOSE_TEXT_TAG = "ClosePromptArgumentText";
    /**
        close argument text
    **/
    protected static String CLOSE_TEXT = "has successfully closed";
    /**
        ...
        if (success)
        {
            ...
            String closeText =
              utility.retrieveText(POSUIManagerIfc.PROMPT_AND_RESPONSE_SPEC,
                                   ...
                                   CLOSE_TEXT_TAG,
                                   CLOSE_TEXT);
            StringBuffer argumentText = new StringBuffer(registerText);
            argumentText.append(" ")
                        .append(closeText);
