 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/DisplayTenderSelectionsSite.java /main/19 2011/01/14 15:48:02 npoola Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayTenderSelectionsSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
         ...
         */
        Map<String, Boolean> enableButtonMap = new HashMap<String, Boolean>();
        ...
        for (int i=0; i<sc.length; i++)
        {
            ...
            else
            {
                ...
                if(cargo.getCurrentActivity().equals(PosCountCargo.NONE) && sc[i].getExpectedAmount().signum() > CurrencyIfc.ZERO ) // we have not had anything counted yet
                {
