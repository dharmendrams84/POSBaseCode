 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/EnterSummaryAmountSite.java /rgbustores_13.4x_generic_branch/2 2011/08/25 13:13:14 tksharma Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
            ...
            cargo.getCountType() == PosCountCargo.LOAN)
        {
            ...
            vars[0] = utility.retrieveText("SummaryCountSpec",
                                           BundleConstantsIfc.POSCOUNT_BUNDLE_NAME,
                                           foreignCurrency,
                                           foreignCurrency);
            vars[1] = description;
