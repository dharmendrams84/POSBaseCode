 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/SetupTenderAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SetupTenderAisle extends LaneActionAdapter
{
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  SetupTenderAisle (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
    ...
    **/
    ...
    {                                   // begin main()
        // instantiate class
        SetupTenderAisle obj = new SetupTenderAisle();
