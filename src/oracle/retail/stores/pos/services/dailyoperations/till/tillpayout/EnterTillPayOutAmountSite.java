 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/EnterTillPayOutAmountSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EnterTillPayOutAmountSite extends PosSiteActionAdapter
{
    ...
    protected static String PAY_OUT_TEXT_TAG = "PayOutText";
    protected static String PAY_OUT_TEXT     = "Pay out";
