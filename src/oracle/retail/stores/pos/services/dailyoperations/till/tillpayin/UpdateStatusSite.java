 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayin/UpdateStatusSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:17 mszekely Exp $
 * ===========================================================================
 * NOTES
        ...
        if (saveTransSuccess)
        {
	        ...
	        if (letter.getName().equals(CommonLetterIfc.SUCCESS))
	        {
	            ...
	            if (jmi != null)
	            {
	                ...
	                sb.append(Util.EOL);
	                sb.append(Util.EOL);
	                sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.TILL_PAY_IN_LABEL, null));
	                sb.append(Util.EOL);
	                sb.append(Util.EOL);
	                ...
	                sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.PAY_IN_LABEL, dataArgs));
	                sb.append(Util.EOL);
