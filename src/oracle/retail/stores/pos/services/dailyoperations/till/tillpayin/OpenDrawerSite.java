 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayin/OpenDrawerSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:17 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OpenDrawerSite extends PosSiteActionAdapter
{
    ...
    **/
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYIN_TAG = 
      "CashDrawerRetryContinueCancel.payin";
    /**
      Cash Drawer Retry Continue Cancel payin default text
    **/
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYIN_TEXT = 
      "the till pay-in";
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        String tillPayIn = utility.retrieveDialogText(CASH_DRAWER_RETRY_CONT_CANCEL_PAYIN_TAG,
