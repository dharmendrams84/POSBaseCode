 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillresume/TillEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:21 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class TillEnteredAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        String tillId = ui.getInput().trim();
...
*/                
        ...
        if (bOk)
        {
            ...
            if (tillAccountFlag != regAccountFlag)
            {
                ...
                String[] errorScreenArgs = new String[2];
                errorScreenArgs[0] = tillId;
                errorScreenArgs[1] = utility.retrieveDialogText(TILL_ACCOUNTABILITY_RESUMED_TAG, 
                                                                TILL_ACCOUNTABILITY_RESUMED_TEXT);
    ...
    **/
    ...
    { 
        ...
        {
            args[0] = utility.retrieveDialogText(TillCargo.TILL_OPEN_ERROR_TAG_LINE1,
                                                 TillCargo.TILL_OPEN_ERROR_LINE1);
            args[1] = utility.retrieveDialogText(TillCargo.TILL_OPEN_ERROR_TAG_LINE2,
                    TillCargo.TILL_OPEN_ERROR_LINE2);
        }
        else // suspended
        {
            args[0] = utility.retrieveDialogText(TillCargo.TILL_SUSPENDED_ERROR_TAG_LINE1,
                                                 TillCargo.TILL_SUSPENDED_ERROR_LINE1);
            args[1] = utility.retrieveDialogText(TillCargo.TILL_SUSPENDED_ERROR_TAG_LINE2,
                                                 TillCargo.TILL_SUSPENDED_ERROR_LINE2);
        }
        return args;
    }
}
