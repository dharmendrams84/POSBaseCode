 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillresume/DrawerOccupiedErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:21 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DrawerOccupiedErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {
            args[0] = utility.retrieveDialogText(TillCargoIfc.TILL_SUSPENDED_ERROR_TAG_LINE1,
                    TillCargoIfc.TILL_SUSPENDED_ERROR_LINE1);
            args[1] = utility.retrieveDialogText(TillCargoIfc.TILL_SUSPENDED_ERROR_TAG_LINE2,
                    TillCargoIfc.TILL_SUSPENDED_ERROR_LINE2);
