 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillloan/UpdateStatusSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:17 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class UpdateStatusSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        String tender = DomainGateway.getFactory()
        ...
        if (saveTransSuccess && letter.getName().equals(CommonLetterIfc.SUCCESS))
        {
            ...
            if (jmi != null)
            {
				...
				sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE,
						JournalConstantsIfc.LOAN_COUNT_LABEL, null));
				sb.append(Util.EOL);
				sb.append(Util.EOL);
				sb.append(Util.EOL);
            ...
            if (!countTillLoan.equals(FinancialCountIfc.COUNT_TYPE_DESCRIPTORS[FinancialCountIfc.COUNT_TYPE_NONE]))
            {
                ...
                if (jmi != null)
                {
                    if (countTillLoan.equals(FinancialCountIfc.COUNT_TYPE_DESCRIPTORS[FinancialCountIfc.COUNT_TYPE_DETAIL]))
                    {
                    ...
                    sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.TOTAL_LOAN_LABEL, dataArgs));
                                   }
            }
            ...
            if (!Util.isEmpty(fromRegister))
            {
            	...
            	sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.FROM_REGISTER_LABEL, dataArgs));
            }
