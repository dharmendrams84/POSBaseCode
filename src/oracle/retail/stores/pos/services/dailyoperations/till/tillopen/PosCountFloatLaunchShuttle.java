 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillopen/PosCountFloatLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:21 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class PosCountFloatLaunchShuttle implements ShuttleIfc
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.till.tillopen.PosCountFloatLaunchShuttle.class);
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        register.addTill(opencargo.getTill());
