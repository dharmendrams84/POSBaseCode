 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillloan/PrintReceiptSite.java /main/14 2011/02/16 09:13:26 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class PrintReceiptSite extends PosSiteActionAdapter
{
    ...
    **/
     ...
     * @deprecated as of 13.1 use blueprint configuration instead
     */
    protected static final String LOAN_TEXT_TAG = "CashLoanTextFull";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        argumentText.append(utility.retrieveText(
                ...
                LOAN_TEXT_TAG,LOAN_TEXT)).append("  ");
