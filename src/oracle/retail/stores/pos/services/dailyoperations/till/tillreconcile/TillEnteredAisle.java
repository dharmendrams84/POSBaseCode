 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillreconcile/TillEnteredAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:20 mszekely Exp $
 * ===========================================================================
 * NOTES
            ...
            else 
            {
                ...
                if (register.getTillByID(tillID) == null)
                {
                    ...
                    {    
                        ...
                        errorScreenArgs[1] = utility.retrieveDialogText(TILL_ACCOUNTABILITY_RECONCILED_TAG, 
                                                                        TILL_ACCOUNTABILITY_RECONCILED_TEXT);
