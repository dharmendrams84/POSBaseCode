 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayrollpayout/EnterTillPayrollPayOutAmountSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:19 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EnterTillPayrollPayOutAmountSite extends PosSiteActionAdapter
{
    ...
    protected static String PAYROLL_PAY_OUT_TEXT_TAG = "PayrollPayOutText";
    protected static String PAYROLL_PAY_OUT_TEXT     = "Payroll pay out";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        parModel.setArguments(utility.retrieveText(POSUIManagerIfc.PROMPT_AND_RESPONSE_SPEC,
                                                      BundleConstantsIfc.TILL_BUNDLE_NAME,
                                                      PAYROLL_PAY_OUT_TEXT_TAG,
                                                      PAYROLL_PAY_OUT_TEXT));
