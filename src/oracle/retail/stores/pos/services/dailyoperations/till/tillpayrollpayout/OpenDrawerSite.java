 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayrollpayout/OpenDrawerSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:19 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OpenDrawerSite extends PosSiteActionAdapter
{
    ...
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYROLL_PAYOUT_TAG = 
      "CashDrawerRetryContinueCancel.payrollpayout";
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYROLL_PAYOUT_TEXT = 
      "payroll payout";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        TillCashDrawer.
        tillOpenCashDrawer(bus,utility.retrieveDialogText(CASH_DRAWER_RETRY_CONT_CANCEL_PAYROLL_PAYOUT_TAG,
