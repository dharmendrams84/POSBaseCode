 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayin/EnterTillPayInAmountSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:17 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EnterTillPayInAmountSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    /**
        pay-in text tag
    **/
    protected static String PAY_IN_TEXT_TAG = "PayInText";
    /**
        pay-in text
    **/
    protected static String PAY_IN_TEXT = "pay-in";
