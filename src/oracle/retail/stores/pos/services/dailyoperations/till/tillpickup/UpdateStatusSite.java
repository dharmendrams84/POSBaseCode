 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpickup/UpdateStatusSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class UpdateStatusSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            utility.saveTransaction(transaction, t.getTotals(), till, register, false);
        ...
        if (saveTransSuccess && letter.getName().equals(CommonLetterIfc.SUCCESS))
        {
            ...
            if (jmi != null)
            {
                journal(jmi, cargo, utility, transaction);
            }
            else
            {
                logger.warn(bus.getServiceName() + ": No journal manager found.");
            }
        }
        if (saveTransSuccess)
        {
    ...
    **/
    //--------------------------------------------------------------------------
    private void journal(JournalManagerIfc jmi,
