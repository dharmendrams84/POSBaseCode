 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/endofday/CancelSuspendedTransactionsSite.java /rgbustores_13.4x_generic_branch/3 2011/09/19 12:16:56 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CancelSuspendedTransactionsSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            writeTransaction = (TransactionWriteDataTransaction)DataTransactionFactory
                    .create(DataTransactionKeys.TRANSACTION_WRITE_DATA_TRANSACTION);

            writeTransaction.cancelSuspendedTransactions(cargo.getStoreStatus().getStore().getStoreID(), cargo
                    .getStoreStatus().getBusinessDate());
        ...
        for (int i = 0; i < summaries.length; i++)
        {
            ...
            try
            {
                if (StringUtils.isNotBlank(externalOrderId))
                {
                    ...
                    // cancel order
                    externalOrderManager.cancel(orderId);
