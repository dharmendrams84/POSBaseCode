 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/endofday/StoreStatusUpdateSite.java /rgbustores_13.4x_generic_branch/3 2011/12/01 16:06:40 mchellap Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
/**
 The site updates the store status to closed. <P>
...
{                                       // begin class StoreStatusUpdateSite
    ...
    //----------------------------------------------------------------------
    /**
     Updates the store status database entry to closed. <P>
