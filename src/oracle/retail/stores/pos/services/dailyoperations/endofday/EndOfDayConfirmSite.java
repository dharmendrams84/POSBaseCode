 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/endofday/EndOfDayConfirmSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    { // begin createListModel()
        ...
        for (int i = 0; i < enteredItems.length; i++)
        {
            if (enteredItems[i].isSummary())
            {
                ...
                if (expectedItem.getNumberItemsIn() != 0
