 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/ejournal/DisplayDataSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:07 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DisplayDataSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (data == null || cargo.getNewSearch())
        {
            ...
            {
                // Just grab the sequence number from the 
                // transaction id
                //
        ...
        // If we have a valid index, enable/disable the buttons appropriately.
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Process a letter - it can be selecting a different
       transaction or printing the current one
       @param bus the bus arriving at this site
    **/
    //--------------------------------------------------------------------------

    public void processLetter(BusIfc bus)
    {
        String letterName = bus.getCurrentLetter().getName();
        EJournalCargo cargo = (EJournalCargo) bus.getCargo();
