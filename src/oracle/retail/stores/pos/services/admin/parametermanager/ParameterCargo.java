 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/ParameterCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ParameterCargo extends UserAccessCargo implements CargoIfc, TourCamIfc
{
    ...
    /** Currency */
    public static final String CURRENCY_PM_GROUP = "Currency";
    /** TenderAuthorization */
    ...
    /** OperatorID */
    public static final String OPERATORID_PM_GROUP = "OperatorID";
    /** Browser */
    public static final String BROWSER_PM_GROUP = "Browser";
    /** Customer */
    ...
    /** TimeMaintenance */
    public static final String TIME_MAINTENANCE_PM_GROUP = "TimeMaintenance";
    /** Queue */
    ...
    /** StoreCredit */
    public static final String STORE_CREDIT_PM_GROUP = "StoreCredit";
    /** Inventory */
    public static final String INVENTORY_PM_GROUP = "Inventory";
    /** External Order */
    ...
    /** The collection of (Retail) parameters in the parameter group
        being edited.  **/
    protected Vector retailParameters = new Vector();
    ...
    void setParameterGroups(Vector groups)
    {
        ...
        if (groupToRoleFn.isEmpty())
        {
            for (int i = 0; i < groups.size(); i++)
            {
                ...
                else if (groupName.equals(CURRENCY_PM_GROUP))
                {
                    groupToRoleFn.put(groupName,new Integer(RoleFunctionIfc.PARAMETER_CURRENCY));
                }
                ...
                else if (groupName.equals(BROWSER_PM_GROUP))
                {
                    groupToRoleFn.put(groupName,new Integer(RoleFunctionIfc.PARAMETER_BROWSER));
                }
                else if (groupName.equals(OPERATORID_PM_GROUP))
                {
                    groupToRoleFn.put(groupName,new Integer(RoleFunctionIfc.PARAMETER_OPERATOR_ID));
                }
                ...
                else if (groupName.equals(TIME_MAINTENANCE_PM_GROUP))
                {
                    groupToRoleFn.put(groupName, new Integer(RoleFunctionIfc.PARAMETER_TIME_MAINT));
                }
                ...
                else if (groupName.equals(STORE_CREDIT_PM_GROUP))
                {
                    groupToRoleFn.put(groupName, new Integer(RoleFunctionIfc.PARAMETER_STORE_CREDIT));
                }
