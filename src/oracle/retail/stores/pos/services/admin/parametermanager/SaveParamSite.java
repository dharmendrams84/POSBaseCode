 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/SaveParamSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 **/
//------------------------------------------------------------------------------
public class SaveParamSite extends PosSiteActionAdapter implements
		SiteActionIfc {
	...
	//--------------------------------------------------------------------------
	/**
	 Try to save the parameter values.  Send a letter indicating whether
	 ...
	 **/
	public static String[] STATUS_DESCRIPTORS = { "Closed", "Open",
			"Reconciled", "Suspended" };

	//--------------------------------------------------------------------------
	/**
	 Load the event object used for Audit logging with
	 all the information that has to be logged.
	 ...
	 **/
	//--------------------------------------------------------------------------
	protected void journalParameterChange(ParameterCargo cargo) {
