 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/BadParamValueSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class BadParamValueSite extends PosSiteActionAdapter
{
    ...
    /**
     * minimum value parameter tag
     */
    protected static String MINIMUM_VALUE_TAG = "InvalidNumericParam.MinimumValueString";
    /**
     * minimum value parameter
     */
    protected static String MINIMUM_VALUE = "the minimum value";
    /**
     * maximum value parameter tag
     */
    protected static String MAXIMUM_VALUE_TAG = "InvalidNumericParam.MaximumValueString";
    /**
     * maximum value parameter
     */
    protected static String MAXIMUM_VALUE = "the maximum value";
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        String minStr = utility.retrieveDialogText(MINIMUM_VALUE_TAG,
                                                   MINIMUM_VALUE);
        String maxStr = utility.retrieveDialogText(MAXIMUM_VALUE_TAG,
                                                   MAXIMUM_VALUE);
