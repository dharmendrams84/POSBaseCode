 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/reasoncodemanager/SaveReasonCodeGroupSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:08 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SaveReasonCodeGroupSite extends PosSiteActionAdapter {
    ...
    public void arrive(BusIfc bus) {
        ...
        try {
			...
			Vector reasonCodes = cargo.reasonCodeGroup.getReasonCodes();
            ...
            for (int i = 0; i < reasonCodes.size(); i++) {
                ReasonCode reason = (ReasonCode) reasonCodes.elementAt(i);
        ...
        catch (DataException e) { // begin handle data exception
            // set error code
