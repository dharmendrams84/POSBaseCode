 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/role/setaccess/SetAccessDoneAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:06 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SetAccessDoneAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setNewFunctionAccess(functionAccess, utility);
