 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/role/setaccess/SetAccessUpdatesAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:06 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SetAccessUpdatesAisle extends PosLaneActionAdapter {
    ...
    **/
			...
			if (newRole == true) {
                ...
                while(itr.hasNext())
                {
                	...
                	if(Boolean.TRUE.equals(roleFunction.getAccess()))
                	{
                        ...
                        logRoleTitle.append(APPLICATION_NAME)
                                 .append(" ")
				...
				journalAddRole(employeeID, newRoleName, mapNewFunction);
			} else {
				// for Auditlogging
				ev = (RoleEvent) AuditLoggingUtils.createLogEvent(
	 ...
	 */
	// --------------------------------------------------------------------------
	protected void journalAddRole(String employeeID, String roleName,
			TreeMap map)
