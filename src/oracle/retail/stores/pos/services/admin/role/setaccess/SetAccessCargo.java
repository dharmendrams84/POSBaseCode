 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/role/setaccess/SetAccessCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:06 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SetAccessCargo extends UserAccessCargo implements WriteHardTotalsCargoIfc, DBErrorCargoIfc
{
    ...
    /**
     * Set the new role function access.
     * <P>
     * 
     * @param functionAccess the function access values
    ...
    public void setNewFunctionAccess(String[] functionAccess, UtilityManagerIfc utility)
    {
        ...
        for (int i = 0; i < function.length; i++)
        {
            ...
            if (newFunctionAccess[i].equals(utility.retrieveText(SET_ACCESS_SPEC, BundleConstantsIfc.ROLE_BUNDLE_NAME,
                    YES_TAG, YES_LABEL)))
            {
