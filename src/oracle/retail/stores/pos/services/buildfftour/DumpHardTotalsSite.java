 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/buildfftour/DumpHardTotalsSite.java /main/10 2011/02/16 09:13:25 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class DumpHardTotalsSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            ...
            RandomAccessFile outfile = new RandomAccessFile("hardtotals.txt", "rw");
