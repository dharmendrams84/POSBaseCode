 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/nosale/CompleteNoSaleSite.java /main/16 2011/02/16 09:13:28 cgreene Exp $
 * ===========================================================================
 * NOTES
    ...
    implements ParameterConstantsIfc
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        catch (DataException de)
        {
        	...
        	{
        		DialogBeanModel dialogModel = utility.createErrorDialogBeanModel(de, false);
                // display dialog
            ...
            errorString[0] =
                utility.retrieveDialogText("TranDatabaseError.NoSaleIncomplete", "No sale cannot be completed:");
            errorString[1] = utility.getErrorCodeString(de.getErrorCode());
