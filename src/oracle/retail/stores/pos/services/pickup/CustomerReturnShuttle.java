 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pickup/CustomerReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2012/02/07 13:49:37 blarsen Exp $
 * ===========================================================================
 * NOTES
    ...
    public void unload(BusIfc bus)
    {
        ...
        if (customerMainCargo.isLink() && (customer != null))
        {
            ...
            if (transaction == null)
            {
                ...
                CustomerUtilities.journalCustomerExit(customerMainCargo.getEmployeeID(), customerMainCargo
                        .getTransactionID());
            ...
            {
                CustomerUtilities.journalCustomerLink(transaction.getCashier().getEmployeeID(), customer
        ...
        CustomerUtilities.journalCustomerExit(customerMainCargo.getEmployeeID(), customerMainCargo.getTransactionID());
    }
