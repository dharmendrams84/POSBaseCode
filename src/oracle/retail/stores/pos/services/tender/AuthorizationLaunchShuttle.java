 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/AuthorizationLaunchShuttle.java /rgbustores_13.4x_generic_branch/37 2011/12/29 14:02:52 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class AuthorizationLaunchShuttle extends UserAccessCargoLaunchShuttle
{
    ...
    public void load(BusIfc bus)
    {
        ...
        String transactionID = tenderCargo.getTransaction().getTransactionID();
