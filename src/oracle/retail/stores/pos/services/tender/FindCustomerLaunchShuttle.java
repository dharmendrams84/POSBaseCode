 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/FindCustomerLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:49 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class FindCustomerLaunchShuttle implements ShuttleIfc
{
    ...
    public void unload(BusIfc bus)
    {
        ...
        {
            CustomerUtilities.journalCustomerEnter(trans.getCashier().getEmployeeID(), trans.getTransactionID());
        }
    }
