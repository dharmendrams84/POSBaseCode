 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/ChangeDueOptionsUISite.java /rgbustores_13.4x_generic_branch/10 2011/09/12 16:01:35 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class ChangeDueOptionsUISite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        cpoiPaymentUtility.displayChangeDueScreen(cargo.getRegister().getWorkstation(), cargo.getCurrentTransactionADO().getBalanceDue());
