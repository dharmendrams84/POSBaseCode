 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/capturecustomerinfo/ValidateCustomerInfoSite.java /main/14 2011/02/16 09:13:29 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateCustomerInfoSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        address.setPostalCodeExtension(model.getPostalCodeExt());
        try
        {
