 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/capturecustomerinfo/CaptureCustomerInfoCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:46 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureCustomerInfoCargo implements CargoIfc
{
    ...
    public void setCustomer(CustomerIfc customer)
    {
        ...
        this.customer.setAddresses(customer.getAddresses());
        this.customer.setPhones(customer.getPhones());
    }
