 ...
 * =============================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/RefundOptionsUISite.java /rgbustores_13.4x_generic_branch/6 2011/10/17 14:55:57 sgu Exp $
 * =============================================================================
 * NOTES
 *
 *
...
public class RefundOptionsUISite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        //Paramter change start for RM/POS Refund option
        ParameterManagerIfc paramManager = (ParameterManagerIfc) bus.getManager(ParameterManagerIfc.TYPE);
        Boolean useRMTender = null;
        try
        {
            useRMTender = paramManager.getBooleanValue("UseRMTenders");
        }
        ...
        //If UseRMTender Parameter Value is No , then proceed with POS Tender Options.
        //if Yes, proceed with RM Tender Options.
        if (useRMTender != null && !useRMTender.booleanValue())
        {
        ...
        else
        {
            ...
            {
            //display refund tender options provided from RM with manager override button
                // at the end of tender type list
                attributeMap.put(RefundOptionsTDO.RETURN_RESPONSE, cargo.getReturnResponse());
                ui.showScreen(POSUIManagerIfc.RM_REFUND_OPTIONS, tdo.buildBeanModel(attributeMap));
            }
        }
    }
