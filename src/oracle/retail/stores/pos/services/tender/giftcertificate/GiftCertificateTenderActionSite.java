 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/giftcertificate/GiftCertificateTenderActionSite.java /rgbustores_13.4x_generic_branch/1 2011/07/12 15:58:32 cgreene Exp $
 * ===========================================================================
 * NOTES
...
{
    /** serialVersionUID */
    private static final long serialVersionUID = -10996561794094707L;
    ...
    public void arrive(BusIfc bus)
    {
        ...
        catch (TenderException e)
        {
            ...
            else if (error == TenderErrorCodeEnum.VALIDATION_OFFLINE)
            {
                ...
                cargo.getCurrentTransactionADO().addValidTender(gcTender);
                cargo.setLineDisplayTender(gcTender);
    ...
    protected void showTenderRedeemedDialog(UtilityManagerIfc utility, POSUIManagerIfc ui, HashMap<Object,Object> tenderAttributes)
    {
        ...
        args[1] = (String) tenderAttributes.get(TenderConstants.NUMBER);
        args[2] = (String) tenderAttributes.get(TenderConstants.REDEEM_TRANSACTION_ID);
        args[3] = (String) tenderAttributes.get(TenderConstants.REDEEM_DATE);
