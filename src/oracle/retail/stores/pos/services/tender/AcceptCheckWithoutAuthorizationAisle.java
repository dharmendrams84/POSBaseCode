 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/AcceptCheckWithoutAuthorizationAisle.java /rgbustores_13.4x_generic_branch/2 2011/07/12 15:58:32 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class AcceptCheckWithoutAuthorizationAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    **/
    public void traverse(BusIfc bus)
    {
        ...
        //configure tender attributes to indicate tender is considered Authorized 
        ...
        tenderAttributes.put(TenderConstants.FINANCIAL_NETWORK_STATUS, AuthorizableTenderIfc.AUTHORIZATION_NETWORK_ONLINE);
        ...
        {
            logger.error("TenderException caught while adding tender to the transaction. Unable to obtain Factory", adoe);
        }
