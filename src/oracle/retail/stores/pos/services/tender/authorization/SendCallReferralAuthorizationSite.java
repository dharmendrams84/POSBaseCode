 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/authorization/SendCallReferralAuthorizationSite.java /rgbustores_13.4x_generic_branch/6 2011/11/03 16:06:11 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class SendCallReferralAuthorizationSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if(response != null)
        {
            ...
            authorizationCargo.setCallReferralApprovalCode(approvalCode);
            ...
            authorizationCargo.setCallReferralApprovedAmount(enteredAmount);
            ...
            if(callPaymentManager)
            {
                ...
                if(callReferralRequest.isCallReferralWithoutToken() &&
