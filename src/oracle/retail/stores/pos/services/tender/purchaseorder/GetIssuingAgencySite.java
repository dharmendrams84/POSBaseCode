 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/purchaseorder/GetIssuingAgencySite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:47 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void depart(BusIfc bus)
    {
        ...
        if (letter.getName().equals("Next"))
        {
            ...
            POSUIManagerIfc ui = (POSUIManagerIfc) bus.getManager(UIManagerIfc.TYPE);
            UtilityManagerIfc um = (UtilityManagerIfc)bus.getManager(UtilityManagerIfc.TYPE);
            String otherAgnecy = um.retrieveText("Common", BundleConstantsIfc.PARAMETER_BUNDLE_NAME, "Other", "Other");
            ...
            if (otherAgnecy.equals(agencyName))
            {
