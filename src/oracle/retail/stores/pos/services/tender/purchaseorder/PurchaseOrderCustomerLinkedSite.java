 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/purchaseorder/PurchaseOrderCustomerLinkedSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:47 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class PurchaseOrderCustomerLinkedSite extends PosSiteActionAdapter
{
    ...
    /** Business Invalid Type Strings **/
    public static final String businessInvalid = "InvalidType.business";
    public static final String businessDefault = "business";
    
    /** Purchase Order Tenders Invalid Strings **/
    public static final String poInvalid = "InvalidType.purchaseordertender";
    public static final String poDefault = "purchase order tender";
    ...
    public DialogBeanModel noCustomerLinked(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText
            (businessInvalid,
             businessDefault);
        args[1] = args[0];
        args[2] = utility.retrieveDialogText
            (poInvalid,
             poDefault);
