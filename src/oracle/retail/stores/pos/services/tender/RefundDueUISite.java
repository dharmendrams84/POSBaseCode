 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/RefundDueUISite.java /rgbustores_13.4x_generic_branch/3 2011/07/21 14:27:40 jswan Exp $
 * ===========================================================================
 * NOTES
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (cargo.getCustomer() != null)
        {
            cargo.getCurrentTransactionADO().updateCustomerForRedeemedStoreCredit(cargo.getCustomer(),
                    (String)cargo.getTenderAttributes().get(TenderConstants.ENTRY_METHOD),
