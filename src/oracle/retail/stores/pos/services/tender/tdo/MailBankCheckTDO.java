 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/MailBankCheckTDO.java /main/17 2011/01/14 15:48:01 npoola Exp $
 * ===========================================================================
 * NOTES
...
public class MailBankCheckTDO extends TDOAdapter implements TDOUIIfc
{
    ...
    public void copyFromCustomerToModel(CustomerInfoBeanModel model, CustomerIfc customer, BusIfc bus)
    {
        ...
        if (customer != null)
        {
            ...
            if (address == null)
            {
                ...
                {
                    address = (AddressIfc) addresses.elementAt(0);
                }
                else
                {
                    getLogger().error(
            ...
            if (customerPhone == null)
            {
                ...
                {
                    customerPhone = (PhoneIfc) phones.elementAt(0);
                }
                else
                {
    ...
    public void copyFromModelToMap(CustomerInfoBeanModel model, HashMap attributeMap)
    {
        ...
        attributeMap.put(TenderConstants.POSTAL_CODE_2, model.getExtPostalCode());
        ...
        if (phones != null)
        {
            for (int i = 0; i < phones.length; i++)
            {
                if (phones[i].getPhoneType() == phoneType)
                {
                    ...
                    attributeMap.put(TenderConstants.PHONE_AREA_CODE, phone.getAreaCode());
                    break;
                }
            }
        }
    ...
    public void printMap(HashMap attributeMap)
    {
        ...
        System.out.println(attributeMap.get(TenderConstants.PHONE_AREA_CODE));
