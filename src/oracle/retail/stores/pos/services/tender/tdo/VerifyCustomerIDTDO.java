 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/VerifyCustomerIDTDO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:48 mszekely Exp $
 * ===========================================================================
 * NOTES
                                 ...
                                 implements TDOUIIfc
{
    ...
    public POSBaseBeanModel buildBeanModel(HashMap attributeMap)
    {
        ...
        CodeListIfc personalIDTypes =  um.getReasonCodes(storeID, CodeConstantsIfc.CODE_LIST_CHECK_ID_TYPES);
