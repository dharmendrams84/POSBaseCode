 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/CaptureCustomerInfoTDO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:48 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureCustomerInfoTDO extends TDOAdapter implements TDOUIIfc
{
    ...
    public void customerToModel(CaptureCustomerInfoBeanModel model, BusIfc bus, CaptureCustomerIfc customer)
    {
        ...
        if (customer != null)
        {
            ...
            model.setPhoneNumber(customer.getAreaCode(), customer.getPhoneNumber());
            ...
            model.setPostalCodeExt(customer.getPostalCodeExt());
