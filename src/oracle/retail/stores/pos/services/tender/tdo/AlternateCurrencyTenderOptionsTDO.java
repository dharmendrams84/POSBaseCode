 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/AlternateCurrencyTenderOptionsTDO.java /main/14 2011/01/14 15:48:01 npoola Exp $
 * ===========================================================================
 * NOTES
...
//----------------------------------------------------------------------
/**
   This tdo builds the alternate currency enter amount screen.<P>
   @version $Revision: /main/14 $
**/
//----------------------------------------------------------------------
public class AlternateCurrencyTenderOptionsTDO extends TDOAdapter
                              implements TDOUIIfc
{
    ...
    **/
    ...
    public POSBaseBeanModel buildBeanModel(HashMap attributeMap)
    {
        ...
        String screenName = alternateCurrencyInstance.getDescription()+ SCREEN_NAME_TAG;
        ...
        baseModel.setLocalButtonBeanModel
          (getNavigationBeanModel(alternateCurrencyInstance.getDescription()));
        return baseModel;
    }
    ...
    protected NavigationButtonBeanModel getNavigationBeanModel(String alternateCurrencyDescription)
    {
        ...
        {
            cash = new String[1];
            cash[0] = DomainGateway.getBaseCurrencyInstance().getDescription();
        }
        ...
        if (travelersChecksAccepted == null)
        {
            ...
            travelersChecksAccepted[0] = DomainGateway.getBaseCurrencyInstance().getDescription();
        }
        else
        {
        ...
        if (checksAccepted == null)
        {
            ...
            checksAccepted[0] = DomainGateway.getBaseCurrencyInstance().getDescription();
        }
        else
        {
        ...
        if (giftCertificate == null)
        {
            ...
            giftCertificate[0] = DomainGateway.getBaseCurrencyInstance().getDescription();
        }
        ...
        HashMap tendersList = new HashMap();
     ...
     * @param util
     */
    protected void enableTenderButtons(String alternateCurrencyDescription,
            NavigationButtonBeanModel navModel,
            String acceptedParam,
            HashMap tList,
            UtilityIfc util)
    {
        // tender button
        ...
        if (tenderAccepted == null)
        {
            ...
            tenderAccepted[0] = DomainGateway.getBaseCurrencyInstance().getDescription();
        }
        boolean enableTenderAccepted = util.isStringListed(alternateCurrencyDescription,
                tenderAccepted);
