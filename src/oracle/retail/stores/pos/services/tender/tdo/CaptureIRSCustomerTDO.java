 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/CaptureIRSCustomerTDO.java /rgbustores_13.4x_generic_branch/3 2011/09/02 13:05:37 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureIRSCustomerTDO extends TDOAdapter implements TDOUIIfc
{
    ...
    public void customerToModel(CaptureIRSCustomerBeanModel model, BusIfc bus, CustomerIfc customer)
    {
        ...
        if (customer != null)
        {
            ...
            {
                AddressIfc address = customer.getAddresses().firstElement();
    ...
    public void modelToCustomer(CaptureIRSCustomerBeanModel model, BusIfc bus, IRSCustomerIfc customer)
    {
        if (customer != null)
        {
            ...
            {
                address = customer.getAddresses().firstElement();
            }
