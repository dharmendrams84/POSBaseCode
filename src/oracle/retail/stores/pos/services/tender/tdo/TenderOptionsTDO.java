 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/tdo/TenderOptionsTDO.java /rgbustores_13.4x_generic_branch/7 2011/10/20 18:01:46 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class TenderOptionsTDO extends TDOAdapter implements TDOUIIfc
{
        ...
        HashMap attributeMap)
    {
        ...
        if (!transReentry.booleanValue()
                ...
                && txnRDO.getTransactionType()!= TransactionConstantsIfc.TYPE_ORDER_COMPLETE
                && txnRDO.getTransactionType()!= TransactionConstantsIfc.TYPE_ORDER_PARTIAL
                && txnRDO.getTransactionType()!= TransactionConstantsIfc.TYPE_LAYAWAY_COMPLETE
                && txnRDO.getTransactionType()!= TransactionConstantsIfc.TYPE_LAYAWAY_PAYMENT
