 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/check/ValidateMICRSite.java /rgbustores_13.4x_generic_branch/9 2011/09/12 15:46:42 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ValidateMICRSite extends PosSiteActionAdapter
{
     ...
     */
    public static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/9 $";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        account = accountNumber.getDecryptedNumber().getBytes();
    ...
    private void flushSecuredData(byte[] ...  data)
    {
        for(byte[] secureDataByteArray : data)
        {
            Util.flushByteArray(secureDataByteArray);
        }
