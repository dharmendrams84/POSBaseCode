 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/check/CheckActionSite.java /rgbustores_13.4x_generic_branch/8 2011/10/07 17:41:54 sgu Exp $
 * ===========================================================================
 * NOTES
...
public class CheckActionSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        try
        {
            if (pm.getBooleanValue("E-CheckFunctionality").booleanValue())
            {
                //echeck
