 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/check/GetCheckMICRSite.java /rgbustores_13.4x_generic_branch/10 2011/09/12 15:46:42 cgreene Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    $Revision: /rgbustores_13.4x_generic_branch/10 $
**/
//--------------------------------------------------------------------------
    ...
    */
    ...
    public void arrive(BusIfc bus)
    {
        ...
        else
        {
            ...
            String argText =
                utility.retrieveText("CheckEntrySpec",
                                     BundleConstantsIfc.TENDER_BUNDLE_NAME,
                                     "EnterBankInfo",
                                     "or enter bank information");
