 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/check/GetCheckIDPhoneSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:49 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class GetCheckIDPhoneSite extends PosSiteActionAdapter
{
    ...
    */
    ...
    public void arrive(BusIfc bus)
    {
        ...
        Integer countryIndex = (Integer)cargo.getTenderAttributes().get(TenderConstants.ID_COUNTRY_INDEX);
