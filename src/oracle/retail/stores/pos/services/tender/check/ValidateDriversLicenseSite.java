 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/check/ValidateDriversLicenseSite.java /rgbustores_13.4x_generic_branch/5 2011/09/02 13:05:38 cgreene Exp $
 * ===========================================================================
 * NOTES
        ...
        && tenderAttributes.get(TenderConstants.ID_TYPE).equals("DriversLicense"))
    {
      ...
      if (util.getParameterValue("ValidateDriverLicenseFormat", "Y").equals("Y"))
      {
        try
        {
          ...
          util.validateDriversLicense(checkID.getDecryptedNumber().getBytes(),
