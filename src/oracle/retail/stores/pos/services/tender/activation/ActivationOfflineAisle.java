 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/activation/ActivationOfflineAisle.java /rgbustores_13.4x_generic_branch/7 2012/02/06 15:33:18 mkutiana Exp $
 * ===========================================================================
 * NOTES
 * <other useful comments, qualifications, etc.>
 *
 * MODIFIED    (MM/DD/YY)
 *    mkutiana  02/06/12 - Removing the duplicated parameter
 *                         GiftCardActivationReferralNumber and using existing
...
public class ActivationOfflineAisle extends ActivationErrorAisle
{
    ...
    /** constant for referral dialog name */
    ...
    public void traverse(BusIfc bus)
    {
        ...
        else
        {
            ...
            DialogBeanModel dialogModel = new DialogBeanModel();
            dialogModel.setResourceID(ACTIVATION_REFERRAL_DIALOG);
