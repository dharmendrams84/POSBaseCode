 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/activation/ActivationSite.java /rgbustores_13.4x_generic_branch/15 2011/10/21 10:47:14 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ActivationSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if(response != null)
        {
            ...
            journalResponse(cargo, response, request);
        }
     ...
     */
    protected void journalResponse(ActivationCargo cargo, AuthorizeTransferResponseIfc response, AuthorizeTransferRequestIfc request)
    {
        ...
        if ((jmi != null) && (response != null))
        {
                    ...
                    RequestSubType.ReloadVoid.equals(requestSubType))
            {
                ...
                // journal the entry method
                message.append(Util.EOL);
                dataArgs[0] = response.getEntryMethod();
                message.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.ENTRY_METHOD_LABEL, dataArgs));
