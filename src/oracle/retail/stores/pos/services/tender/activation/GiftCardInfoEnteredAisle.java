 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/activation/GiftCardInfoEnteredAisle.java /rgbustores_13.4x_generic_branch/6 2011/11/14 15:28:16 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class GiftCardInfoEnteredAisle extends PosLaneActionAdapter
{
    ...
    public void traverse(BusIfc bus)
    {
        ...
        if (cardData == null
                || (noError && !GiftCardUtilities.isValidBinRange(pm, utility, cardData, logger, bus.getServiceName())))
        {
            noError = false;
        ...
        if(cardData != null)
        {
            encryptedCardNumber = cardData.getEncryptedAcctNumber();
        }

        // Proceed
        if (noError && encryptedCardNumber != null)
        {
            // journal setting of gift card number before proceeding
            journalSetting(bus, cardData);

            // replace current giftcard card details
            updateGiftCardNumber(cargo, cardData);
