 ...
 * =============================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/TenderCargo.java /rgbustores_13.4x_generic_branch/12 2011/10/17 14:55:57 sgu Exp $
 * =============================================================================
 * NOTES
 *
 *
...
public class TenderCargo extends AbstractFinancialCargo implements RetailTransactionCargoIfc, Serializable
{
    ...
    protected HashMap<String,Object> tenderAttributes = new HashMap<String,Object>();
    ...
    {
        tenderAttributes = new HashMap<String,Object>();
    }
