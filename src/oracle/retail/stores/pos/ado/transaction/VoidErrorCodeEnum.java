 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/transaction/VoidErrorCodeEnum.java /rgbustores_13.4x_generic_branch/4 2011/10/04 14:46:39 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class VoidErrorCodeEnum implements TypesafeEnumIfc
{
    ...
    protected static final HashMap<String, VoidErrorCodeEnum> map = new HashMap<String, VoidErrorCodeEnum>();
