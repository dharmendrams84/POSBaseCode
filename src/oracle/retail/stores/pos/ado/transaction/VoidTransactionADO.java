 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/transaction/VoidTransactionADO.java /rgbustores_13.4x_generic_branch/2 2011/10/19 13:41:31 jswan Exp $
 * ===========================================================================
 * NOTES
...
public class VoidTransactionADO extends AbstractRetailTransactionADO
{
    ...
    */
    ...
    protected LineItemADOIfc[] getLineItemsForType(LineItemTypeEnum type)
    {
        ...
        if (items != null)
        {
            ...
            HashMap lineItemAttributes = new HashMap();
    ...
    **/
    ...
    protected boolean openDrawerForTraining()
    {
        ...
        try
        {
            result = "Y".equalsIgnoreCase(pm.getStringValue("OpenDrawerInTrainingMode"));
        }
