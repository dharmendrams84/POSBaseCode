 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/transaction/LayawayTransactionADO.java /rgbustores_13.4x_generic_branch/4 2011/11/08 16:27:13 blarsen Exp $
 * ===========================================================================
 * NOTES
                                   ...
                                   implements ReturnableTransactionADOIfc
{
    ...
    {
        // completed layways should not have returns made against them
