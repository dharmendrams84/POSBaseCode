 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/CreditTypeEnum.java /rgbustores_13.4x_generic_branch/3 2011/08/16 17:38:36 ohorne Exp $
 * ===========================================================================
 * NOTES
...
public class CreditTypeEnum implements TypesafeEnumIfc
{
    ...
    protected static final HashMap<String,CreditTypeEnum> map = new HashMap<String,CreditTypeEnum>();
