 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/TenderMailCheckADO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:43 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class TenderMailCheckADO extends AbstractTenderADO
{
	...
	public void setTenderAttributes(HashMap tenderAttributes) throws TenderException
	{
		...
		phone.setAreaCode((String) tenderAttributes.get(TenderConstants.PHONE_AREA_CODE));
