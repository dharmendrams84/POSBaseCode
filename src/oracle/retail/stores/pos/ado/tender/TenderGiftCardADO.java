 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/TenderGiftCardADO.java /rgbustores_13.4x_generic_branch/27 2012/02/08 13:00:34 asinton Exp $
 * ===========================================================================
 * NOTES
...
public class TenderGiftCardADO extends AbstractCardTender implements AuthorizableADOIfc, OverridableIfc, ReversibleTenderADOIfc
{
    ...
    {
        return ContextFactory.getInstance().getContext().getRegisterADO().getWorkstationID();
    }
    ...
    {
        return ContextFactory.getInstance().getContext().getRegisterADO().getStoreADO().getStoreID();
    }
}
