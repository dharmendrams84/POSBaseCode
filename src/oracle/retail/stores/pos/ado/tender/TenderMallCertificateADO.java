 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/TenderMallCertificateADO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:43 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class TenderMallCertificateADO extends AbstractTenderADO
{
	...
	public HashMap getTenderAttributes()
	{
		...
		map.put(TenderConstants.NUMBER, ((TenderGiftCertificateIfc)tenderRDO).getNumber());
