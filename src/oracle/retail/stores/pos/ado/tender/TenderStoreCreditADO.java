 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/TenderStoreCreditADO.java /rgbustores_13.4x_generic_branch/3 2011/08/26 16:22:59 vtemker Exp $
 * ===========================================================================
 * NOTES
...
//            ae.printStackTrace();
    ...
    {
        CertificateValidatorIfc certificateValidator = new CertificateValidator((TenderCertificateIfc) tenderRDO);
        certificateValidator.checkStoreNumber();
    }
    ...
    public void setStoreCreditPersonalIdInfo(LocalizedCodeIfc lidType)
    {
        ...
        if (tsc != null && lidType != null)
        {
        	tsc.setPersonalIDType(lidType);
        }

        if (sc != null && lidType != null)
        {
    ...
    {
        return ContextFactory.getInstance().getContext().getRegisterADO().getNextUniqueID();
    }
