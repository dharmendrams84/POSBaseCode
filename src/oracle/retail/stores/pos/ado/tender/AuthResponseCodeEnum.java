 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/AuthResponseCodeEnum.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:42 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AuthResponseCodeEnum implements TypesafeEnumIfc
{
    ...
    protected static final HashMap<String, AuthResponseCodeEnum> map = new HashMap<String, AuthResponseCodeEnum>();
