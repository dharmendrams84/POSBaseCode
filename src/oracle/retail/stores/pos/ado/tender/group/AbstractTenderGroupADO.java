 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/group/AbstractTenderGroupADO.java /rgbustores_13.4x_generic_branch/3 2011/12/20 07:15:59 icole Exp $
 * ===========================================================================
 * NOTES
 * <other useful comments, qualifications, etc.>
 *
 * MODIFIED    (MM/DD/YY)
 *    icole     12/20/11 - Reset evaluate tender limits to ensure proper
 *                         manager overrides.
    ...
    implements TenderGroupADOIfc
{
        ...
        throws TenderException
    {
        ...
        if (!utility.isOvertenderAllowed(tenderType))
        {
            ...
            {
                // formula: tenderAmount - balanceDue <= overtenderLimit
                CurrencyIfc overTenderAmount = tenderAmount.subtract(balanceDue);
                if (overTenderAmount.compareTo(overtenderLimit) == CurrencyIfc.GREATER_THAN)
                {
    ...
    public boolean override(EmployeeIfc overrideEmployee, int roleFunction)
    {
        ...
        SecurityManagerIfc sm =
            (SecurityManagerIfc) context.getManager(SecurityManagerIfc.TYPE);
    ...
    **/
    ...
    public TenderGroupADOIfc createGroupFactoryAndTenderGroup()
    {
        ...
        //groupFactory = createGroupFactory(groupFactory);
        try
        {
            groupFactory =
        ...
        TenderGroupADOIfc voidGroup =
            groupFactory.createTenderGroup(getVoidType());
        return voidGroup;
    }
