 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/tender/TenderGiftCertificateADO.java /rgbustores_13.4x_generic_branch/2 2011/07/07 12:20:05 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class TenderGiftCertificateADO extends AbstractTenderADO
{
    ...
    public void validate() throws TenderException
    {
        ...
        try
        {
            ...
            {
                certificateValidator.checkGiftCertificateStoreNumber();
    ...
    public HashMap getTenderAttributes()
    {
        ...
        map.put(TenderConstants.NUMBER, ((TenderCertificateIfc) tenderRDO).getNumber());
