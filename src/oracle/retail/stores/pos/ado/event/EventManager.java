 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/event/EventManager.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:40 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class EventManager
{
    ...
    **/
    ...
    {
        //Double check to avoid two instances being created in case of thread
        //race condition
        if (instance == null)
        {
