 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/store/RegisterADO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:42 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class RegisterADO extends ADO implements RegisterADOIfc
{
            ...
            EmployeeIfc operatorRDO)
    {
        ...
        ((AbstractRetailTransactionADO)txn).setParameterManager(parameterManager);
    ...
    {
        POSDeviceActions pda = new POSDeviceActions((SessionBusIfc)((TourADOContext)getContext()).getBus());
        writeHardTotals(pda);
    }
