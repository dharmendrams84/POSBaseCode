 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/utility/tdo/AbstractPasswordPolicyTDO.java /rgbustores_13.4x_generic_branch/1 2011/04/11 11:48:40 abondala Exp $
 * ===========================================================================
 * NOTES
...
public abstract class AbstractPasswordPolicyTDO extends TDOAdapter implements PasswordPolicyTDOIfc
{
    ...
    **/
                                   ...
                                   int numberOfFailedPasswords) 
    {
        ...
        if (employee != null && employee.getEmployeeCompliance() != null)
        {
