 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/XMLPOSScreenSpecBuilder.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:37 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class XMLPOSScreenSpecBuilder extends XMLOverlayScreenSpecBuilder implements BuilderIfc
{
    ...
    **/
    protected static Logger logger                                 = Logger.getLogger(oracle.retail.stores.pos.ui.XMLPOSScreenSpecBuilder.class);
    ...
    protected POSBeanSpec       localNavigationBeanSpec             = null;
    ...
    **/
    ...
    public void addChild(Object parent, String childName, Object child)
    {
        ...
        if (childName.equals("BUTTON"))
        {
            ...
            {
                localNavigationBeanSpec = new POSBeanSpec();
            ...
            localNavigationBeanSpec.addButton((ButtonSpec) child);
        }
    ...
    public void setAttribute(String attrName, String attrValue)
    {
            ...
            attrName.equals("tableBean"))
        {
            ...
            if (createSpecs)
            {
                ...
                POSBeanSpec beanSpec = new POSBeanSpec();
    ...
    **/
    ...
    protected void updateProperty(AssignmentSpec spec, String attrName, String attrValue)
    {
        ...
        Map          map   = spec.getBeanProperties();

        if (!(map == null))
        {
            PropertyTrio propTrio = (PropertyTrio)map.get(attrName);
            if (propTrio != null)
            {
    ...
    */
    ...
    protected void updateGlobalButtonState(String actionName, String boolValue)
    {
        ...
        Map map = globalNavigationPanelAssignment.getBeanProperties();
        if (map != null)
        {
            PropertyTrio propTrio = (PropertyTrio)map.get(BUTTON_STATES);
            if (propTrio != null)
            {
    ...
    **/
    ...
    protected void addNextAndClearConnections()
    {
        ...
        Collection cnct = screenSpec.getConnections();
        if (cnct.isEmpty())
        {
