 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/behavior/ConfirmCancelAction.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:07:00 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ConfirmCancelAction extends AbstractAction
{
    ...
    */
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        {
            Logger logger = Logger.getLogger(oracle.retail.stores.pos.ui.behavior.ConfirmCancelAction.class);
            logger.error( "ConfirmCancelAction.performAction() showScreen failed ");
        }
