 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/behavior/HelpAction.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:07:00 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class HelpAction extends AbstractAction
{
    ...
    protected Logger logger = Logger.getLogger(oracle.retail.stores.pos.ui.behavior.HelpAction.class);
    //---------------------------------------------------------------------------
    /**
    ...
    */
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        {
            logger.error("Unable to get the ActiveScreenID");
        }
        ...
        {
            if (ui.getModel() != null &&
                ui.getModel() instanceof POSBaseBeanModel)
                {
        ...
        {
            Logger logger = Logger.getLogger(oracle.retail.stores.pos.ui.behavior.HelpAction.class);
            logger.error( "HelpAction.performAction() failed ");
        }
