 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/plaf/UIFactory.java /rgbustores_13.4x_generic_branch/4 2011/06/27 22:28:24 asinton Exp $
 * ===========================================================================
 * NOTES
...
import oracle.retail.stores.pos.ui.beans.SocialSecurityField;
...
public class UIFactory implements UIFactoryIfc
{
    ...
    /** ui properties
     * @deprecated as of 13.1 Use {@link #uiPropertiesForAllLocales}*/
    protected Properties uiProperties = null;
    ...
    /**
     * Creates and configures an EYSButton.
     *
    ...
    /**
     * Creates and configures a JButton.
     *
     * @param label the display text for the button
     * @param icon an icon for the button
     * @param prefix the lookup identifier to use in configuration
     * @return a configures button
     */
    public JButton createButton(String label, Icon icon, String prefix)
    {
     ...
     * @return a configures button
     */
    public JButton createButton(String name, String label, Icon icon, String prefix)
    {
        JButton button = new JButton(label, icon);
        configureUIComponent(button, prefix);
    ...
    /**
     * Creates and configures a JToggleButton.
     *
     * @param name the name of the widget.
     * @param label the display text for the button
     * @param icon an icon for the button
    ...
    /**
     * Creates and configures an AbstractButton.
     *
     * @param name the name of the widget.
     * @param label the display text for the button
     * @param icon an icon for the button
    ...
    /**
     * Creates and configures a SocialSecurityField.
     * SI SCR-5992, release 7.0.0
     *
     * @param name the name associated with the component
     * @param minLength Minimum Length
     * @param columns Number of Columns
     * @return A SocialSecurityField
     */
    public SocialSecurityField createSocialSecurityField(
            String name,
            String minLength,
            String columns)
    {
        SocialSecurityField socialSecurityField = new SocialSecurityField();

        socialSecurityField.setName(name);
        socialSecurityField.setMinLength(Integer.parseInt(minLength));
        socialSecurityField.setColumns(Integer.parseInt(columns));
        socialSecurityField.setMinimumSize(getMinimumFieldSizeProperty());
        configureUIComponent(socialSecurityField, VALIDATING_FIELD);
     ...
     * @deprecated as of 13.1 Use {@link #getUIProperty(String, Locale)}
     */
    public String getUIProperty(String prop)
    {
        Locale lcl = LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE);
        return getUIProperty(prop, lcl);
    }
    ...
    {
        return getUIProperties(lcl).getProperty(prop);
    }


    /**
     * Loads a ui properties object from a file. This object is used by the
     * look and feel to set ui defaults.
     *
     * @param fileName the name of the ui properties file
     * @deprecated as of 13.1 Use {@link #setLookAndFeelFileName(String) and
     *    #setUIProperties(Locale)}
     */
    public void setUIProperties(String fileName)
    {
        lafFile = fileName;
        Locale lcl = LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE);
        setUIProperties(lcl);
    ...
    public void setUIProperties(Locale lcl)
    {
        ...
        String fullFileName = lafFile + "_" + bestMatch.toString() + ".properties";
        Properties uiProperties = UIUtilities.loadProperties(fullFileName);
        uiPropertiesForAllLocales.put(bestMatch, uiProperties);
    }

    /**
     * Returns the ui properties object.
     *
     * @return the ui properties
     * @deprecated as of 13.1 Use {@link #getUIProperties(Locale)}
     */
    public Properties getUIProperties()
    {
    	Locale lcl = LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE);
        return getUIProperties(lcl);
    }
    /**
