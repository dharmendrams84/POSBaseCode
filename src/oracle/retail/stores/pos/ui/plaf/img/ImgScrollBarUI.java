 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/plaf/img/ImgScrollBarUI.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:07:00 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
 *      Implements a bigger scrollbar ui that its easier to manipulate on a touch screen
...
public class ImgScrollBarUI extends BasicScrollBarUI
{
    ...
    {
        JButton button = UIFactory.getInstance().createButton(null,null,"ScrollUpButton");
    ...
    {
        JButton button = UIFactory.getInstance().createButton(null,null,"ScrollDownButton");
