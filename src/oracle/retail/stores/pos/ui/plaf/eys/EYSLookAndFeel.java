 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/plaf/eys/EYSLookAndFeel.java /rgbustores_13.4x_generic_branch/2 2011/06/23 11:33:23 rrkohli Exp $
 * ===========================================================================
 * NOTES
...
public class EYSLookAndFeel extends BasicLookAndFeel
{
    ...
    protected void initClassDefaults(UIDefaults table)
    {
        ...
        Object[] uiDefaults =
        {
                       "ButtonUI", packageName + "EYSButtonUI",
