 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/plaf/eys/EYSUIFactory.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:07:01 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class  EYSUIFactory extends UIFactory
{
    ...
    //--------------------------------------------------------------------------
    /**
     *  Overrides UIFactory.createButton to set the button size
     *  based on default dimensions.
    ...
    {
        JButton button = super.createButton(label, icon, prefix);
        configureButton(button, prefix);
        return button;
    }
    ...
    //--------------------------------------------------------------------------
    /**
     *  Overrides UIFactory.getConstraints to provide bean-specific
     *  constraints objects for ButtonBars, dataEntry beans, and Renderers.
