 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/LocationBeanModel.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:55 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//    protected Integer selectedInventoryLocationId = new Integer(InventoryLocationIfc.SALES_FLOOR);
    ...
    public void loadOrder(OrderIfc order)
    {
        ...
        customerNameField = order.getCustomer().getCustomerName();
