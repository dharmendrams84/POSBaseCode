 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ValidatingList.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:53 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ValidatingList extends JList implements ValidatingFieldIfc
{
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
        Sets the label associated with the field. <p>
    ...
    **/
    ...
    {
        String strResult = new String("Class: ValidatingList (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
