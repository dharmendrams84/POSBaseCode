 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/AlterationsBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:59 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class AlterationsBean extends ValidatingBean
{
    ...
    */
    ...
    protected void initFields()
    {
        ...
        ItemNumberField = uiFactory.createAlphaNumericField
