 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/CheckEntryBean.java /main/16 2011/02/16 09:13:31 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CheckEntryBean extends ValidatingBean implements DocumentListener
{
    ...
    public static void main(String[] args)
    {
        ...
        CheckEntryBeanModel
            beanModel = new CheckEntryBeanModel();
            beanModel.setABANumber("8768768768");
            beanModel.setAccountNumber("18kjh6iuy36");
            beanModel.setCheckNumber("666");
            ...
            beanModel.setDOBValid(false);

        CheckEntryBean
            bean = new CheckEntryBean();
            bean.configure();
