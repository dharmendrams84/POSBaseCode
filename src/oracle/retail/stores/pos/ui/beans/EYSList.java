 ...
 */
//------------------------------------------------------------------------------
public class EYSList extends JList
{
     ...
     * 
     * @param msr
     *            a subclass of AbstractMultiSelectRenderer
     */
    public EYSList(DefaultListModel dlm)
    {
        super(dlm);
     ...
     *            a subclass of AbstractMultiSelectRenderer
     */
    public EYSList(AbstractListRenderer msr)
    {
        super();
        initialize(msr);
    }
    ...
    //------------------------------------------------------------------------------
    /**
     * Overriden for multiselect mode so that the current selected index is not
    ...
    public void setSelectedIndex(int index)
    {
        ...
        {
            int old = listSelectionModel.getHighlightItem();
    ...
    //--------------------------------------------------------------------------
    /**
     * Return the previously highlighted row from the selection model. This is
     * a convenience method which accesses the list selection model.
     * <P>
     * 
