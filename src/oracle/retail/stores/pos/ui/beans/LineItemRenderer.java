 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/LineItemRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:43 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class LineItemRenderer extends AbstractListRenderer
{
    ...
    /** the line weights */
    public static int[] LINE_WEIGHTS2 = {21,16,21,21,21}; // {33,14,16,14,18,8};   // (+1,0,0,0,+1,+1)

    /** the line cell widths */
    public static int[] LINE_WIDTHS = {3,1,1}; // {33,14,16,14,18,8};   // (+1,0,0,0,+1,+1)

    /** the line cell widths */
    public static int[] LINE_WIDTHS2 = {1,1,1,1,1}; // {33,14,16,14,18,8};   // (+1,0,0,0,+1,+1)
    ...
    /** the tax column */
    public static int TAX         = 2;

    /** the stock number column */
    public static int STOCK_NUM   = 3;
    /** the quantity column */
