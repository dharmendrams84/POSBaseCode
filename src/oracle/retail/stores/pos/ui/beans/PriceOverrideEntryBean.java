 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/PriceOverrideEntryBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:46 mszekely Exp $
 * ===========================================================================
...
public class PriceOverrideEntryBean extends ValidatingBean
{
    ...
    protected HashMap<String, String> reverseMap = new HashMap<String, String>();
    ...
    public void configure()
    {
        ...
        UIUtilities.layoutDataPanel(this,
                                    ...
                                    new JComponent[] {overridePriceField, reasonList});
    ...
    public void updateModel()
    {
        ...
        {
            beanModel.setSelectedReasonCode((String)reverseMap.get(selectedReasonCode));
        }
        else
        {
