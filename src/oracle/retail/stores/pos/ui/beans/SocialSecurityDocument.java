 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/SocialSecurityDocument.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:45 mszekely Exp $
 * ===========================================================================
 * NOTES
...
*/
//-------------------------------------------------------------------------
class SocialSecurityDocument extends PlainDocument
{
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
       Gets the first 3 digits of the Social Security number
       @return first 3 digits of the Social Security number
    */
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    /**
       Gets the middle 2 digits of the Social Security number
       @return middle 2 digits of the Social Security number
    */
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    /**
       Gets the last 3 digits of the Social Security number
       @return last 3 digits of the Social Security number
    */
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    /**
       Gets the format for the Social Security.
       @return a pattern string for the Social Security
    */
    //---------------------------------------------------------------------
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
       Inserts a digit into First Part of Social security Number.
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
       Inserts a digit into Second Part of Social security Number.
       @param offset the position in the document to insert the digit
       @param digit the character digit to insert
       @param attributes the attributes for the text to insert
       @exception BadLocationException if the digit cannot be inserted
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
       Inserts a digit into Third Part of Social security Number.
       @param offset the position in the document to insert the digit
       @param digit the character digit to insert
       @param attributes the attributes for the text to insert
       @exception BadLocationException if the digit cannot be inserted
