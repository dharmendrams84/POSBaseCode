 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OrderListRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:45 mszekely Exp $
 * ===========================================================================
 * NOTES
...

{
    ...
    */
    ...
    public void setData(Object value)
    {
        ...
        labels[CUSTOMER].setText(order.getCustomerName());
        ...
        {
            String orderType = OrderConstantsIfc.ORDER_CHANNEL_DESCRIPTORS[order.getInitiatingChannel()];
    ...
    */
    ...
    public Object createPrototype()
    {
        ...
        order.setOrderTotal(DomainGateway.getBaseCurrencyInstance());
