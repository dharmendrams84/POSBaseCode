 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/POSFocusManager.java /rgbustores_13.4x_generic_branch/1 2011/08/24 11:31:13 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class POSFocusManager extends DefaultKeyboardFocusManager
{
    ...
    public boolean dispatchEvent(AWTEvent e)
    {
        ...
        if (dispatched && e instanceof KeyEvent)
        {
            ...
            if (!ke.isConsumed())
            {
                ...
                {
                    System.out.println("Component " + ke.getComponent());
                }
            }
            else if (debug)
            {
    ...
    protected void recordKeyStroke(KeyEvent aEvent)
    {
        if(aEvent.getID() == KeyEvent.KEY_PRESSED)
        {
            try
            {
                FileWriter fw = new FileWriter(recordKeyStrokesFile, true);
