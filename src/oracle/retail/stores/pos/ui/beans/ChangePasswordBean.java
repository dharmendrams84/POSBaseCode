 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ChangePasswordBean.java /rgbustores_13.4x_generic_branch/2 2011/07/12 13:46:52 mchellap Exp $
 * ===========================================================================
 * NOTES
...
public class ChangePasswordBean extends ValidatingBean
{
    ...
    public void updateBean()
    {
    	...
    	beanModel.setPassword("");
    	beanModel.setNewPassword("");
    	beanModel.setVerifyPassword("");
    ...
    public void updateModel()
    {
        ...
        beanModel.setPassword(new String(passwordField.getPassword()));
        beanModel.setNewPassword(new String(newPasswordField.getPassword()));
        beanModel.setVerifyPassword(new String(verifyPasswordField.getPassword()));
    }
