 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/TaxOverrideRateBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class TaxOverrideRateBean extends SelectionListBean
{
    ...
    protected void updateBean()
    {
        if(beanModel instanceof DecimalWithReasonBeanModel)
        {
            ...
            if (myModel.getValue() == null || myModel.getValue().compareTo(Util.I_BIG_DECIMAL_ZERO) == 0)
            {
