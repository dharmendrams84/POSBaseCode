 ...
 * =============================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ReturnResponseLineItemRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:44 mszekely Exp $
 * =============================================================================
 * NOTES
                                  ...
                                  implements CodeConstantsIfc
{
    ...
    public void setData(Object value)
    {
        ...
        labels[APPROVE_DENY_CODE].setText(lineItem.getApproveDenyCode());
                ...
                && !incrementNonMerchandiseQuantity.booleanValue())
        {
            ...
            labels[EXT_PRICE].setText(lineItem.getReturnItem().getPrice()
        ...
        else if (lineItem.isUnitOfMeasureItem())
        {
            ...
            labels[QUANTITY].setText(LocaleUtilities.formatDecimal(lineItem.getItemQuantityDecimal(),
                                                                   getLocale()));
            labels[EXT_PRICE].setText(lineItem.getReturnItem().getPrice().multiply(lineItem.getItemQuantityDecimal())
                    .toGroupFormattedString());
        }
        else
        {
