...
* ===========================================================================
* $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/InstantCreditInquiryCriteriaBean.java /rgbustores_13.4x_generic_branch/3 2011/08/30 11:34:33 cgreene Exp $
* ===========================================================================
* NOTES
...
public class InstantCreditInquiryCriteriaBean extends ValidatingBean
{
    ...
    public void updateModel()
    {
        ...
        beanModel.setCountryIndex(countryField.getSelectedIndex());
        beanModel.setSsn(ssnField.getSocialSecurityNumber());
