 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/PromptAndResponseBean.java /rgbustores_13.4x_generic_branch/7 2011/09/07 08:33:36 jswan Exp $
 * ===========================================================================
 * NOTES
    ...
    implements ClearActionListener, ResponseTextListener
{
     ...
     *
     * @param focus a string with the value of "true" or "false"
     */
    public void setEnterData(String focus)
    {
        enterData = UIUtilities.getBooleanValue(focus);
    }
    ...
    public void setVisible(boolean aFlag)
    {
        ...
        if (aFlag)
        {
            ...
            else
            {
                ...
                activeResponseField.setEnabled(false);
                activeResponseField.setEditable(false);
                activeResponseField.setVisible(false);
    ...
    /**
     * Receive Fingerprint data. Called by the UI Framework.
     *
     * @param data DeviceModelIfc
     */
