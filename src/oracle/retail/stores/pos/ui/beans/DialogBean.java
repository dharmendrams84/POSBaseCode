 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DialogBean.java /rgbustores_13.4x_generic_branch/4 2011/09/21 14:28:24 jswan Exp $
 * ===========================================================================
 * NOTES
...
public class DialogBean extends CycleRootPanel
{
    ...
    protected static String[] BUTTON_ADD      = null; //{"Later", LATER_LETTER, "l"};
    protected static String[] BUTTON_UPDATE   = null; //{"Later", LATER_LETTER, "l"};
   ...
   protected void initButtonsText()
   {
        if (BUTTONS == null  || (beanModel.getLocale() != null && !beanModel.getLocale().equals(getLocale())))
        {
            ...
            BUTTON_ADD = new String[] { retrieveText("AddBtn", "Add"),
                    ADD_LETTER, retrieveText("AddBtnMnemonic", "l")};

            BUTTON_UPDATE = new String[] { retrieveText("UpdateBtn", "Update"),
                    UPDATE_LETTER, retrieveText("UpdateBtnMnemonic", "l")};
