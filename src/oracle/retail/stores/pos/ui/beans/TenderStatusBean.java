...
public class TenderStatusBean extends BaseBeanAdapter
{
  ...
  protected void initComponents()
  {
    ...
    balanceDueStaticLabel.setFont(f.deriveFont(f.getStyle() ^ Font.BOLD));
    balanceDueStaticLabel.setFont(f.deriveFont(18f));
    balanceDueField = uiFactory.createLabel("balanceDueField", "27.05", null, prefix);
    f = balanceDueField.getFont();
    balanceDueField.setFont(f.deriveFont(f.getStyle() ^ Font.BOLD));
