 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/EmployeeMasterBean.java /rgbustores_13.4x_generic_branch/2 2011/10/25 11:30:23 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EmployeeMasterBean extends ValidatingBean implements DocumentListener
{
     ...
     * valid
     */
    protected ValidatingComboBox daysValidField = null;
    /**
    ...
    protected void initComponents()
    {
        ...
        daysValidField = uiFactory.createValidatingComboBox("daysValidField");
    }
    ...
    public void updateModel()
    {
        ...
        if (EmployeeTypeEnum.TEMPORARY.equals(employeeType))
        {
            String daysValid = (String)daysValidField.getSelectedItem();
            beanModel.setSelectedDaysValidValue(Integer.valueOf(daysValid).intValue());
            beanModel.setSelectedDaysValidIndex(daysValidField.getSelectedIndex());
        }
    }
    ...
    public void updateBean()
    {
        ...
        if (EmployeeTypeEnum.TEMPORARY.equals(employeeType))
        {
            ...
            daysValidField.setModel(new DefaultComboBoxModel(beanModel.getDaysValidList()));

            if (!Integer.valueOf(beanModel.getSelectedDaysValidValue()).toString().equals("0"))
                daysValidField.setSelectedItem(Integer.valueOf(beanModel.getSelectedDaysValidValue()).toString());
            else
                // default list to first index
                daysValidField.setSelectedIndex(beanModel.getSelectedDaysValidIndex());
