 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ItemInquiryBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:47 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ItemInquiryBean extends ValidatingBean implements DocumentListener
{
    ...
    **/
    ...
    private static Logger logger = Logger.getLogger(oracle.retail.stores.pos.ui.beans.ItemInquiryBean.class);
    ...
    **/
    ...
    /**
 	 Determines if manufacturer field should be displayed
 	**/
    protected boolean showManufacturer = false;
    ...
    **/
    private void initialize()
    {
        ...
        UIUtilities.layoutDataPanel
            (
                this,
                new JLabel[]{itemNumberLabel, itemDescLabel,itemManufacturerLabel, itemDeptLabel, itemTypeLabel,itemUOMLabel, itemStyleLabel, itemColorLabel, itemSizeLabel},
                new JComponent[]{itemNumberField, itemDescField, itemManufacturerField, deptComboBox,itemTypeCombo, itemUOMCombo, itemStyleCombo,itemColorCombo, itemSizeCombo}
             );
    ...
    protected void updateBean()
    {
       ...
       itemDescField.setText(UIUtilities.makeSafeStringForDisplay(beanModel.getItemDesc(), MAX_ITM_DESC_DISPLAY_LENGTH));
    ...
    **/
    ...
    {
        String strResult = new String("Class: ItemInquiryBean (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
    ...
    **/
    ...
    public void manageNextButton()
    {
    	...
    	{
	    	if(((itemNumberField.getText()!= null) && (!itemNumberField.getText().equals("")))
	    			|| ((itemDescField.getText()!= null) && (!itemDescField.getText().equals("")))
		    		|| ((itemManufacturerField.getText()!= null) && (!itemManufacturerField.getText().equals(""))))
		    {
