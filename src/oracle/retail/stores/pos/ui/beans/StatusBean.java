...
public class StatusBean extends BaseBeanAdapter implements ScreenNameListener, ActionListener
{
    ...
    {
    	/*System.out.println("inside updatePropertyFields "+retrieveText(screenNameTag, screenNameField.getText()));*/
       ...
       // DomainGateway.getFactory().getTransactionInstance();
        ...
        if("Sell Item".equalsIgnoreCase(retrieveText(screenNameTag, screenNameField.getText())) 
        		&& empDiscountApplied){
        	customerLabel.setText("Remaining Spend Amt:");
        }
        ...
        //salesAssociateLabel.setText("Employee Name :  ");
