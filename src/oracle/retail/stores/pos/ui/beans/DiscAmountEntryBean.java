 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DiscAmountEntryBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:42 mszekely Exp $
 * ===========================================================================
...
//------------------------------------------------------------------------------
/**
 *   This Bean displays a Discount Amount and a Reason Code Form.
...
public class DiscAmountEntryBean extends ValidatingBean
{
    ...
    {
        discAmountLabel = uiFactory.createLabel(AMOUNT_LABEL, null, UI_LABEL);
    ...
    protected void initLayout()
    {
        UIUtilities.layoutDataPanel(this,
                                        new JLabel[]{discAmountLabel, choiceLabel},
                                        new JComponent[]{discAmountField, choiceList});
    }
