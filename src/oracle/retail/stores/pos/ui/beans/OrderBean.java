 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OrderBean.java /rgbustores_13.4x_generic_branch/2 2011/05/23 11:58:43 rrkohli Exp $
 * ===========================================================================
 * NOTES
    ...
    **/
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        */
        ...
        int    status     = OrderLineItemIfc.ORDER_ITEM_STATUS_UNDEFINED;

        if(actionName.equals(FILLED))
        {
            status = OrderLineItemIfc.ORDER_ITEM_STATUS_FILLED;
        }
        else if(actionName.equals(PENDING))
        {
            status = OrderLineItemIfc.ORDER_ITEM_STATUS_PENDING;
        }
        else if(actionName.equals(PICKUP))
        {
            status = OrderLineItemIfc.ORDER_ITEM_STATUS_PICK_UP;
        }
        ...
        {
            if (originalStatus[indices[i]] != OrderLineItemIfc.ORDER_ITEM_STATUS_PICKED_UP &&
                originalStatus[indices[i]] != OrderLineItemIfc.ORDER_ITEM_STATUS_CANCELED &&
                originalStatus[indices[i]] != OrderLineItemIfc.ORDER_ITEM_STATUS_VOIDED)
            {
