 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OtherTenderDetailBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:42 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
     ...
     @version $Revision: /rgbustores_13.4x_generic_branch/1 $ $EKW;
**/
//----------------------------------------------------------------------------
public class OtherTenderDetailBean extends BaseBeanAdapter implements AddDeleteListener
{
    ...
    **/
    public static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/1 $ $EKW;";

    protected static final String BUTTON_ADD_LABEL = "Add";
   // protected static final char BUTTON_ADD_MNEMONIC = 'a';
    protected static final int BUTTON_ADD_KEY = KeyEvent.VK_A;

    protected static final String BUTTON_DELETE_LABEL = "Delete";
    //protected static final char BUTTON_DELETE_MNEMONIC = 'd';
  ...
  **/
    ...
    **/
    ...
    //----------------------------------------------------------------------------
    /**
        Called when the panel is created. <P>
        <B>Pre-Condition(s)</B>
        <UL>
        <LI> None.
        </UL>
    ...
    **/
    ...
    public void configure()
    {
        ...
        amountsList = new EYSList(listModel);
       ...
       // totalField = uiFactory.createCurrencyField("TotalField", "true", "true", "true");
//      set the field.
    ...
    //----------------------------------------------------------------------------
    /**
        Called when the panel is added to the screen. <P>
        <B>Pre-Condition(s)</B>
        <UL>
        <LI> None.
        </UL>
    ...
    **/
    ...
    //----------------------------------------------------------------------------
    /**
        Update the screen with values from the model. <P>
        <B>Pre-Condition(s)</B>
        <UL>
    ...
    **/
    ...
    //----------------------------------------------------------------------------
    /**
        Get data from the screen fields and puts it in the model. <P>
        <B>Pre-Condition(s)</B>
        <UL>
        <LI> None.
        </UL>
    ...
    **/
    ...
    //----------------------------------------------------------------------------
    /**
        Move data from the model to the bean. <P>
        <B>Pre-Condition(s)</B>
        <UL>
        <LI> None.
        </UL>
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
       Retrieves Retry/Continue key listener.  Listener instantiated if not already
    ...
    */
    ...
    {
        String strResult = new String("Class: OtherTenderDetailBean (Revision "
                                      + getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
    ...
    */
    ...
    public static void main(String[] args)
    {
        ...
        final OtherTenderDetailBean
            bean = new OtherTenderDetailBean();
            bean.configure();
            bean.activate();
