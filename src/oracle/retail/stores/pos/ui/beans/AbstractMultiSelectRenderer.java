 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/AbstractMultiSelectRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:45 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//-------------------------------------------------------------------------
/**
   This is the Abstract renderer that will be used for Multiple Item
   Selection lists. You will need to extend from this class and implement
   the two abstract functions.
   @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//-------------------------------------------------------------------------
public abstract class AbstractMultiSelectRenderer
extends JPanel
implements ListCellRenderer
{
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
        This function is to be used for Setting the visual components
        for your Cell. This function is called by getListCellRendererComponent
     */
    //---------------------------------------------------------------------
    public abstract void setData(Object data);
    //---------------------------------------------------------------------
    /**
        This function is to be used for Setting the prototype in the list.
        This is needed for making rendering more efficient.
        Create the object you want to render setting all the data
