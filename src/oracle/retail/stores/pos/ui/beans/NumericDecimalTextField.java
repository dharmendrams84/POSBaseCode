 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/NumericDecimalTextField.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class NumericDecimalTextField extends ValidatingTextField
{
    ...
    */
    ...
    {
        BigDecimal value = Util.I_BIG_DECIMAL_ZERO;
        String text = getText();
