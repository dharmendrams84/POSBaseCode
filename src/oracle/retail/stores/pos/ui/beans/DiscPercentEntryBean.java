 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DiscPercentEntryBean.java /rgbustores_13.4x_generic_branch/2 2011/10/21 14:59:22 rsnayak Exp $
 * ===========================================================================
...
//--------------------------------------------------------------------------
/**
 *  This Bean displays a Discount percent field and a Reason Code Form. <P>
 *  It uses the DecimalWithReasonBeanModel.
 *   This bean supports an editable combo box. To make the combo box editable,
 *   add an EditableList bean property with property value true in the
 *   workpanel of the corresponding OVERLAYSCREEN in the appropriate
 *   uicfg.xml file. By default, it is not editable.
...
public class DiscPercentEntryBean extends ValidatingBean
{
   ...
   public DiscPercentEntryBean()
    ...
    protected void initComponents()
    {
        ...
        discPercentLabel = uiFactory.createLabel(PERCENT_LABEL, null, UI_LABEL);
        ...
        choiceLabel = uiFactory.createLabel(labelText, null, UI_LABEL);
    ...
    public void updateModel()
    {
        if(beanModel instanceof DecimalWithReasonBeanModel)
        {
            ...
            {
                myModel.setValue(new BigDecimal("0.00"));
            }
            else
            {
     ...
     *  @see #setModel(oracle.retail.stores.foundation.manager.gui.UIModelIfc model)
     */
    //-------------------------------------------------------------------------
