 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ImageAppFrame.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:56 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
 * This is an application frame that displays a background image behind the screen beans and components.
 * 
...
public class ImageAppFrame extends ApplicationFrame
{
    ...
    public void configure(Properties props)
    {
        ...
        String image = UIFactory.getInstance().getUIProperties().getProperty("backgroundImage", DEFAULT_IMAGE) + ".gif";
        backgroundImageTrainingModeOnName =
            UIFactory.getInstance().getUIProperties().getProperty("trainingModeImage", DEFAULT_IMAGE) + ".gif";
        backgroundImageTransReentryModeName =
            UIFactory.getInstance().getUIProperties().getProperty("transReentryModeImage", DEFAULT_IMAGE) + ".gif";
