 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/EmployeeMasterBeanModel.java /rgbustores_13.4x_generic_branch/3 2011/10/25 11:30:23 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class EmployeeMasterBeanModel extends POSBaseBeanModel
{
    ...
    /**
     * Days Valid. Only used for temporary employees
     */
    protected String[] daysValidList;
    /**
     * UI control index of the days valid for temporary employees.
     */
    protected int selectedDaysValidIndex = 0;
    /**
     * Represents the days valid value that was selected in the UI.
     */
    protected int selectedDaysValidValue;
     ...
     * 
     * @param daysValidList the number of days the employee is to be valid
     */
    public void setDaysValidList(String[] daysValidList)
    {
        this.daysValidList = daysValidList;
    }

    /**
     * Sets the daysValid for temporary employees.
     * 
     * @return String array representing the number of days the employee is
     *         supposed to be valid
     */
    public String[] getDaysValidList()
    {
        return this.daysValidList;
    }

    /**
     * Sets the UI control index of the days valid for temporary employees.
     * 
     * @param selectedDaysValidIndex the index for the value selected in the UI.
     */
    void setSelectedDaysValidIndex(int selectedDaysValidIndex)
    {
        this.selectedDaysValidIndex = selectedDaysValidIndex;
    }

    /**
     * Gets the UI control index of the days valid for temporary employees.
     * 
     * @return the index for the value selected in the UI.
     */
    int getSelectedDaysValidIndex()
    {
        return this.selectedDaysValidIndex;
    }

    /**
     * Sets an integer which represents the days valid value that was selected
     * in the UI.
     * 
     * @param daysValidValue integer which represents the days valid value that
     *            was selected in the UI.
     */
    public void setSelectedDaysValidValue(int selectedDaysValidValue)
    {
        this.selectedDaysValidValue = selectedDaysValidValue;
    }

    /**
     * Gets an integer which represents the days valid value that was selected
     * in the UI.
     * 
     * @return integer which represents the days valid value that was selected
     *         in the UI.
     */
    public int getSelectedDaysValidValue()
    {
        return this.selectedDaysValidValue;
    }
