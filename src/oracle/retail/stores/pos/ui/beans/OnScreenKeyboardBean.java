 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OnScreenKeyboardBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:52 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OnScreenKeyboardBean extends BaseBeanAdapter implements ActionListener
{
    ...
    protected void buildPanelAlpha()
    {
        ...
        panelAlpha.setPreferredSize(new java.awt.Dimension(600, 140));
    ...
    protected void buildPanelNumpad()
    {
        ...
        panelNumpad.setPreferredSize(new java.awt.Dimension(220, 160));
    ...
    protected void buildPanelSymbols()
    {
        ...
        panelSymbols.setPreferredSize(new java.awt.Dimension(550, 140));
    ...
    protected void buildPanelToggle()
    {
        ...
        panelToggle.setPreferredSize(new java.awt.Dimension(25, 140));
