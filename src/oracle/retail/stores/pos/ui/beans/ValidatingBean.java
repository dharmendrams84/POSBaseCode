 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ValidatingBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    protected boolean validatePasswordFields()
    {
        ...
        while (requiredEnum.hasNext() && errorCount < DISPLAY_ERROR_MESSAGES)
        {
            ...
            if (field instanceof ValidatingPasswordField)
            {
            	...
            	{
            		String password2 = new String(tField.getPassword()); 
            		// if a field is non-null and the data is invalid, set error message
            		...
            		{
            			password = new String(tField.getPassword());
            		}
            	}
            }
        }
    ...
    **/
    ...
    public void setVisible(boolean aFlag)
    {
        ...
        if (aFlag)
        {
            ...
            {
                setFocusByName(getPOSBaseBeanModel().getFieldInErrorName());
            }
        }
    }
    ...
    {
        return getPOSBaseBeanModel().getFieldInErrorName() != null;
