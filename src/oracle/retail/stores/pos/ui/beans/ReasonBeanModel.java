 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ReasonBeanModel.java /rgbustores_13.4x_generic_branch/2 2011/08/16 11:03:53 vtemker Exp $
 * ===========================================================================
 * NOTES
...
public class ReasonBeanModel extends CountryModel
{
     ...
     */
    //--------------------------------------------------------------------------
    protected static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/2 $";
     ...
     */
    //--------------------------------------------------------------------------
    protected String fieldSelectedReasonKey = new String();
     ...
     */
    //--------------------------------------------------------------------------
    protected Vector fieldReasonCodeKeys = new Vector();
     ...
     */
    //--------------------------------------------------------------------------
    public Vector getReasonCodeKeys()
    {
   ...
   public String getDefaultValue()
   {
     ...
     */
    //--------------------------------------------------------------------------
    public void setReasonCodeKeys(Vector reasonCodeKeys)
    {
    ...
    public void setSelectedReasonCode(int selectedReasonIndex)
    {
        ...
        {
            fieldSelectedReason = (String)fieldReasonCodes.elementAt(fieldSelectedIndex);
            if(!fieldReasonCodeKeys.isEmpty())
            {
                fieldSelectedReasonKey = (String)fieldReasonCodeKeys.elementAt(fieldSelectedIndex);
            }
        }
    }
    ...
    **/
    ...
    {
        fieldSelected = false;
        fieldSelectedReason = new String();
        fieldSelectedReasonKey = new String();
    ...
    **/
    ...
    public String toString()
    {
        ...
        buff.append("Class: ReasonBeanModel Revision: "
                                                  + revisionNumber + "\n");
    ...
    public void inject(CodeListIfc list, String selectedReasonCode, Locale locale)
    {
    	if (list!=null)
    	{
	        ...
	        if (!Util.isEmpty(selectedReasonCode) &&
	            !CodeConstantsIfc.CODE_UNDEFINED.equals(selectedReasonCode))
	        {
