 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DualListBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DualListBean extends ListBean
{
    ...
    protected void configureTopScrollPane()
    {
        ...
        topScrollPane.setPreferredSize(new Dimension(160, 60));
        topScrollPane.setMinimumSize(new Dimension(160, 60));
