 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/SummaryChargeMenuBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:52 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class SummaryChargeMenuBean extends BaseBeanAdapter
{
    ...
    protected SummaryChargeMenuBeanModel beanModel =
        new SummaryChargeMenuBeanModel();
    ...
    protected void initComponents()
    {
        ...
        fieldLabels[totalPos] = uiFactory.createLabel(totalLabelText, null, UI_LABEL);
