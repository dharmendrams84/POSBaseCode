 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OrderDetailRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:42 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OrderDetailRenderer extends LineItemRenderer 
{
    ...
    /** the property for the currency format 
      @deprecated as of release 5.5 retrieve the format format from domain gateway*/
  //  public static final String CURRENCY_FORMAT = "#,##0.00;(#,##0.00)";
    ...
    */
    ...
    //        currencyFormat = props.getProperty("CurrencyIfc.DisplayFormat", CURRENCY_FORMAT);
            ...
            giftRegLabel = props.getProperty("SaleLineItemRenderer.GiftRegistryLabel", "GiftReg.#");
        }
    }
