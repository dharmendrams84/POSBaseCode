 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/PersonalIDEntryBean.java /rgbustores_13.4x_generic_branch/3 2011/09/02 13:05:38 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class PersonalIDEntryBean extends ValidatingBean implements DocumentListener, ItemListener
{
    ...
    protected void updateBean()
    {
        ...
        {
            PersonalIDEntryBeanModel model = (PersonalIDEntryBeanModel)beanModel;
            idNumberField.setText(model.getPersonalID().getDecryptedNumber());
