 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/LocationBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class LocationBean extends CycleRootPanel
{
    ...
    public void updateModel()
    {
        if (beanModel !=null && beanModel.getEditMode() && locationListField != null)
        {
            ...
            if (locationIndex >= 0)
            {
                String orderLocationCode = (String)beanModel.getOrderLocationsList().getKeyEntries().elementAt(locationIndex);
    ...
    protected void updateLocationField()
    {
        ...
        if (beanModel !=null)
        {
            if (beanModel.getEditMode())
            {
                ...
                locationListField = uiFactory.createValidatingComboBox("locationListField", "false", "10");
