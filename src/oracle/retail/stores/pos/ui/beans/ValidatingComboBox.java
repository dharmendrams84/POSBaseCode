 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ValidatingComboBox.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
**/
//-------------------------------------------------------------------------
public class ValidatingComboBox extends JComboBox implements ValidatingFieldIfc, FocusListener//, PopupMenuListener
{
    /** Revision number supplied by version control. */
    public static final String revisionNumber = "$Revision: /rgbustores_13.4x_generic_branch/1 $";

    /** id for look and feel */
    public final static String uiClassID = "RequiredBoxUI";
    ...
    /** The document listener responding to keystrokes in text field
        area of combobox. */
    ...
    **/
    //---------------------------------------------------------------------
    public ValidatingComboBox(ComboBoxModel data)
    {
        super(data);
        initialize();
    }
    ...
    **/
    //---------------------------------------------------------------------
    public ValidatingComboBox(Object[] data)
    {
        super(data);
        initialize();
    }
    ...
    **/
    //---------------------------------------------------------------------
    public ValidatingComboBox(Vector data)
    {
        super(data);
        initialize();
    }
    ...
    **/
    ...
    protected void initialize()
    {
        ...
        setUI(new ValidatingComboBoxUI());
    ...
    **/
    ...
    public void addNotify()
    {
        ...
        ((JTextField)getEditor().getEditorComponent()).getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "none");
    ...
    **/
    ...
    protected void activateScrollFromTextField()
    {
        ...
        ((JTextField)getEditor().getEditorComponent()).getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0), upAction);
        ((JTextField)getEditor().getEditorComponent()).getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0), downAction);
    ...
    **/
    ...
    public boolean isInputValid()
    {
        ...
        if (!emptyAllowed &&
            (getSelectedItem() == null  || ((String)getSelectedItem()).length() == 0
             || (!isEditable() && getSelectedIndex() == -1)))
        {
            rv = false;
        }
        return rv;
    ...
    //---------------------------------------------------------------------
    /**
        Overrides setSelectedItem in JComboBox. Ensures item in combo box's
        text field matches the selected value <p>
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
        Overrides getSelectedItem in JComboBox. Ensure's item in combo box's
        text field matches the selected value <p>
    ...
    **/
    ...
    /**
     * Sets the width of the display field
     * This method is equivalent to the JTextField.getColumnWidth() but adapted to the JComboBox.
     *
     * @param columns
     */
    public void setColumns (int columns)
    {
        if (columns > 0)
        {
            StringBuffer prototypeDisplayValue = new StringBuffer();
    ...
    public void focusGained(FocusEvent e)
    {
        if (isEditable())
        {
            ...
            else
            {
                ...
                {
                    ((JTextField)getEditor().getEditorComponent()).getDocument().addDocumentListener(POSDocumentListener);
                    ValidatingTextDocumentEvent evt =
                                new ValidatingTextDocumentEvent(((JTextField)getEditor().getEditorComponent()).getDocument());
    ...
    public void focusLost(FocusEvent e)
    {
        if (isEditable())
        {
            if (POSDocumentListener != null)
            {
                ...
                POSDocumentListener.changedUpdate(evt);
                ((JTextField)getEditor().getEditorComponent()).getDocument().removeDocumentListener(POSDocumentListener);
            }
        }
    }
    ...
    **/
    ...
    {
        String strResult = new String("Class: ValidatingComboBox (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
    ...
    */
    ...
    //---------------------------------------------------------------------
    /**
    *   This inner class will allow the popup menu size to be set independently
    *   from the size of the initial combo box text field.
    *   @see setColumns to set the text field width
    */
    //---------------------------------------------------------------------
				...
				public void show()
      		      {
                        ...
                        // If the size (width) of the ComboBox is bigger than the popupSize
                        // make them the same.
    ...
    /**
     * Overriding the setModel method in order to set the popupWidth before setting up the model
     * @param model
     */
    public void setModel (ValidatingComboBoxModel model)
    {
        setPopupWidth(model.toArray());
     ...
     * @param model
     */
    public void setModel (POSListModel model)
    {
        setPopupWidth (model.toArray());
        super.setModel(model);
    }
    ...
    {
        ValidatingComboBox tmp = new ValidatingComboBox(dropdownChoices);
    ...
    public void addItems(Object[] objects)
    {
        ...
        {
            super.addItem(objects[i]);	// call the super class addItem so that we only reset popup width once
        }
    	resetPopupWidth();
    }
    ...
    /*
     * Add an item to the combo box
     * Override the addItem method in order to adjust the popup width
     */
