 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/MailBankCheckInfoBean.java /rgbustores_13.4x_generic_branch/2 2012/02/27 17:57:55 mkutiana Exp $
 * ===========================================================================
 * NOTES
...
public class MailBankCheckInfoBean extends CustomerInfoBean
{
    ...
    */
    ...
    {
        String strResult = new String("Class: MailBankCheckInfoBean (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
