 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ShippingMethodBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ShippingMethodBean extends ValidatingBean implements ListSelectionListener
{
    ...
    {
        shipViaScrollPane = uiFactory.createSelectionList("shipViaList", "large", "false");
        ...
        instrScrollPane = uiFactory.createConstrainedTextAreaFieldPane("instrViaScrollPane", "0", "500", "100", "true",
