 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/BaseBeanAdapter.java /rgbustores_13.4x_generic_branch/2 2011/07/14 16:48:07 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 */
abstract public class BaseBeanAdapter
extends JPanel
implements EYSPOSBeanIfc,
           FocusListener,
           WindowFocusListener
{
    ...
    protected String retrieveText(String tag)
    {
        ...
        if (tag != null)
        {
            ...
            if (props != null)
            {
               if (testingBundles)
               {
                   result = props.getProperty(tag, testTag);
               }
               else
               {
