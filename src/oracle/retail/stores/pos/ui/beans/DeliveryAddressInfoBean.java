 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DeliveryAddressInfoBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DeliveryAddressInfoBean extends ValidatingBean
{
    ...
    protected void setChangeStateValue()
    {
        ...
        String phoneNumber = new String(phone.getAreaCode() + phone.getPhoneNumber());
