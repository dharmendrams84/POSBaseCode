 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/CaptureCustomerInfoBeanModel.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureCustomerInfoBeanModel extends CountryModel
{
    ...
    /** @deprecated as of 13.1. {@link #phone} reference knows its type. */
    ...
    /**
     * @deprecated as of 13.1 use {@link #setPhoneNumber(String, int)} instead.
     * @param areaCode
     * @param phoneNumber
     */
    public void setPhoneNumber(String areaCode, String phoneNumber)
    {
        setPhoneNumber(areaCode + phoneNumber, getPhoneType());
    }
    ...
    {
        setPhoneNumber(telephoneNumber, getPhoneType());
    }
     ...
     * @deprecated since v13.1
     */
    public void setPostalCodeExt(String postalExt)
    {
        fieldExtPostalCode = postalExt;
    }
