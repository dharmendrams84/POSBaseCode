 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/LogoBean.java /rgbustores_13.4x_generic_branch/3 2011/11/17 14:44:53 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class LogoBean extends BaseBeanAdapter implements WindowFocusListener
{
    ...
    {
        imageSource = props.getProperty("logoImg");
        if (imageSource != null)
        {
            configure();
        }
