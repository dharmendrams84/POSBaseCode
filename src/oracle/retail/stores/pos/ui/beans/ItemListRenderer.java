 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ItemListRenderer.java /rgbustores_13.4x_generic_branch/2 2011/07/20 12:46:25 mkutiana Exp $
 * ===========================================================================
 * NOTES
...
public class ItemListRenderer extends AbstractListRenderer
{
    ...
    **/
    ...
    public static int[] ITEM_WIDTHS2 = { -1, 1, 1, 1 };
    ...
    public void setData(Object value)
    {
        ...
        labels[DEPARTMENT].setText(item.getDepartment().getDescription(getLocale()));
    ...
    protected ImageIcon getLoadingImage()
    {
        ...
        if (getParent() != null)
        {
            buzy.setImageObserver(getParent().getParent());
        }
        return buzy;
    }
