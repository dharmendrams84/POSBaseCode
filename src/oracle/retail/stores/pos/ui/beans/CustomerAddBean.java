 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/CustomerAddBean.java /rgbustores_13.4x_generic_branch/3 2011/09/02 13:05:37 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CustomerAddBean extends ValidatingBean
{
    ...
    protected void updateBean()
    {
        if (beanModel instanceof CustomerInfoBeanModel)
        {
            ...
            {
                taxCertificateField.setText(model.getEncipheredTaxCertificate().getDecryptedNumber());
            }
            ...
            {
                custTaxIDField.setText(model.getTaxID().getDecryptedNumber());                
            }
            else
            {
