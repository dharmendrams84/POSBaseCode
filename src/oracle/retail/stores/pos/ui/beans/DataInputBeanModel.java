 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DataInputBeanModel.java /rgbustores_13.4x_generic_branch/2 2011/07/14 16:48:07 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class DataInputBeanModel extends POSBaseBeanModel
{
    ...
    protected HashMap<String,Object> beanData = new HashMap<String,Object>();
    /** 
     * Container label arguments to place into the localized text.
     * @since 13.4 
     */
    protected HashMap<String,Object[]> labelArgs = new HashMap<String,Object[]>();
    ...
    public BigDecimal getValueAsDecimal(String fieldName)
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                result = Util.I_BIG_DECIMAL_ZERO;
            }
        }
        return result;
    }
