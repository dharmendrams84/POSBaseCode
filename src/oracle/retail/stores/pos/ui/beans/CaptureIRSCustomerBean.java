 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/CaptureIRSCustomerBean.java /rgbustores_13.4x_generic_branch/3 2011/09/02 13:05:38 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class CaptureIRSCustomerBean extends ValidatingBean
{
    ...
    protected ConstrainedTextField taxpayerIDField = null;
    ...
    protected void initializeFields()
    {
        ...
        taxpayerIDField = uiFactory.createAlphaNumericField("taxpayerIDField", "9", "20", false);
        ...
        if (beanModel instanceof CaptureIRSCustomerBeanModel)
        {
            ...
            try
            {
                taxPayerID = FoundationObjectFactory.getFactory().createEncipheredDataInstance(
                        taxpayerIDField.getText().getBytes());
    ...
    protected void updateBean()
    {
        if (beanModel instanceof CaptureIRSCustomerBeanModel)
        {
            ...
            {
                taxpayerIDField.setText(model.getTaxPayerID().getDecryptedNumber());
            }
            else
            {
                taxpayerIDField.setText("");
            }
