 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/InstantCreditCustomerBean.java /rgbustores_13.4x_generic_branch/2 2011/10/06 18:56:48 hyin Exp $
 * ===========================================================================
 * NOTES
...
public class InstantCreditCustomerBean extends ValidatingBean
{
    ...
    protected JLabel ssnLabel = null;
    ...
    protected SocialSecurityField ssnField = null;
    ...
    protected void initComponents()
    {
        ...
        dobLabel = uiFactory.createLabel("dobLabel", "dobLabel", null, UI_LABEL);
        ssnLabel = uiFactory.createLabel("ssnLabel", "ssnLabel", null, UI_LABEL);
        ...
        dobField.setErrorMessage("Date of Birth");
        ssnField = new SocialSecurityField();
        ssnField.setName("ssnField");
        ssnField.setColumns(15);
        ssnField.setMinLength(9);
        ssnField.setMinimumSize(15);
        ssnField.setErrorMessage("Social Security Number");
    ...
    protected void initLayout()
    {
        ...
        orderableFields.add(new OrderableField(dobLabel, dobField));
        orderableFields.add(new OrderableField(ssnLabel, ssnField));
    ...
    public void updateModel()
    {
        ...
        if(dobField.getText() != null && !dobField.getText().equals(""))
        {
            beanModel.setDob(dobField.getEYSDate());
        }
        String ssn = ssnField.getSocialSecurityNumber();

        beanModel.setSsn(ssn);
        beanModel.setCountryIndex(countryField.getSelectedIndex());
    ...
    public void updateBean()
    {
        ...
        if(beanModel.isFirstRun())
        {
            ...
            // set dob field to empty
            if(beanModel.getDob() == null)
            {
                dobField.setText("");
            }
            else
            {
                ...
                String dateString = dateTimeService.formatDate(beanModel.getDob().dateValue(), locale, DateFormat.SHORT);
                dobField.setText(dateString);
            }

            if(beanModel.getSsn() == null)
            {
                ssnField.setText("");
            }
            else
            {
                ssnField.setText(beanModel.getSsn());
            }
    ...
    protected void updatePropertyFields()
    {
        ...
        dobLabel.setText(retrieveText("DateOfBirth", dobLabel));
        String translatedLabel = getTranslatedDatePattern();
        dobLabel.setText(LocaleUtilities.formatComplexMessage(dobLabel.getText(), translatedLabel));

        ssnLabel.setText(retrieveText("SocialSecurityNumber", ssnLabel));
        ...
        dobField.setLabel(dobLabel);
        ssnField.setLabel(ssnLabel);
