 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ConstrainedTextField.java /rgbustores_13.4x_generic_branch/2 2011/09/09 13:13:26 cgreene Exp $
 * ===========================================================================
 * NOTES
...
//                || len > doc.getMaxLength())
    ...
    */
    ...
    /**
     * This method overrides the basic behavior of the JText.setText()
     * If the input string is bigger than the field maxLength, truncates the data
     * 
     * This method was created because if we had a text which was bigger than
     * the maxLength, nothing was being displayed in the field.
     * 
