 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/DetailStatusBeanModel.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:40 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class DetailStatusBeanModel extends ListBeanModel
{
    ...
    protected HashMap<String,Integer> statusMap = new HashMap<String,Integer>();
