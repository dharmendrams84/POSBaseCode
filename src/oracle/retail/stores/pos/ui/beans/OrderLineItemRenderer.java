 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OrderLineItemRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:54 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//-------------------------------------------------------------------------
/**
   This is the renderer for the OrderLineItem Table.  It displays
   OrderLineItems in the same manner as the SaleLineItemRenderer.
   <P>
...
public class OrderLineItemRenderer extends LineItemRenderer
{
    ...
    public void setData(Object value)
    {
        ...
        // set status
        int status = lineItem.getOrderItemStatus().getStatus().getStatus();
    ...
    */
    ...
    protected void setPropertyFields()
    {
        ...
        {
             quantityFormat =
                props.getProperty("OrderDetailRenderer.QuantityFormat",
                        DomainGateway.getNumberFormat(getLocale()).toString());

            salesAssocLabel =
                props.getProperty("SaleLineItemRenderer.SalesAssociateLabel", "Sales Assoc:");

            giftRegLabel =
                props.getProperty("SaleLineItemRenderer.GiftRegistryLabel", "GiftReg.#");
        }
    }
