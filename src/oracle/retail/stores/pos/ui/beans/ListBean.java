 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ListBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:58 mszekely Exp $
 * ===========================================================================
 * NOTES
    ...
    public void updateModel()
    {
        if (beanModel != null && beanModel instanceof ListBeanModel)
        {
            ...
            else
            {
                ...
                if (row != -1 && list.getModel().getSize() > 0)
                {
