 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/SpecialOrderDetailListRenderer.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:54 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
    public void setData(Object data)
    {
        ...
        labels[STATUS].setText(
            UIUtilities.retrieveCommonText(OrderLineItemIfc.ORDER_ITEM_STATUS_DESCRIPTORS[item.getItemStatus()]));
