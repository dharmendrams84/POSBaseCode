 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ReturnItemInfoBean.java /main/26 2011/03/02 18:29:11 ohorne Exp $
 * ===========================================================================
 * NOTES
...
*/
//----------------------------------------------------------------------------
public class ReturnItemInfoBean extends ValidatingBean
{
    /** serialVersionUID */
    ...
    **/
     ...
     **/
    protected AlphaNumericTextField serialNumberField    = null;
    ...
    */
    ...
    protected void initFields()
    {
        ...
        itemDescriptionField = uiFactory.createLabel("no description available", "no description available", null, UI_LABEL);
        constraints.insets.bottom = iLABEL;
        ...
        receiptNumberField = uiFactory.createAlphaNumericField("ReceiptNumberField", "0", transIDLength, false);
        ...
        serialNumberField = uiFactory.createAlphaNumericField("SerialNumberField", "1", "15", false);
    ...
    */
    ...
    protected void updateBean()
    {
        ...
        itemDescriptionField.setText(UIUtilities.makeSafeStringForDisplay(beanModel.getItemDescription(), MAX_ITM_DESC_DISPLAY_LENGTH));
        ...
        if(beanModel.getGiftCardSerialNumber() != null)
        {
            ...
            giftCardBalanceField.setText(LocaleUtilities.formatDecimal(beanModel.getGiftCardBalance(),getDefaultLocale()));
        ...
        {
            String formattedPrice = getCurrencyService().formatCurrency(beanModel.getPrice(), LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE));
            priceFieldDisplayOnly.setText(formattedPrice);
            priceFieldDisplayOnly.setVisible(true);
            priceField.setVisible(false);
            priceField.setEnabled(false);
    ...
    /*
     * The fields which can be enabled/disabled programatically,
     * must be initialized with the values from the bean model
     * due to the fact that the updateModel() method repopulates
     * the model with this data.  This can lead to a number of 
     * bad effects.
     */
    ...
    */
    ...
    public void updateModel()
    {
        ...
        if(beanModel.getGiftCardSerialNumber() != null)
        {
            ...
            {
                Number balance = LocaleUtilities.parseCurrency(giftCardBalanceField.getText(),
                                                             getDefaultLocale());
    ...
    **/
    ...
    public void activate()
    {
        ...
        // modify "status" drop down list content when user makes a selection in "location"
    }
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  GetReturnItemInformationAisle (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
