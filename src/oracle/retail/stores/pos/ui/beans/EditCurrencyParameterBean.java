 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/EditCurrencyParameterBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
 *      This bean enables the editing of a parameter that has a currency
...
public class EditCurrencyParameterBean extends ValidatingBean
{
    ...
    //--------------------------------------------------------------------------
    /**
     *  Returns the currency text field.
     *  @return the currency text field
     */
    private CurrencyTextField getValueTextField()
    {
    ...
    public void updateModel()
    {
    	...
    	{
    		beanModel.setNewValue(Util.I_BIG_DECIMAL_ZERO);
    	}
    }
    ...
    **/
    ...
    {
        String strResult = new String("Class: EditCurrencyParameterBean (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
...
}                                       // end class EditCurrencyParameterBean
