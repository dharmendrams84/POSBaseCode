 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/ValidatingTextAreaField.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:38 mszekely Exp $
 * ===========================================================================
 * NOTES
...
**/
//-------------------------------------------------------------------------
public class ValidatingTextAreaField extends    JTextArea
                                            ...
                                            FocusListener
{
    ...
    **/
    ...
    {
        String strResult = new String("Class: ValidatingTextAreaField (Revision " +
                                      getRevisionNumber() + ") @" +
                                      hashCode());
        return(strResult);
    }
