 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/POSFocusRegulator.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:37 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
 *  Singleton class that allows a component to be registered as needing
 *  focus. The POS Application Frame calls this object to see if a 
 *  component has been set for focus. This circumvents a problem that can
 *  occur on the first screen if a compoent has requested focus before the
 *  Application Frame is visible.
...
public class POSFocusRegulator
{
    ...
    //--------------------------------------------------------------------------
    /**
     *  Used by a bean to set a component for focus when the application
     *  frame is visible.
