 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/POSBeanConfigurator.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:36 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class POSBeanConfigurator extends DefaultBeanConfigurator
{
    ...
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.ui.POSBeanConfigurator.class);

    //--------------------------------------------------------------------------
    /**
        EYSPOS specific implementation of setModel.  This method transports
        data from the business logic to the bean
        <P>
        @param model UIModelIfc model
        @param beanInstance UIBeanIfc
    **/
    //--------------------------------------------------------------------------
    public void setModel(UIModelIfc model, UIBeanIfc beanInstance)
        throws ConfigurationException
    {
        if (beanInstance instanceof EYSPOSBeanIfc)
        {
            ...
            else
            {
                ...
                EYSPOSBeanIfc bean = (EYSPOSBeanIfc)beanInstance;
                POSBaseBeanModel posBaseBeanModel = (POSBaseBeanModel)model;
               // posBaseBeanModel.setFieldInErrorName("")
                bean.setModel(model);
            }
        }
    }
    ...
    //--------------------------------------------------------------------------
    /**
        This method is called from the POSBeanSpec class.  It configures
        all beans.
    ...
    **/
    //--------------------------------------------------------------------------
    public void setResourceBundleFilename
      (String beanName,
       UIBeanIfc beanInstance,
       String filename) throws ConfigurationException
    {
        if (filename != null && beanInstance instanceof EYSPOSBeanIfc)
        {
            ...
            Properties props =
                InternationalTextSupport.getInternationalBeanText(beanName, bundles);
