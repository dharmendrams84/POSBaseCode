 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/XMLFieldSpecBuilder.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:36 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class XMLFieldSpecBuilder extends XMLBuilder implements BuilderIfc
{
    ...
    **/
    ...
    {
        StringBuffer tmpString = new StringBuffer("Class: XMLFieldSpecBuilder (Revision ");
