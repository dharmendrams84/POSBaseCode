 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/device/POSDeviceActions.java /rgbustores_13.4x_generic_branch/3 2012/02/22 11:55:44 mkutiana Exp $
 * ===========================================================================
 * NOTES
...
public class POSDeviceActions extends DeviceActions
{
    ...
    /**
     * The action to execute on the remote system.
     */
    protected DeviceActionIfc deviceAction;
