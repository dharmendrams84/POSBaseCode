 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/receipt/ItemTaxSlip.java /main/17 2011/02/27 20:37:37 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class ItemTaxSlip
{
    ...
    public String[] getTaxTotalsByRule(boolean receiptFormat, TransactionTotalsIfc totals)
    {
        ...
        HashMap<String,TaxInformationIfc> taxData = new HashMap<String,TaxInformationIfc>();
