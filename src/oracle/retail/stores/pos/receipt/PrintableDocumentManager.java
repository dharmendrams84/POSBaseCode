 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/receipt/PrintableDocumentManager.java /rgbustores_13.4x_generic_branch/2 2011/10/25 17:27:05 hyin Exp $
 * ===========================================================================
 * NOTES
            ...
            if(lineItems.length > 0)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        BigDecimal itemQuantity = srli.getItemQuantityDecimal();
                        BigDecimal returnQuantity = itemQuantity.subtract(srli.getQuantityReturnedDecimal());
                ...
                if (lineItems[i] instanceof SaleReturnLineItemIfc)
                {
                    ...
                    if (!hasDamageDiscounts(srli))
                    {
                                ...
                                || (srli.getItemSendFlag() && receiptParameters.isAutoPrintGiftReceiptItemSend()))
                        {
                            ...
                            {
                                SendPackageLineItemIfc spli = srTrans.getTransactionTotals().getSendPackage(srli.getSendLabelCount() - 1);
