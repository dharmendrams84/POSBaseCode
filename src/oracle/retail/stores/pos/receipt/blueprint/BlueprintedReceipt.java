 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/receipt/blueprint/BlueprintedReceipt.java /rgbustores_13.4x_generic_branch/3 2011/08/11 15:48:21 icole Exp $
 * ===========================================================================
 * NOTES
    ...
    implements EYSPrintableDocumentIfc
{
    ...
    protected void flush() throws PrintingException
    {
        try
        {
            ...
            if (isPreview())
                previewText.append(printer.getPrintString(line.toString()));
            else
    ...
    protected void printImageElement(ImageElement element) throws PrintingException
    {
        ...
        try
        {
            printer.printBitmap(element.getFileName(), POSPrinterConst.PTR_BM_CENTER);
        }
        catch (DeviceException e)
        {
            throwPrintingException(e);
